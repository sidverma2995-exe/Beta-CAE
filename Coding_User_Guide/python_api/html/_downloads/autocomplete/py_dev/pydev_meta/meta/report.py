...
@typing_extensions.deprecated("Deprecated since version 20.1.0.Use meta.report.Report.get_slide_size instead.")
def HeightOfSlide(unit: float) -> float:

	"""
	.. deprecated:: 20.1.0
		Use :py:meth:`meta.report.Report.get_slide_size` instead.
	...
	warnings.warn("Deprecated since version 20.1.0.Use meta.report.Report.get_slide_size instead.", DeprecationWarning)

def NamesOfAllSlides() -> Iterable[str]:
...
@typing_extensions.deprecated("Deprecated since version 20.1.0.Use meta.report.Textbox.get_text instead.")
def TextOfReportTextbox(slide_name: str, textbox_name: str, text_type: int) -> str:

	"""
	.. deprecated:: 20.1.0
		Use :py:meth:`meta.report.Textbox.get_text` instead.
	...
	Notes
	-----
	This functions works for the active report composer.
	...
	warnings.warn("Deprecated since version 20.1.0.Use meta.report.Textbox.get_text instead.", DeprecationWarning)
...
def WidthOfSpreadsheetColumns(slide_name: str, table_name: str, sheet_name: str, columns: Iterable[int], unit: str) -> Iterable[float]:
	...
	Notes
	-----
	The function works for the active Report Composer.
...
def NamesOfAllShapes(slide_name: str) -> dict:
	...
	-------
	dict
		It returns a dictionary which contains, the shape types as keys, and lists of shape names as values.
...
def CreateReport(name: str) -> Report:
	...
	Notes
	-----
	Creation fails when a report composer window with the same name exists.

	See Also
	--------
	meta.report.Report, meta.report.Reports
...
def GetReportNames() -> Iterable[str]:
...
def Reports() -> Iterable[Report]:
	...
	See Also
	--------
	meta.report.CreateReport, meta.report.Report
...
def DeleteReport(report: Report | str) -> bool:
	...
	See Also
	--------
	meta.report.Report, meta.report.CreateReport, meta.report.Reports
...
def Spreadsheets() -> Iterable[spreadsheet.Spreadsheet]:
...
def CreateReportTag(name: str, value: str) -> ReportTag:
...
def CreateReportFilter(type: str, name: str, operator: str, value: str, value2: str) -> ReportFilter:
...
class Report:
	...
	def open(self, filename: str, load_shape_names: bool=True, load_slide_names: bool=True) -> bool:
	...
	def save(self, filename: str, options: dict) -> bool:
	...
	def get_slide(self, slide: str | int) -> Slide:
	...
	def add_slide(self, name: str, index: int) -> Slide:
	...
	def move_slide(self, slide: Slide, index: int) -> bool:
	...
	def duplicate_slide(self, slide: Slide, name: str, index: int) -> Slide:
	...
	def delete_slide(self, slide: str | Slide) -> bool:
	...
	def set_slide_size(self, size: Iterable[float], unit: str, type: str, orientation: str) -> bool:
	...
	def get_slide_size(self, unit: str) -> list[float]:
	...
	def get_tags(self) -> list[ReportTag]:
	...
	def add_tag(self, tag: ReportTag) -> bool:
	...
	def remove_tag(self, tag: ReportTag | str) -> bool:
	...
	def get_current_slide(self) -> Slide:
		...
		Returns the current slide in the Report Composer.
	...
	def set_current_slide(self, slide: int | str | Slide) -> bool:

		"""

		Sets the current slide in the Report Composer.


		Parameters
		----------
		slide : int | str | Slide
			Either the index of the slide (1-indexed), the name of the slide, or the slide object that the user wishes to become current.

		Returns
		-------
		bool
			True upon success. False upon failure to set the current slide, when the index is out of range or the slide name does not exist.
	...
	def __init__(self, report_name: str) -> None:
		...
		Upon success it returns an object of class Report for the given report name.
...
class Slide:
	...
	def add_textbox(self, text: str, name: str) -> Textbox:
	...
	def add_picture(self, filename: str, name: str) -> Picture:
	...
	def add_table(self, rows: int, columns: int, name: str) -> Table:
	...
	def add_group(self, shapes: list, name: str) -> ShapeGroup:
	...
	def add_excel_table(self, filename: str, name: str) -> ExcelTable:
	...
	def delete_shapes(self, shapes: list) -> bool:
	...
	def add_rectangle(self, name: str) -> Rectangle:
	...
	def add_ellipse(self, name: str) -> Ellipse:
	...
	def add_triangle(self, name: str) -> Triangle:
	...
	def set_background(self, fill: str, color: windows.Color, filename: str) -> bool:
	...
	def add_line(self, name: str) -> Line:
	...
	def get_tags(self) -> Iterable[ReportTag]:
	...
	def add_freeform(self, points: list, unit: str, name: str) -> Freeform:
	...
	def add_3dmodel(self, filename: str, name: str) -> Model3D:
	...
	def add_video(self, filename: str, name: str, embed: bool) -> VideoShape:
	...
	def add_audio(self, filename: str, name: str, embed: bool) -> Audio:
	...
	def __init__(self, report_name: str, slide_name: str) -> None:

		"""

		Upon success it returns an object of class Slide for the given report name and slide name.
...
class Textbox:
	...
	::
		...
		def main():
		    ...
		    slide = rep.get_slides()[0]
		    shape = slide.add_textbox()
		    shape.set_text_style(autofit="no_autofit")
		    size = (0.25, 0.25)
	...
	def get_position(self, unit: str) -> Iterable[float]:
	...
	def set_position(self, position: Iterable[float], unit: str) -> bool:
	...
	def get_size(self, unit: str) -> Iterable[float]:
	...
	def set_size(self, size: Iterable[float], unit: str) -> bool:
	...
	def set_line_style(self, fill: str, color: windows.Color, width: float, dash: str, custom_dash_pattern: str, cap: str, join: str) -> bool:
	...
	def set_fill(self, fill: str, color: windows.Color, filename: str) -> bool:
	...
	def set_text_style(self, font_family: str, font_size: int, bold: bool, italic: bool, underline: bool, strike_through: bool, superscript: bool, subscript: bool, text_color: windows.Color, text_align: str, shape_align: str, autofit: str, wrap: bool) -> bool:
	...
	def get_margins(self, unit: str) -> Iterable[float]:
	...
	def __init__(self, report_name: str, slide_name: str, shape_name: str) -> None:

		"""

		Upon success it returns an object of class Textbox for the given report name, slide name and shape name.
...
class Line:
	...
	::
		...
		def main():
		    ...
		    #    ret = line.connect_p1(shape, connector=1)
		    print(ret)
		...
		#    ret = line.connect_p2(rect, connector=1)
	...
	def get_p1_position(self, unit: str) -> Iterable[float]:
	...
	def get_p2_position(self, unit: str) -> Iterable[float]:
	...
	def set_p1_position(self, position: Iterable[float], unit: str) -> bool:
	...
	def set_p2_position(self, position: Iterable[float], unit: str) -> bool:
	...
	def connect_p1(self, shape: object, position: str, connector: int) -> bool:
		...
		connector : int, optional
			The accepted integer values depend on the type of shape that the line connects to. 
			When connected to a rectangle the accepted values are 0-3. They correspond to the middle position of each side with 0 being the top, 1 the left, 2 the bottom and 3 the right side. 
			When connected to a triangle the accepted values are 0-5. 0, 2 and 4 correspond to the corners whereas 1,3 and 5 to the middle positions of the triangle's sides. 
			When connected to an ellipse the accepted values are 0-7, one for every 45 degrees. 0 corresponds to the top of the ellipse.
	...
	def __init__(self, report_name: str, slide_name: str, shape_name: str) -> None:
		...
		Upon success it returns an object of class Line for the given report name, slide name and shape name.
...
class Picture:
	...
	def set_transparent_background(self, transparent: bool, color: windows.Color) -> bool:
	...
	def get_original_size(self, unit: str) -> Iterable[float]:
	...
	def __init__(self, report_name: str, slide_name: str, shape_name: str) -> None:
		...
		Upon success it returns an object of class Picture for the given report name, slide name and shape name.
...
class Table:
	...
	def set_text_style(self, font_family: str, font_size: int, bold: bool, italic: bool, underline: bool, strike_through: bool, superscript: bool, subscript: bool, text_color: windows.Color, text_align: str, shape_align: str) -> bool:
	...
	def get_cell(self, position: Iterable[int]) -> TableCell:
	...
	def get_range(self, top_left: Iterable[int], bottom_right: Iterable[int]) -> TableRange:
	...
	def get_row(self, row: int) -> TableRange:
	...
	def get_column(self, column: int) -> TableRange:
	...
	def get_table_size(self) -> Iterable[int]:
	...
	def __init__(self, report_name: str, slide_name: str, shape_name: str) -> None:
		...
		Upon success it returns an object of class Table for the given report name, slide name and shape name.
...
class ExcelTable:
	...
	def get_spreadsheet(self) -> spreadsheet.Spreadsheet:
	...
	def __init__(self, report_name: str, slide_name: str, shape_name: str) -> None:
		...
		Upon success it returns an object of class ExcelTable for the given report name, slide name and shape name.
...
class ShapeGroup:
	...
	def __init__(self, report_name: str, slide_name: str, shape_name: str) -> None:
		...
		Upon success it returns an object of class ShapeGroup for the given report name, slide name and shape name.
...
class Rectangle:
	...
	def get_text_style(self, position: int) -> dict:
		...
		-------
		dict
			Python dictionary with the following text style options.
			font_family     string
			font_size       integer
			bold            boolean
			italic          boolean
			...
			superscript     boolean
			subscript       boolean
			text_color      meta.windows.Color
			text_align      string    ('left', 'center', 'right', 'justify')
			shape_align     string    ('top', 'middle', 'bottom', 'top_center', 'middle_center', 'bottom_center')
			autofit         string    ('no_autofit', 'shrink_text_on_overflow', 'resize_shape_to_fit_text')
			wrap            boolean
	...
	def __init__(self, report_name: str, slide_name: str, shape_name: str) -> None:
		...
		Upon success it returns an object of class Rectangle for the given report name, slide name and shape name.
...
class Ellipse:
	...
	def __init__(self, report_name: str, slide_name: str, shape_name: str) -> None:
		...
		Upon success it returns an object of class Ellipse for the given report name, slide name and shape name.
...
class Triangle:
	...
	def __init__(self, report_name: str, slide_name: str, shape_name: str) -> None:
		...
		Upon success it returns an object of class Triangle for the given report name, slide name and shape name.
...
class TableRange:
	...
	def __init__(self, report_name: str, slide_name: str, shape_name: str, top_left: list, bottom_right: list) -> None:

		"""

		Upon success it returns an object of class TableRange for the given report name, slide name, shape name and min and max column and row range.
		...
		top_left : list
			Minimum row and column of the cells (top left corner).

		bottom_right : list
			Maximum row and column (bottom right corner).
...
class TableCell:
	...
	::
		...
		def main():
		    ...
		    cell1 = table.get_cell((1, 2))
		    cell2 = table.get_cell((2, 2))
		    color = windows.Color(name="color1", r=0, g=255, b=0, a=255)
		
		    cell1.set_border_style("left", "no_line", 2, color)
		    cell2.set_border_style("left", "dash_line", 2, color)
		
		
		if __name__ == "__main__":
		    main()
		# method: get_border_style
		# PYTHON script
		import meta
		from meta import report
		from meta import windows
		...
		def main():
		    ...
		    borderStyle = cell.get_border_style("left")
		    print(borderStyle)
	...
	def set_border_style(self, side: str, dash: str, width: float, color: windows.Color) -> bool:

		"""

		Sets the style of the cell's left, right, top, or bottom border.


		Parameters
		----------
		side : str
			One of the following: "left", "right", "top", "bottom".
	...
	def get_border_style(self, side: str) -> dict:

		"""

		Returns the border style for the specified side of this cell. The returned dictionary can be directly applied to method set_border_style using the argument expand (**) operator.


		Parameters
		----------
		side : str
			One of the following values: 'left', 'right', 'top', or 'bottom'
		...
		dict
			...
			width: float
			color: windows.Color object
			dash: predefined dash pattern string

		"""


	def __init__(self, report_name: str, slide_name: str, shape_name: str, position: list) -> None:

		"""

		Upon success it returns an object of class TableCell for the given report name, slide name,shape name and cell position.
...
class ReportFilter:
	...
	def search(self, directory: str, folder_filter: str, file_filter: str, search_in_subfolders: bool) -> Iterable[str]:
	...
	def get_children(self) -> Iterable[ReportFilter]:
		...
		Returns
		-------
		Iterable[ReportFilter]
			List of report.ReportFilter objects

		"""


	def add_child(self, filter: ReportFilter) -> bool:
	...
	def remove_child(self, filter: ReportFilter) -> bool:
	...
	def __init__(self, type: str, name: str, operator: str, value: str, value2: str) -> None:

		"""

		Upon success it returns an object of class ReportFilter for the given type, name, operator, value and value2.
...
class ReportTag:
	...
	def get_children(self) -> Iterable[ReportTag]:
	...
	def add_child(self, tag: ReportTag) -> bool:
	...
	def remove_child(self, tag: ReportTag | str) -> bool:
	...
	def __init__(self, name: str, value: str) -> None:
		...
		Upon success it returns an object of class ReportTag for the given name and  value.
...
class Freeform:
	...
	::
		...
		def main():
		    ...
		    slide = rep.get_slides()[0]
		    freeform = slide.add_freeform()
		    freeform.set_text("some text")
		    print(freeform.get_text())
	...
	def remove_tag(self, tag: ReportTag | str) -> bool:
		...
		----------
		tag : ReportTag | str
			report.ReportTag object or tag name
	...
	def get_points(self, unit: str) -> list:
	...
	def set_points(self, points: list, unit: str) -> bool:
	...
	def __init__(self, report_name: str, slide_name: str, shape_name: str) -> None:
		...
		Upon success it returns an object of class FreeForm for the given report name, slide name and shape name.
...
class Model3D:
	...
	def __init__(self, report_name: str, slide_name: str, shape_name: str) -> None:
		...
		Upon success it returns an object of class Model3D for the given report name, slide name and shape name.
...
class VideoShape:
	...
	def __init__(self, report_name: str, slide_name: str, shape_name: str) -> None:
		...
		Upon success it returns an object of class VideoShape for the given report name, slide name and shape name.
...
class Audio:
	...
	::
		...
		def main():
		    ...
		    audio2 = report.Audio(
		        report_name=rep.name, slide_name=slide.name, shape_name=audio.name
		    )
		    print(audio2)
	...
	def __init__(self, report_name: str, slide_name: str, shape_name: str) -> None:
		...
		Upon success it returns an object of class Audio for the given report name, slide name and shape name.
