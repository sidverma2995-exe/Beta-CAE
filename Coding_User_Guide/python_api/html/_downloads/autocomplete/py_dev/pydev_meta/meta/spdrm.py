...
class process:
	def getDefinitionWorkflows() -> list[WorkflowDefinition]:
		...
		See Also
		--------
		meta.spdrm.process.WorkflowDefinition
	...
	def instantiateWorkflow(workflow_handle_id: int, input_slot_values: dict, input_dir: str) -> int:
		...
		See Also
		--------
		meta.spdrm.process.getDefinitionWorkflows, meta.spdrm.process.abortWorkflow
	...
	def getStateOfWorkflow(workflow_id: int) -> list:
		...
		See Also
		--------
		meta.spdrm.process.WorkflowStatus
	...
	def updateNodeProgress(node_id: int, node_progress: float, user_data: dict, dir: str) -> int:
		...
		See Also
		--------
		meta.spdrm.process.getStateOfWorkflow
	...
	def abortWorkflow(workflow_id: int) -> int:
		...
		See Also
		--------
		meta.spdrm.process.instantiateWorkflow, meta.spdrm.process.getStateOfWorkflow
	...
	def getWorkflowFiles(workflow_id: int) -> list:
		...
		See Also
		--------
		meta.spdrm.process.FilesRecord
	...
	def getDefinitionActions(type: str) -> list:
		...
		See Also
		--------
		meta.spdrm.process.ActionDefinition
	...
	class FilesRecord:
		...
		See Also
		--------
		meta.spdrm.process.getWorkflowFiles
	...
	class WorkflowDefinition:
		...
		See Also
		--------
		meta.spdrm.process.getDefinitionWorkflows
	...
	class WorkflowStatus:
		...
		See Also
		--------
		meta.spdrm.process.getStateOfWorkflow, meta.spdrm.process.RunningNode
	...
	class RunningNode:
		...
		See Also
		--------
		meta.spdrm.process.WorkflowStatus, meta.spdrm.process.getStateOfWorkflow, meta.spdrm.process.updateNodeProgress
	...
	class ActionDefinition:
		...
		See Also
		--------
		meta.spdrm.process.getDefinitionActions
	...
	class PexDriver:
		...
		See Also
		--------
		meta.spdrm.process.getPexDriver
	...
	def getBALApps(bal: str) -> list:
		...
		See Also
		--------
		meta.spdrm.process.getAvailableBALs
