...
def ConvertMorphToSizeBox(morphs_matrix: list[base.Entity], max_surface_length: float, max_volume_length: float) -> int:
	...
	Parameters
	----------
	morphs_matrix : list[base.Entity]
...
def DvgridStop(element: object, tolerance: float, ret_ent: bool) -> object:
	...
	------
	TypeError
		Invalid input element, should be a DVGRID object.
...
def MorphAdjust(hatch: base.Entity) -> int:
...
@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.AlignBoxPoints instead.")
def MorphAlign(id_curve_or_plane: int, curve_or_plane: str, mpoints: base.Entity, flag: int) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.AlignBoxPoints` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.AlignBoxPoints instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.AlignBoxPoints instead.")
def MorphAlign3Grids(grid1: base.Entity, grid2: base.Entity, grid3: base.Entity, m1: list[base.Entity], flag: int) -> int:
...
def MorphBoxDel(boxes: list[base.Entity]) -> int:
...
def MorphBoxUndel(morphes: list[base.Entity]) -> int:
...
def MorphByPoints(points: list[base.Entity], solid_type: str) -> base.Entity:
...
def MorphCalcDvgrid(morph_points: list[base.Entity], directory: str, entities_flag: int) -> int:
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.base.CollectEntities instead.")
def MorphContents(morphes: list[base.Entity]) -> list[base.Entity]:

	"""
	.. deprecated:: 21.0.0
		Use :py:func:`ansa.base.CollectEntities` instead.
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.base.CollectEntities instead.", DeprecationWarning)

def MorphConvert(convert_type: str, entities: list[base.Entity], options: int) -> list[base.Entity]:
...
def MorphCylindrical(curve: list[base.Entity], rad1: float, rad2: float, auto_sort: bool=True) -> base.Entity:
	...
	Notes
	-----
	In case curve contains a list of POINTs, they should be provided in the correct order.
	"auto_sort" argument is only applicable when CURVEs are provided in curve list.
...
def MorphDepress(curve: base.Entity, set: base.Entity, matrix: list) -> int:
...
def MorphDirectFit(Origin_Target: list[base.Entity], Entities: list[base.Entity], Bounds: list[base.Entity]) -> int:
	...
	Parameters
	----------
	Origin_Target : list[base.Entity]
...
def MorphEdgeFit(origin_target: list, edge_fit_add_flag: bool, morphing_flag: bool) -> int:
...
def MorphFacesAccordingNodes(faces: list[base.Entity]) -> int:
...
def MorphHistoryState(history_state: base.Entity) -> int:
...
def MorphInner(morph: base.Entity, dist: float) -> int:
...
def MorphInsert(pnt1: base.Entity, pnt2: base.Entity, edg: base.Entity, s: str) -> int:
...
def MorphJoin(hatch: base.Entity, flag: int) -> int:

	"""

	Script function for joining morph hatches

	Parameters
	----------
	hatch : base.Entity
		The morph hatch element(s) that will be joined.
	...
	::
		...
		def join():
		    ...
		    ents = base.CollectEntities(constants.NASTRAN, None, "MORPHFACE")
		    morph.MorphJoin(ents, 1)


	"""

def MorphLoad(morphes_to_load: list[base.Entity], entities_to_load: list[base.Entity], db_or_visib: str, strict_project: bool, keep_loaded: bool) -> int:
	...
	Parameters
	----------
	morphes_to_load : list[base.Entity]
		A list of target morphing boxes.

	entities_to_load : list[base.Entity], optional
	...
	Notes
	-----
	If both 'entities_to_load' and 'db_or_visib' are not defined, morphing box loaded 
	entities are removed and box does not morph any entities.
...
@typing_extensions.deprecated("Deprecated since version 23.1.4.Use ansa.morph.DeformMap instead.")
def MorphMappingDeformations(deformation_parameter: list[base.Entity], moved_elements: list[base.Entity], sampling_points: int, work_on_visible: bool, bound_entities: bool | list[base.Entity], max_displacement: float) -> int:

	"""
	.. deprecated:: 23.1.4
		Use :py:class:`ansa.morph.DeformMap` instead.
	...
	Parameters
	----------
	deformation_parameter : list[base.Entity]
	...
	moved_elements : list[base.Entity]
	...
	bound_entities : bool | list[base.Entity], optional
	...
	TypeError
		Invalid entries in moved_elements

	TypeError
		Invalid entries inside deformation parameters array

	Notes
	-----
	Note: The older format of this function MorphMappingDeformations(x, y, z, dx, dy, dz, moved_elements, sampling_points) still works but is deprecated. Please do not develop new code using this old format
	...
	warnings.warn("Deprecated since version 23.1.4.Use ansa.morph.DeformMap instead.", DeprecationWarning)

def MorphMinMax(coordinate: base.Entity, min_xyz: list[float], max_xyz: list[float]) -> int:
...
def MorphMove(morph_points: list[base.Entity], morph_edges: list[base.Entity], flag: int, dist: float) -> int:
...
def MorphMultBox(coord: base.Entity, load: list[base.Entity], min_flag: int, factor: float) -> list[base.Entity]:
...
def MorphMultBoxAbsDis(coord: base.Entity, load: list[base.Entity], min_flag: int, distance: float, boxesType: int) -> list[base.Entity]:
...
def MorphNested(set: base.Entity, reference_grid: base.Entity) -> int:
...
def MorphNumber(morph_edge: base.Entity | list[base.Entity], string: str) -> int:
	...
	Parameters
	----------
	morph_edge : base.Entity | list[base.Entity]
...
def MorphOffset(morph_hatces: list[base.Entity], offset_value: float, flag_morphing: int) -> int:
...
def MorphOffsetBox(morph_hatches: list[base.Entity], offset_value: float) -> list[base.Entity]:
	...
	Parameters
	----------
	morph_hatches : list[base.Entity]
...
def MorphOneDimCreate(curves_list: list[base.Entity], load_radius: float, part: base.Entity) -> base.Entity:
	...
	Parameters
	----------
	curves_list : list[base.Entity]
		A list with curves or points to create the one dimensional morph.

	load_radius : float
		The load radius of the created morph.Defines the morhing area around the Box.

	part : base.Entity, optional
...
def MorphOrtho(loaded_elements: list[base.Entity], db_or_visible: str, coordinate: base.Entity, min_flag: bool, directions: list[list]) -> base.Entity:
	...
	Parameters
	----------
	loaded_elements : list[base.Entity], optional
	...
	coordinate : base.Entity, optional
		A local coordinate object instead of global. This input will discard input of 'directions' argument.

	min_flag : bool, optional
		True or False for minimum volume morph.

	directions : list[list], optional
		A list of 2 directions to define specific orientation for the morph box. Must be perpendicular to each other. To be used instead of 'coordinate' argument.
	...
	::
		...
		def morph():
		    ...
		    coord = base.GetEntity(0, "CORD_C", a_id)
		    morph.MorphOrtho(loaded_elements=shells, coordinate=coord)


	"""

def MorphParPrj(dx: float, dy: float, dz: float, morph: base.Entity, morph_edge: base.Entity) -> int:
...
def MorphParam(param: base.Entity, dist: float) -> int:
...
def MorphParamCreate(name: str, type: str, arguments_list: list) -> int:
	...
	Notes
	-----
	In case you provide a list of lists as the first argument you should provide a list, of translate vector lists, of the same length as the second argument.                   See Examples for more info.          "DFMRotate" -- it will create a DFM Rotate parameter.          arguments_list: object is list with 6 entries                         list of entities or list of lists of entities to be rotated,                         list [x, y, z, dx, dy, dz] or list of lists [x, y, z, dx, dy, dz] with the rotation axis,                         list of entities to be morphed,                         list of bounds,                         C.Entities Sampling flag: 0 to disable sampling, 1 to sample points from perimeters                         Auto Bounds flag: 1 to activate automatic bounds recognition, 0 otherwise.          In case you provide a list of lists as the first argument you should provide a list, of rotation axis matrices, of the same length as the second argument.                   See Examples for more info.          "DFMScale" -- it will create a DFM Rotate parameter.          arguments_list: object is list with 6 entries                         list of entities or list of lists of entities to be scaled,                         list [x, y, z] or list of lists [x, y, z] with the origin(s),                         list of entities to be morphed,                         list of bounds,                         C.Entities Sampling flag: 0 to disable sampling, 1 to sample points from perimeters                         Auto Bounds flag: 1 to activate automatic bounds recognition, 0 otherwise.          In case you provide a list of lists as the first argument you should provide a list, of origins matrices, of the same length as the second argument.                   See Examples for more info.          "DFMTransform" -- it will create a DFM transform parameter.          arguments_list: object is list with 6 entries                         list of entities or list of lists of entities to be transformed,                         list of 2 ANSA Coordinate systems (coord1, coord2) or list of list of 2 ANSA Coordinate                                 systems or list of six points [x0, y0, z0, x1, y1, z1, ...] (total 18 floats)                                 discribing two local coordinate system or list of list of six points.                         list of entities to be morphed,                         list of bounds,                         C.Entities Sampling flag: 0 to disable sampling, 1 to sample points from perimeters                         Auto Bounds flag: 1 to activate automatic bounds recognition, 0 otherwise.          In case you provide a list of lists as the first argument you should provide a list, of coordinate system matrices, of the same length as the second argument.                   See Examples for more info.          "DFMOffset" -- it will create a DFM offset parameter.          arguments_list: object is list with 5 entries                         list of entities or list of lists of entities for offset,                         list of entities to be additionally morphed,                         list of bounds                         C.Entities Sampling flag: 0 to disable sampling, 1 to sample points from perimeters                         Auto Bounds flag: 1 to activate automatic bounds recognition, 0 otherwise          "DFMSurfaceFit" -- it will create a DFM Surface Fit parameter.          arguments_list: object is list with 7 entries                         list or list of lists of origin entities,                         list or list of lists of target entities,                         list or list of lists of origin corresponding nodes,                         list or list of lists of target corresponding nodes,                         list of entities to be additionally morphed,                         list of bounds                         Auto Bounds flag: 1 to activate automatic bounds recognition, 0 otherwise   See examples for more information.         "DFMEdgeFit" -- it will create a DFM Edge Fit parameter.         arguments_list: object is list with 5 entries                         list or list of lists of origin entities,                         list or list of lists of target entities,                         list of entities to be additionally morphed,                         list of bounds                         Auto Bounds flag: 1 to activate automatic bounds recognition, 0 otherwise          See examples for more information          "SLFeatureTranslate" -- it will create a Slide feature Translate parameter.         argumets_list: object is a list with 5 entities                         list of entities to be included                         coordinate system object                         dx, dy, dz vector          See examples for more information.          "SLFeatureRotate" -- it will create a Slide feature Rotate parameter.         arguments_list: object is a list with 8 entries                         list of entities to be included                         coordinate system object                         origin_x, origin_y, origin_z origin position                         dx, dy, dz vector          See examples for more information.          "SLFeatureScale" -- it will create a Slide feature Scale parameter.         arguments_list: object is a list with 4 entries                         list of entities to be included                         scale points coordinates origin_x, origin_y, origin_z          See examples for more information.          "SLFeatureCurve" -- it will create a Slide feature Curve parameter.         argumets_list: object is a list with 3 entries                         list of entities to be included                         Curve                         Auto orientation flag: 1 follow curve's orientation, 0 otherwise.          See examples for more information.

	See Also
	--------
	ansa.morph.NewParameterDFMFitEdges, ansa.morph.NewParameterAngle, ansa.morph.NewParameterDeformation, ansa.morph.NewParameterDFMAlign, ansa.morph.NewParameterDFMFitSurfaces, ansa.morph.NewParameterDFMOffset, ansa.morph.NewParameterDFMRotate, ansa.morph.NewParameterDFMScale, ansa.morph.NewParameterDFMTranslate, ansa.morph.NewParameterDFMTransform, ansa.morph.NewParameterTransform, ansa.morph.NewParameterTranslate, ansa.morph.NewParameterEdgeFit, ansa.morph.NewParameterExtend, ansa.morph.NewParameterOffset, ansa.morph.NewParameterRadiusInner, ansa.morph.NewParameterRadiusOuter, ansa.morph.NewParameterRotate, ansa.morph.NewParameterUserTangent, ansa.morph.NewParameterScale, ansa.morph.NewParameterSlideFeatureCurve, ansa.morph.NewParameterSlideFeatureRotate, ansa.morph.NewParameterSlideFeatureScale, ansa.morph.NewParameterSlideFeatureTranslate, ansa.morph.NewParameterTailoredBlank
...
def MorphPaste(hatch1: base.Entity, hatch2: base.Entity, paste_on_middle: bool) -> int:
...
def MorphPntSnap(grid_point: base.Entity, morph_point: base.Entity, flag: int) -> int:
	...
	Parameters
	----------
	grid_point : base.Entity
		The grid point to get coordinates.

	morph_point : base.Entity
...
def MorphPointDel(morph_points: list[base.Entity]) -> int:
...
def MorphProject(x: float, y: float, z: float, morph_edge: base.Entity) -> int:
...
def MorphRadius(morph_hatces: list[base.Entity], d: float, flag: int) -> int:
...
def MorphRelocate(morph_edges: list[base.Entity]) -> int:
...
def MorphScale(morph: base.Entity, flag: int, d1: float, d2: float, d3: float, d4: float) -> int:
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.BoxSplit instead.")
def MorphSplit(box_points: base.Entity | list[base.Entity], non_isoparam: bool, fit_new_skin_edges: bool, box_edges: base.Entity | list[base.Entity], number_of_splits: int, work_on: str) -> int:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.BoxSplit` instead.
	...
	Parameters
	----------
	box_points : base.Entity | list[base.Entity], optional
	...
	box_edges : base.Entity | list[base.Entity], optional
	...
	See Also
	--------
	ansa.morph.MorphSplitProject, ansa.morph.MorphSplitToHexa, ansa.morph.MorphSplitToPenta
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.BoxSplit instead.", DeprecationWarning)

def MorphTangent(entities: list[base.Entity]) -> int:
...
def MorphTopoVis(tolerance: str) -> int:
	...
	------
	ValueError
		MorphTopo: Invalid tolerance input.

	See Also
	--------
	ansa.morph.MorphTopo
...
def MorphUserTangent(m1: list[base.Entity], dx: float, dy: float, dz: float) -> int:
...
def PerformDoeStudy(opt_task_id: int, comb_file: str, dir_path: str, solver: str=None, solver_session_file: str=None, post_processing: str=None, meta_session_file: str=None, meta_response_file: str="response.txt", empty_experiments_directory: bool=False, single_directory: bool=False, pre_processing: str="create_experiments", save_database: bool=False, dm_signature: object=None, sim_run_save_action: str=None, detailed_results: bool=False, upload_doe_study: bool=False, existing_doe_study: str=None) -> int:
	...
	solver_session_file : str, optional
		The path of the session file necessary to run a solver. Session file is essential for running Ansys.
	...
	meta_response_file : str, optional
		...
		This keyword is optional for running META
	...
	pre_processing : str, optional
		...
		It defines if DOE will be performed to existing experiments or it will create new.
	...
	Notes
	-----
	The database for which we run DOE should be saved before the execution of DOE study.
	...
	::
		...
		def main():
		    # local DOE study perform
		    morph.PerformDoeStudy(1, "./combinations.txt", "./DOE_Run_001/")
		
		    # DM DOE study perform
		    dm_signature = createDMSignature()
...
def MorphEdgeFitOnSurfs(edges: list[base.Entity], surface_ents: list[base.Entity] | int, add_pnts: int, search_distance: float, user_projection_mode_vector: list[float]) -> int:
	...
	Parameters
	----------
	edges : list[base.Entity]
		A list with morph edges.

	surface_ents : list[base.Entity] | int
	...
	user_projection_mode_vector : list[float], optional
	...
	------
	TypeError
		Box edges are not defined.

	TypeError
		Target surface is not defined.

	TypeError
		Error in projection vector definition. Zero vector detected.
...
def MorphParamMerge(parameters: list[base.Entity]) -> int:
...
def MorphInnerMod(edge: base.Entity, morph_entities: int, ddiam: float) -> int:
...
@typing_extensions.deprecated("Deprecated since version 21.1.0.Use ansa.morph.DCFeatureSlide instead.")
def MorphSlFeatureCurve(elements: list[base.Entity], curve: base.Entity, dist: float, orient: int, copy: int) -> list:

	"""
	.. deprecated:: 21.1.0
		Use :py:class:`ansa.morph.DCFeatureSlide` instead.
	...
	warnings.warn("Deprecated since version 21.1.0.Use ansa.morph.DCFeatureSlide instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 21.1.0.Use ansa.morph.DCFeatureSlide instead.")
def MorphSlFeatureRotate(elements: list[base.Entity], p1: base.Entity, angle: float, origin_x: float, origin_y: float, origin_z: float, dx: float, dy: float, dz: float, copy: int) -> list[list]:
...
@typing_extensions.deprecated("Deprecated since version 21.1.0.Use ansa.morph.DCFeatureSlide instead.")
def MorphSlFeatureTransl(elements: list[base.Entity], p1: base.Entity, dist: float, dx: float, dy: float, dz: float, copy: int) -> list[list]:
...
def MorphSweepGlide(extrusion_type: str, guideline_ents: list[base.Entity], box_face: base.Entity, curves: list[base.Entity], points: list[base.Entity], section_type: str, radius: float, width: float, dx: float, dy: float, dz: float, height: float, lower_base: float, upper_base: float) -> list[base.Entity]:
...
def MorphCornerPoints(boxes: base.Entity | list[base.Entity]) -> list[base.Entity]:
	...
	Parameters
	----------
	boxes : base.Entity | list[base.Entity]
...
@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterTranslate instead.")
def MorphParamCreateTranslate(name: str, morph_points: list[base.Entity], coord: base.Entity | None, dx: float, dy: float, dz: float) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterTranslate` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterTranslate instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterEdgeFit instead.")
def MorphParamCreateEdgeFit(name: str, morph_edges: list, curves: list) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterEdgeFit` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterEdgeFit instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterExtend instead.")
def MorphParamCreateExtend(name: str, morph_points: list[base.Entity], morph_edges: list[base.Entity]) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterExtend` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterExtend instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterOffset instead.")
def MorphParamCreateOffset(name: str, morph_faces: list[base.Entity]) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterOffset` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterOffset instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterRadiusOuter instead.")
def MorphParamCreateRadiusOuter(name: str, morph_faces: list[base.Entity]) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterRadiusOuter` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterRadiusOuter instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterRadiusInner instead.")
def MorphParamCreateRadiusInner(name: str, concentric_edges: list[base.Entity]) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterRadiusInner` instead.
	...
	concentric_edges : list[base.Entity]
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterRadiusInner instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterDFMAlign instead.")
def MorphParamCreateSetsAlign(name: str, s_elements: base.Entity, s_aligned: base.Entity, s_retained: base.Entity, s_target: base.Entity, search_distance: float) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterDFMAlign` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterDFMAlign instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterDFMOffset instead.")
def MorphParamCreateSetsOffset(name: str, s_elements: base.Entity, s_offset: base.Entity, s_retained: base.Entity) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterDFMOffset` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterDFMOffset instead.", DeprecationWarning)

def MorphParamCreateSetsTranslate(name: str, s_elements: base.Entity, s_translate: base.Entity, s_retained: base.Entity, dx: float, dy: float, dz: float) -> int:
...
@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterDFMRotate instead.")
def MorphParamCreateSetsRotate(name: str, s_elements: base.Entity, s_rotate: base.Entity, s_retained: base.Entity, x: float, y: float, z: float, dx: float, dy: float, dz: float) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterDFMRotate` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterDFMRotate instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterAngle instead.")
def MorphParamCreateAngle(name: str, morph_edges: list[base.Entity]) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterAngle` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterAngle instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterRotate instead.")
def MorphParamCreateRotate(name: str, morph_points: list[base.Entity], coord: base.Entity | None, x: float, y: float, z: float, dx: float, dy: float, dz: float) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterRotate` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterRotate instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterDeformation instead.")
def MorphParamCreateDeformation(name: str, affected: str) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterDeformation` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterDeformation instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterScale instead.")
def MorphParamCreateScale(name: str, morph_points: list[base.Entity], x: float, y: float, z: float) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterScale` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterScale instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterUserTangent instead.")
def MorphParamCreateUserTangent(name: str, morph_tang: list[base.Entity]) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterUserTangent` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterUserTangent instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewParameterDFMFitEdges instead.")
def MorphParamCreateDFMFitEdges(name: str, edge_fit_args: list, entities: list[base.Entity], bounds: list[base.Entity], autobounds: bool) -> int:

	"""
	.. deprecated::
		Use :py:func:`ansa.morph.NewParameterDFMFitEdges` instead.
	...
	warnings.warn("Deprecated.Use ansa.morph.NewParameterDFMFitEdges instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewDFMFitEdgesArgs instead.")
def MorphCreateDFMFitEdgesArgs(source: object, target: object) -> object:

	"""
	.. deprecated::
		Use :py:func:`ansa.morph.NewDFMFitEdgesArgs` instead.
	...
	See Also
	--------
	ansa.morph.MorphParamCreateDFMFitEdges
	...
	warnings.warn("Deprecated.Use ansa.morph.NewDFMFitEdgesArgs instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewParameterDFMFitSurfaces instead.")
def MorphParamCreateDFMFitSurfaces(name: str, surafce_fit_args: list, morphed: list[base.Entity], bounds: list[base.Entity], autobounds: bool) -> int:

	"""
	.. deprecated::
		Use :py:func:`ansa.morph.NewParameterDFMFitSurfaces` instead.
	...
	warnings.warn("Deprecated.Use ansa.morph.NewParameterDFMFitSurfaces instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewDFMFitSurfsArgs instead.")
def MorphCreateDFMFitSurfsArgs(source_area: object, target_area: object, source_points: object, target_points: object) -> object:

	"""
	.. deprecated::
		Use :py:func:`ansa.morph.NewDFMFitSurfsArgs` instead.
	...
	Notes
	-----
	The source_points and target_points lists must be of the same length.
	Correspondence of perimetric points is based on indicies of the two lists i.e. each point of the source_points 
	will be matched to the point of the target_points with the same index.

	See Also
	--------
	ansa.morph.MorphParamCreateDFMFitSurfaces
	...
	warnings.warn("Deprecated.Use ansa.morph.NewDFMFitSurfsArgs instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewParameterDFMTranslate instead.")
def MorphParamCreateDFMTranslate(name: str, translate_arg: list, entities: list[base.Entity], bounds: list[base.Entity], autobounds: bool) -> int:

	"""
	.. deprecated::
		Use :py:func:`ansa.morph.NewParameterDFMTranslate` instead.
	...
	warnings.warn("Deprecated.Use ansa.morph.NewParameterDFMTranslate instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewDFMTranslateArgs instead.")
def MorphCreateDFMTranslateArgs(translated: object, dx: float, dy: float, dz: float) -> object:

	"""
	.. deprecated::
		Use :py:func:`ansa.morph.NewDFMTranslateArgs` instead.
	...
	See Also
	--------
	ansa.morph.MorphParamCreateDFMTranslate
	...
	warnings.warn("Deprecated.Use ansa.morph.NewDFMTranslateArgs instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewParameterDFMRotate instead.")
def MorphParamCreateDFMRotate(name: str, rotate_args: list, entities: list[base.Entity], bounds: list[base.Entity], autobounds: bool) -> int:
	...
	warnings.warn("Deprecated.Use ansa.morph.NewParameterDFMRotate instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewDFMRotateArgs instead.")
def MorphCreateDFMRotateArgs(rotated: object, x: float, y: float, z: float, dx: float, dy: float, dz: float) -> object:

	"""
	.. deprecated::
		Use :py:func:`ansa.morph.NewDFMRotateArgs` instead.
	...
	See Also
	--------
	ansa.morph.MorphParamCreateDFMRotate
	...
	warnings.warn("Deprecated.Use ansa.morph.NewDFMRotateArgs instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewParameterDFMScale instead.")
def MorphParamCreateDFMScale(name: str, scale_args: list, entities: list[base.Entity], bounds: list[base.Entity], autobounds: bool) -> int:

	"""
	.. deprecated::
		Use :py:func:`ansa.morph.NewParameterDFMScale` instead.
	...
	warnings.warn("Deprecated.Use ansa.morph.NewParameterDFMScale instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewDFMScaleArgs instead.")
def MorphCreateDFMScaleArgs(scaled: object, x: float, y: float, z: float) -> object:

	"""
	.. deprecated::
		Use :py:func:`ansa.morph.NewDFMScaleArgs` instead.
	...
	See Also
	--------
	ansa.morph.MorphParamCreateDFMScale
	...
	warnings.warn("Deprecated.Use ansa.morph.NewDFMScaleArgs instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewParameterDFMTransform instead.")
def MorphParamCreateDFMTransform(name: str, transformed_args: list, entities: list[base.Entity], bounds: list[base.Entity], autobounds: bool) -> int:

	"""
	.. deprecated::
		Use :py:func:`ansa.morph.NewParameterDFMTransform` instead.
	...
	warnings.warn("Deprecated.Use ansa.morph.NewParameterDFMTransform instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewDFMTransformArgs instead.")
def MorphCreateDFMTransformArgs(transformed: object, src_coord: object, trg_coord: object) -> object:

	"""
	.. deprecated::
		Use :py:func:`ansa.morph.NewDFMTransformArgs` instead.
	...
	See Also
	--------
	ansa.morph.MorphParamCreateDFMTransform
	...
	warnings.warn("Deprecated.Use ansa.morph.NewDFMTransformArgs instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewParameterDFMOffset instead.")
def MorphParamCreateDFMOffset(name: str, offset: list[base.Entity], entities: list[base.Entity], bounds: list[base.Entity], autobounds: bool) -> int:
	...
	warnings.warn("Deprecated.Use ansa.morph.NewParameterDFMOffset instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterSlideFeatureTranslate instead.")
def MorphParamCreateSlideFeatureTranslate(name: str, elements: list[base.Entity], coord: base.Entity | None, dx: float, dy: float, dz: float) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterSlideFeatureTranslate` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterSlideFeatureTranslate instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterSlideFeatureRotate instead.")
def MorphParamCreateSlideFeatureRotate(name: str, elements: list[base.Entity], coord: base.Entity | None, x: float, y: float, z: float, dx: float, dy: float, dz: float) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterSlideFeatureRotate` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterSlideFeatureRotate instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterSlideFeatureScale instead.")
def MorphParamCreateSlideFeatureScale(name: str, elements: list[base.Entity], x: float, y: float, z: float) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterSlideFeatureScale` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterSlideFeatureScale instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterSlideFeatureCurve instead.")
def MorphParamCreateSlideFeatureCurve(name: str, elements: list[base.Entity], curve: base.Entity, follow_orientation: bool) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterSlideFeatureCurve` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterSlideFeatureCurve instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewDFMAlignArgs instead.")
def MorphCreateDFMAlignArgs(entities: object, target_entities: object, target_axis: object, target_plane: object, include_thickness: bool, max_distance: float, user_direction: object) -> object:

	"""
	.. deprecated::
		Use :py:func:`ansa.morph.NewDFMAlignArgs` instead.
	...
	Notes
	-----
	target_entities, target_axis and target_axis are mutually exclusive arguments and only one of them should be provided.

	See Also
	--------
	ansa.morph.MorphParamCreateDFMAlign
	...
	warnings.warn("Deprecated.Use ansa.morph.NewDFMAlignArgs instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated.Use ansa.morph.NewParameterDFMAlign instead.")
def MorphParamCreateDFMAlign(name: str, align_args: list, entities: list[base.Entity], bounds: list[base.Entity], autobounds: bool) -> int:
	...
	warnings.warn("Deprecated.Use ansa.morph.NewParameterDFMAlign instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterTailoredBlank instead.")
def MorphParamCreateTailoredBlank(entities: list[base.Entity], properties: list[base.Entity], lengths: list[float], origin: list[float], normal: list[float], trajectory: list[base.Entity]=[], movement: int=0, cut_mesh: bool=False, reconstruct: bool=False, zones: int=0, name: str="") -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterTailoredBlank` instead.
	...
	trajectory : list[base.Entity], optional
	...
	Notes
	-----
	'properties' and 'lenghts' matricies should have the same length.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterTailoredBlank instead.", DeprecationWarning)

def MorphPointProjectToContainer(box_points: list[base.Entity], target_entities: list[base.Entity], offset: float, coordinate_system: base.Entity, freeze_x_axis: bool, freeze_y_axis: bool, freeze_z_axis: bool) -> int:
	...
	target_entities : list[base.Entity]
	...
	coordinate_system : base.Entity, optional
...
def xyzIsInsideBox(x: float, y: float, z: float) -> list:
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.Create instead.")
def CreateStamp(stamp_type: str, stamp_entities: list[base.Entity], stamp_parameters: list, direction_points: list, invert_direction: bool, auto_reconstruct: dict, add_to_set: int, save_morph_parameter: bool, return_characteristics: bool, top_is_width: bool, detached_feature: list, exclude_feature_recon: bool) -> list | int | dict:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.Create` instead.
	...
	direction_points : list, optional
	...
	auto_reconstruct : dict, optional
	...
	detached_feature : list, optional
	...
	See Also
	--------
	ansa.morph.CreateBead, ansa.morph.CreateFlangedOpening, ansa.morph.CreateOpening, ansa.morph.CreateRib
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.Create instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.Create instead.")
def CreateBead(bead_type: str, bead_entities: Iterable[base.Entity], bead_parameters: list, invert_direction: bool, auto_reconstruct: dict, add_to_set: int, save_morph_parameter: bool, direction_points: Iterable[base.Entity], return_characteristics: bool, top_is_width: bool, detached_feature: Iterable[float], exclude_feature_recon: bool) -> list[base.Entity] | int | dict:
	...
	----------
	bead_type : str
		The type of the bead. Accepted values: "Straight", "Straight rounded", "Straight sloped", "Curved", "Curved rounded", "Curved sloped","X type", "X type rounded","L type", "L type rounded", "T type", "T type rounded", "X type sloped", "L type sloped", "T type sloped".

	bead_entities : Iterable[base.Entity]
		A list of entities, where the bead will be created.

	bead_parameters : list
	...
	direction_points : Iterable[base.Entity], optional
	...
	detached_feature : Iterable[float], optional
		A list with 2 values (flanges width and offset distance) to create a detached feature.
	...
	Returns
	-------
	list[base.Entity] | int | dict
		Returns the shells of the created stamp or 0 on error, use "return_characteristics" to return a dictionary

	See Also
	--------
	ansa.morph.CreateStamp, ansa.morph.CreateFlangedOpening, ansa.morph.CreateOpening, ansa.morph.CreateRib
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.Create instead.")
def CreateFlangedOpening(open_type: str, open_entities: list[base.Entity], open_parameters: list, direction_points: list, invert_direction: bool, auto_reconstruct: dict, add_to_set: int, save_morph_parameter: bool, return_characteristics: bool, top_is_width: bool, detached_feature: list, exclude_feature_recon: bool) -> list | int | dict:
	...
	See Also
	--------
	ansa.morph.CreateStamp, ansa.morph.CreateBead, ansa.morph.CreateOpening, ansa.morph.CreateRib
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.Create instead.")
def CreateOpening(open_type: str, open_entities: list[base.Entity], open_parameters: list, direction_points: list, invert_direction: bool, auto_reconstruct: dict, add_to_set: int, save_morph_parameter: bool) -> list:
	...
	See Also
	--------
	ansa.morph.CreateStamp, ansa.morph.CreateBead, ansa.morph.CreateFlangedOpening, ansa.morph.CreateRib
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.Create instead.")
def CreateRib(rib_type: str, rib_entities: list[base.Entity], rib_parameters: list, add_to_set: int, auto_reconstruct: dict, exclude_feature_recon: bool) -> list:
	...
	See Also
	--------
	ansa.morph.CreateStamp, ansa.morph.CreateBead, ansa.morph.CreateFlangedOpening, ansa.morph.CreateOpening
...
def SimulateDoeWindow(mainitem: base.Entity, values: str, designs: int, algorithm: str, generate: bool, experiments_file: str="") -> int:
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.ConstraintPlanar instead.")
def MorphConstraintPlanar(entities: object, morphed: object, bounds: object, autobounds: bool) -> object:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.ConstraintPlanar` instead.
	...
	See Also
	--------
	ansa.morph.MorphConstraintRigid, ansa.morph.MorphConstraintScaled, ansa.morph.MorphConstraintDirectional, ansa.morph.MorphConstraintPathFollower, ansa.morph.MorphConstraintFlange, ansa.morph.ConstraintPlanar, ansa.morph.ConstraintRigid, ansa.morph.ConstraintScaled, ansa.morph.ConstraintDirectional, ansa.morph.ConstraintPathFollower, ansa.morph.ConstraintFlanges
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.ConstraintPlanar instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.ConstraintRigid instead.")
def MorphConstraintRigid(entities: object, morphed: object, bounds: object, autobounds: bool) -> object:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.ConstraintRigid` instead.
	...
	See Also
	--------
	ansa.morph.MorphConstraintPlanar, ansa.morph.MorphConstraintScaled, ansa.morph.MorphConstraintDirectional, ansa.morph.MorphConstraintPathFollower, ansa.morph.MorphConstraintFlange, ansa.morph.ConstraintPlanar, ansa.morph.ConstraintRigid, ansa.morph.ConstraintScaled, ansa.morph.ConstraintDirectional, ansa.morph.ConstraintPathFollower, ansa.morph.ConstraintFlanges
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.ConstraintRigid instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.ConstraintScaled instead.")
def MorphConstraintScaled(entities: object, morphed: object, bounds: object, autobounds: bool) -> object:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.ConstraintScaled` instead.
	...
	See Also
	--------
	ansa.morph.MorphConstraintPlanar, ansa.morph.MorphConstraintRigid, ansa.morph.MorphConstraintDirectional, ansa.morph.MorphConstraintPathFollower, ansa.morph.MorphConstraintFlange, ansa.morph.ConstraintPlanar, ansa.morph.ConstraintRigid, ansa.morph.ConstraintScaled, ansa.morph.ConstraintDirectional, ansa.morph.ConstraintPathFollower, ansa.morph.ConstraintFlanges
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.ConstraintScaled instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.ConstraintDirectional instead.")
def MorphConstraintDirectional(entities: object, morphed: object, bounds: object, coordinate: object, x_status: str, y_status: str, z_status: str, autobounds: bool) -> object:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.ConstraintDirectional` instead.
	...
	See Also
	--------
	ansa.morph.MorphConstraintPlanar, ansa.morph.MorphConstraintRigid, ansa.morph.MorphConstraintScaled, ansa.morph.MorphConstraintPathFollower, ansa.morph.MorphConstraintFlange, ansa.morph.ConstraintPlanar, ansa.morph.ConstraintRigid, ansa.morph.ConstraintScaled, ansa.morph.ConstraintDirectional, ansa.morph.ConstraintPathFollower, ansa.morph.ConstraintFlanges
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.ConstraintDirectional instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.ConstraintPathFollower instead.")
def MorphConstraintPathFollower(entities: list[base.Entity], morphed: list[base.Entity], bounds: list[base.Entity], path: list[base.Entity], autobounds: bool=False) -> base.Entity:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.ConstraintPathFollower` instead.
	...
	See Also
	--------
	ansa.morph.MorphConstraintPlanar, ansa.morph.MorphConstraintRigid, ansa.morph.MorphConstraintScaled, ansa.morph.MorphConstraintDirectional, ansa.morph.ConstraintFlanges
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.ConstraintPathFollower instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.BoxSplit instead.")
def MorphSplitProject(box_edge: base.Entity, points: base.Entity, fit_new_skin_edges: bool, work_on: str) -> int:
	...
	See Also
	--------
	ansa.morph.MorphSplit, ansa.morph.MorphSplitToHexa, ansa.morph.MorphSplitToPenta
...
def MorphAdaptCrossections(entities: list[base.Entity], number_or_length: str) -> list[base.Entity]:
...
def MorphByCurves(height_edges: list[base.Entity], top_bottom_edges: list[base.Entity]) -> base.Entity:
	...
	See Also
	--------
	ansa.morph.MorphOrtho, ansa.morph.MorphByPoints
...
def Morph2DCreate(type: str, entities: Iterable[base.Entity], thickness: float, delete_original: bool, paste: bool, convert_to_ortho: bool) -> base.Entity | list[base.Entity]:
...
def MorphEdgesRedistribute(box_edges: list[base.Entity], factor: float, nodal_number_redistribution: bool) -> int:
	...
	ValueError
		Factor should vary from 0 to 1.

	ValueError
		Branching edges detected, cannot redistribute.
...
def MorphEdgesMatch(box_edges: list[base.Entity], target_edges: list[base.Entity], factor: float) -> None:
	...
	------
	ValueError
		Error, no box edges defined.

	ValueError
		Error, no target edges defined.
...
def MorphTopo(boxes: list[base.Entity], tolerance: str) -> int:
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.BoxSplit instead.")
def MorphSplitToPenta(box_points: list[base.Entity]) -> int:
	...
	See Also
	--------
	ansa.morph.MorphSplit, ansa.morph.MorphSplitProject
...
def MorphRelease(entities: list[base.Entity], keep_internal_connectivity: bool) -> int:
...
def MorphCollapse(box_face: base.Entity, box_edge: base.Entity, target_point: base.Entity, collapse_entire_topology: bool) -> None:
...
def CoarseBoxTopology(boxes: Iterable[base.Entity], box_edge: base.Entity, coarse_ratio: str, distance: float) -> None:
	...
	------
	ValueError
		Error, box edge is not defined.

	ValueError
		Error, coarse ratio is not defined correctly (it should be "3-1" or "2-1").

	ValueError
		Error, distance is too small.

	ValueError
		Error, all boxes should be of the same type.

	See Also
	--------
	ansa.morph.MorphCollapse
...
def DCPositionApply(entity: base.Entity, distance: float) -> bool:
	...
	See Also
	--------
	ansa.morph.DCCrossSectionApply
...
def DCCrossSectionApply(entity: base.Entity, width: float, height: float) -> bool:
...
@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewParameterTransform instead.")
def MorphParamCreateTransform(name: str, morph_points: list[base.Entity], transform_points: list[base.Entity]) -> int:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewParameterTransform` instead.
	...
	transform_points : list[base.Entity]
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewParameterTransform instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 17.1.0.Use ansa.morph.NewMorphAlignArgs instead.")
def MorphCreateMorphAlignArgs(entities: object, target_entities: object, distance: float, offset: float, user_direction: object, align_to_midplane: bool, align_on_geometry: bool) -> object:

	"""
	.. deprecated:: 17.1.0
		Use :py:func:`ansa.morph.NewMorphAlignArgs` instead.
	...
	warnings.warn("Deprecated since version 17.1.0.Use ansa.morph.NewMorphAlignArgs instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFM instead.")
def NewParameterDFMFitEdges(args: object, entities: object, bounds: object, autobounds: bool, name: str) -> object:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.DFM` instead.
	...
	See Also
	--------
	ansa.morph.DFMFitEdges, ansa.morph.DFM, ansa.morph.NewDFMFitEdgesArgs
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.DFM instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFMFitEdges instead.")
def NewDFMFitEdgesArgs(source: object, target: object) -> object:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.DFMFitEdges` instead.
	...
	See Also
	--------
	ansa.morph.DFMFitEdges, ansa.morph.DFM, ansa.morph.NewParameterDFMFitEdges
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.DFMFitEdges instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFMFitSurfaces instead.")
def NewDFMFitSurfsArgs(source_area: object, target_area: object, source_points: object, target_points: object) -> object:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.DFMFitSurfaces` instead.
	...
	See Also
	--------
	ansa.morph.DFMFitSurfaces, ansa.morph.DFM, ansa.morph.NewParameterDFMFitSurfaces
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.DFMFitSurfaces instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFMTranslate instead.")
def NewDFMTranslateArgs(translated: object, dx: float, dy: float, dz: float) -> object:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.DFMTranslate` instead.
	...
	See Also
	--------
	ansa.morph.DFMTranslate, ansa.morph.DFM, ansa.morph.NewParameterDFMTranslate
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.DFMTranslate instead.", DeprecationWarning)

def NewDFMRotateArgs(rotated: object, x: float, y: float, z: float, dx: float, dy: float, dz: float) -> object:
	...
	See Also
	--------
	ansa.morph.NewParameterDFMRotate
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFMScale instead.")
def NewDFMScaleArgs(scaled: object, x: float, y: float, z: float) -> object:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.DFMScale` instead.
	...
	See Also
	--------
	ansa.morph.DFMScale, ansa.morph.DFM, ansa.morph.NewParameterDFMScale
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.DFMScale instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFMTransform instead.")
def NewDFMTransformArgs(transformed: object, src_coord: object, trg_coord: object) -> object:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.DFMTransform` instead.
	...
	See Also
	--------
	ansa.morph.DFMTransform, ansa.morph.DFM, ansa.morph.NewParameterDFMTransform
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.DFMTransform instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFMAlign instead.")
def NewDFMAlignArgs(entities: object, target_entities: object, target_axis: object, target_plane: object, include_thickness: bool, max_distance: float, user_direction: object) -> object:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.DFMAlign` instead.
	...
	Notes
	-----
	The arguments target_entities, target_axis and target_axis are mutually exclusive arguments 
	and only one of them should be provided.

	See Also
	--------
	ansa.morph.DFMAlign, ansa.morph.DFM, ansa.morph.NewParameterDFMAlign
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.DFMAlign instead.", DeprecationWarning)

def NewParameterAngle(morph_edges: list[base.Entity], name: str='Angle') -> object:
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFM instead.")
def NewParameterDFMAlign(args: object, entities: list[base.Entity], bounds: list[base.Entity], autobounds: bool=True, name: str='DFM_Align') -> object:
	...
	bounds : list[base.Entity], optional
		A list of entities that will retain their position during the morphing action.
		These entities will also affect the deformation of the entities.
		(Default: None)
	...
	See Also
	--------
	ansa.morph.DFM, ansa.morph.NewDFMAlignArgs
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFM instead.")
def NewParameterDFMFitSurfaces(args: object, entities: object, bounds: object, autobounds: bool, name: str) -> object:
	...
	See Also
	--------
	ansa.morph.DFM, ansa.morph.DFMFitSurfaces, ansa.morph.NewDFMFitSurfsArgs
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFM instead.")
def NewParameterDFMOffset(offset_ents: object, morph_ents: object, bounds: object, autobounds: bool, name: str) -> object:
	...
	See Also
	--------
	ansa.morph.DFMOffset, ansa.morph.DFM
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFM instead.")
def NewParameterDFMRotate(args: object, entities: object, bounds: object, autobounds: bool, name: str) -> object:
	...
	See Also
	--------
	ansa.morph.DFMRotate, ansa.morph.DFM, ansa.morph.NewDFMRotateArgs
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFM instead.")
def NewParameterDFMScale(args: object, entities: object, bounds: object, autobounds: bool, name: str) -> object:
	...
	See Also
	--------
	ansa.morph.DFMScale, ansa.morph.DFM, ansa.morph.NewDFMScaleArgs
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFM instead.")
def NewParameterDFMTranslate(args: object, entities: object, bounds: object, autobounds: bool, name: str) -> object:
	...
	See Also
	--------
	ansa.morph.DFMTranslate, ansa.morph.DFM, ansa.morph.NewDFMTranslateArgs
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFM instead.")
def NewParameterDFMTransform(args: object, entities: object, bounds: object, autobounds: bool, name: str) -> object:
	...
	See Also
	--------
	ansa.morph.DFMTransform, ansa.morph.DFM
...
def NewParameterTransform(morph_points: object, transform_points: object, name: str) -> object:
...
def NewParameterTranslate(morph_points: object, dx: float, dy: float, dz: float, coord: object, name: str) -> object:
...
@typing_extensions.deprecated("Deprecated since version 18.0.0.Use ansa.morph.NewParameterSlideBoxPoints instead.")
def NewParameterExtend(morph_points: object, morph_edges: object, name: str) -> object:

	"""
	.. deprecated:: 18.0.0
		Use :py:func:`ansa.morph.NewParameterSlideBoxPoints` instead.
	...
	warnings.warn("Deprecated since version 18.0.0.Use ansa.morph.NewParameterSlideBoxPoints instead.", DeprecationWarning)
...
def NewParameterRadiusOuter(morph_faces: list[base.Entity], name: str) -> object:
	...
	----------
	morph_faces : list[base.Entity]
		A list of planar circular faces of cylindrical morph boxes.
...
def NewParameterRotate(morph_points: object, x: float, y: float, z: float, dx: float, dy: float, dz: float, coord: object, name: str) -> object:
...
def NewParameterScale(morph_points: object, x: float, y: float, z: float, name: str) -> object:
...
@typing_extensions.deprecated("Deprecated since version 21.1.0.Use ansa.morph.DCFeatureSlide instead.")
def NewParameterSlideFeatureCurve(feature: object, curves: object, follow_orientation: bool, name: str) -> object:
	...
	See Also
	--------
	ansa.morph.DCFeatureSlide, ansa.morph.DCFeatureCopy
...
@typing_extensions.deprecated("Deprecated since version 21.1.0.Use ansa.morph.DCFeatureSlide instead.")
def NewParameterSlideFeatureRotate(feature: object, x: float, y: float, z: float, dx: float, dy: float, dz: float, coord: object, name: str) -> object:
...
@typing_extensions.deprecated("Deprecated since version 21.1.0.Use ansa.morph.DCFeatureSlide instead.")
def NewParameterSlideFeatureScale(feature: object, x: float, y: float, z: float, name: str) -> object:
...
@typing_extensions.deprecated("Deprecated since version 21.1.0.Use ansa.morph.DCFeatureSlide instead.")
def NewParameterSlideFeatureTranslate(feature: object, dx: float, dy: float, dz: float, coord: object, name: str) -> object:
...
def NewParameterTailoredBlank(entities: object, properties: object, lengths: object, origin: object, normal: object, trajectory: object, movement: int, cut_mesh: bool, reconstruct: bool, zones: int, name: str) -> object:
...
def NewMorphAlignArgs(entities: object, target_entities: object, distance: float, offset: float, user_direction: object, align_to_midplane: bool, align_on_geometry: bool) -> object:
...
def DFMGetContents(parameter: object, category: str) -> object:
	...
	See Also
	--------
	ansa.morph.DFM, ansa.morph.DFMSetContents
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFM instead.")
def DFMSetContents(parameter: object, category: str, entities: object, recalculate_bounds: bool) -> bool:
	...
	Notes
	-----
	Pre-existing entities of the category will be erased. In case you want to maintain them, 
	use morph.DFMGetContents to retrieve them and append them in the 'entities' list.

	See Also
	--------
	ansa.morph.DFMGetContents, ansa.morph.DFM
...
def MorphParamSetSlideContents(parameter: base.Entity, feature: list[base.Entity]) -> bool:
	...
	Parameters
	----------
	parameter : base.Entity
		The Slide Feature parameter.

	feature : list[base.Entity]
	...
	Notes
	-----
	Pre-existing slide entities will be erased.
...
def BoxesByWireframe3D(curves: Iterable[base.Entity], box_type: str='', max_surf_len: float=1.0, max_vol_len: float=1.0) -> list[base.Entity]:
...
def MorphAdapt(entities: object, fe_or_geom: bool, bounds: object, transform: bool, split: bool, angle: float, part: object) -> object:
...
def AlignBoxPoints(entities: Iterable[base.Entity], target_entities: Iterable[base.Entity], distance: float, offset: float, user_direction: Iterable[float], align_to_midplane: bool, align_on_geometry: bool) -> int:
	...
	target_entities : Iterable[base.Entity]
	...
	user_direction : Iterable[float], optional
		A list with 3 doubles to define a used defined vector.
...
def CreateDvgridsFromParameter(morph_parameter: object, design_variable: object, distance: float, tolerance: float) -> object:
...
def MorphLinks(morph_box_links: list[base.Entity], all_depths: bool=False) -> dict:
	...
	Parameters
	----------
	morph_box_links : list[base.Entity]
...
def NewParameterSlideBoxPoints(morph_points: object, morph_edges: object, name: str) -> object:
...
def GetDoeStudyCurrentExperimentDir() -> str:
	...
	See Also
	--------
	ansa.morph.PerformDoeStudy, ansa.morph.GetDoeStudyExperiments, ansa.calc.GetDoeStudyExperimentsForParams
...
def GetDoeStudyExperiments(design_variables: object, algorithm: str, level: object, experiments_number: int, seed: int, taguchi_array: str, dv_taguchi_columns: object, reject_duplicates: bool, comb_file: str) -> object:
	...
	See Also
	--------
	ansa.morph.PerformDoeStudy, ansa.morph.GetDoeStudyCurrentExperimentDir, ansa.calc.GetDoeStudyExperimentsForParams
...
def MorphDistorted() -> list:
	...
	-------
	list
		A list with the distorted morphes
...
def NewDFMSweepGlideArgs(entities: object, path: object, movement: str, rigid_deformable: str) -> object:
	...
	See Also
	--------
	ansa.morph.NewParameterDFMSweepGlide
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFM instead.")
def NewParameterDFMSweepGlide(args: object, entities: object, bounds: object, autobounds: bool, name: str) -> object:
	...
	See Also
	--------
	ansa.morph.DFMSweepGlide, ansa.morph.DFM, ansa.morph.NewDFMSweepGlideArgs
...
def MorphIntersections(morphes: Iterable[base.Entity]) -> Iterable[base.Entity]:
	...
	Parameters
	----------
	morphes : Iterable[base.Entity]
		morphes is a list of morph boxes to check
...
def DeformMorphPoints(morph_points: list[base.Entity], dx: list[float], dy: list[float], dz: list[float]) -> int:
	...
	Notes
	-----
	The four lists should be aligned. For instance morph_points[i] will be deformed by dx[i], dy[i], dz[i].
...
def DCFeatureSlideApply(entity: base.Entity, dx: float, dy: float, dz: float, rx: float, ry: float, rz: float, fx: float, fy: float, fz: float) -> None:
	...
	See Also
	--------
	ansa.morph.DCFeatureSlide, ansa.morph.DCFeatureCopy, ansa.morph.DCFeatureSlideSurfaceApply, ansa.morph.DCFeatureSlidePathApply, ansa.morph.DCFeatureCopyApply, ansa.morph.DCFeatureCopySurfaceApply, ansa.morph.DCFeatureCopyPathApply
...
def DCFeatureSlideSurfaceApply(entity: base.Entity, ds: float, dt: float, rw: float, fs: float, ft: float) -> None:
	...
	See Also
	--------
	ansa.morph.DCFeatureSlide, ansa.morph.DCFeatureCopy, ansa.morph.DCFeatureSlideApply, ansa.morph.DCFeatureSlidePathApply, ansa.morph.DCFeatureCopyApply, ansa.morph.DCFeatureCopySurfaceApply, ansa.morph.DCFeatureCopyPathApply
...
def DCFeatureSlidePathApply(entity: base.Entity, dist: float) -> None:
	...
	See Also
	--------
	ansa.morph.DCFeatureSlide, ansa.morph.DCFeatureCopy, ansa.morph.DCFeatureSlideApply, ansa.morph.DCFeatureSlideSurfaceApply, ansa.morph.DCFeatureCopyApply, ansa.morph.DCFeatureCopySurfaceApply, ansa.morph.DCFeatureCopyPathApply
...
def DCFeatureCopyApply(entity: base.Entity, dx: float, dy: float, dz: float, rx: float, ry: float, rz: float, fx: float, fy: float, fz: float, steps: int) -> None:
	...
	See Also
	--------
	ansa.morph.DCFeatureSlide, ansa.morph.DCFeatureCopy, ansa.morph.DCFeatureSlideApply, ansa.morph.DCFeatureSlideSurfaceApply, ansa.morph.DCFeatureSlidePathApply, ansa.morph.DCFeatureCopySurfaceApply, ansa.morph.DCFeatureCopyPathApply
...
def DCFeatureCopySurfaceApply(entity: base.Entity, ds: float, dt: float, rw: float, fs: float, ft: float, steps: int) -> None:
	...
	See Also
	--------
	ansa.morph.DCFeatureSlide, ansa.morph.DCFeatureCopy, ansa.morph.DCFeatureSlideApply, ansa.morph.DCFeatureSlideSurfaceApply, ansa.morph.DCFeatureSlidePathApply, ansa.morph.DCFeatureCopyApply, ansa.morph.DCFeatureCopyPathApply
...
def DCFeatureCopyPathApply(entity: base.Entity, dist: float, steps: int) -> None:
	...
	See Also
	--------
	ansa.morph.DCFeatureSlide, ansa.morph.DCFeatureCopy, ansa.morph.DCFeatureSlideApply, ansa.morph.DCFeatureSlideSurfaceApply, ansa.morph.DCFeatureSlidePathApply, ansa.morph.DCFeatureCopyApply, ansa.morph.DCFeatureCopySurfaceApply
...
def CheckForDuplicateBoxes(tolerance: float, check_on: str) -> list[base.Entity]:
	...
	ValueError
		Tolerance should be greater than 0
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.ConstraintFlanges instead.")
def MorphConstraintFlange(entities: object, contacts: object, morphed: object, bounds: object, autobounds: bool, align: str, offset: float) -> object:

	"""
	.. deprecated:: 21.0.0
		Use :py:class:`ansa.morph.ConstraintFlanges` instead.
	...
	See Also
	--------
	ansa.morph.MorphConstraintPlanar, ansa.morph.MorphConstraintRigid, ansa.morph.MorphConstraintScaled, ansa.morph.MorphConstraintPathFollower, ansa.morph.MorphConstraintDirectional, ansa.morph.ConstraintPlanar, ansa.morph.ConstraintRigid, ansa.morph.ConstraintScaled, ansa.morph.ConstraintDirectional, ansa.morph.ConstraintPathFollower, ansa.morph.ConstraintFlanges
	...
	warnings.warn("Deprecated since version 21.0.0.Use ansa.morph.ConstraintFlanges instead.", DeprecationWarning)

def VideoFromEntities(filename: str, parameters: list[base.Entity], initial_final: list, frames: int, duration: float, lock_view_time: dict, images_per_sec: int) -> None:
	...
	ValueError
		Invalid initial_final input

	ValueError
		Frames per second should be greater than 0 and less than 25

	ValueError
		Video duration should be greater than 0

	ValueError
		Invalid lock_view_time input

	ValueError
		Cannot work without gui, use '-virtualx' option
...
def MorphSplitToHexa(box_faces: base.Entity | Iterable[base.Entity], tangency: str, preserve_local_shape: bool, fit_new_skin_edges: bool, work_on: str, ret_ents: bool) -> tuple | bool:
	...
	Parameters
	----------
	box_faces : base.Entity | Iterable[base.Entity]
	...
	-------
	tuple | bool
		If 'ret_ents' argument is set to true it returns a tuple where its first 
		argument returns true or false depending on the success of the 
		procedure and for the second element it returns the new and modified
		morphes.
		If 'ret_ents' argument is set to false it returns only true or false depending 
		on the success of the procedure.

	See Also
	--------
	ansa.morph.MorphSplit, ansa.morph.MorphSplitProject, ansa.morph.MorphSplitToPenta
...
@typing_extensions.deprecated("Deprecated since version 21.0.0.Use ansa.morph.DFM instead.")
def NewParameterDFMSymmetry(entity: base.Entity) -> base.Entity:
...
@typing_extensions.deprecated("Deprecated since version 21.1.0.Use ansa.morph.DCPosition instead.")
def DCSymmetry(design_change: object) -> object:

	"""
	.. deprecated:: 21.1.0
		Use :py:class:`ansa.morph.DCPosition` instead.
	...
	warnings.warn("Deprecated since version 21.1.0.Use ansa.morph.DCPosition instead.", DeprecationWarning)

def OptimizationTool(optimization_task: base.Entity, load_experiments: str, export_file: str, dv_file: str, doe_algorithm: str, number_of_designs: int, hide_buttons: bool, show_deviation: bool, clear_table: bool, save_in_dm: bool, revert_changes: bool, save_ansa_db: bool, save_animation: bool, working_directory: str) -> int:
	...
	Parameters
	----------
	optimization_task : base.Entity, optional
		An Optimization_Task item.
...
def PMEntityGeometryUpdate(pm_entities: list[base.Entity]) -> None:
	...
	See Also
	--------
	ansa.morph.PMEntityGeometryRegenerate, ansa.morph.PMEntityGeometryDelete, ansa.morph.PMEntityGeometryRelease
...
def PMEntityGeometryRegenerate(pm_entities: list[base.Entity]) -> None:
	...
	See Also
	--------
	ansa.morph.PMEntityGeometryUpdate, ansa.morph.PMEntityGeometryRelease, ansa.morph.PMEntityGeometryDelete
...
def PMEntityGeometryDelete(pm_entities: list[base.Entity]) -> None:
	...
	See Also
	--------
	ansa.morph.PMEntityGeometryUpdate, ansa.morph.PMEntityGeometryRegenerate, ansa.morph.PMEntityGeometryRelease
...
def PMEntityGeometryRelease(pm_entities: list[base.Entity]) -> None:
	...
	See Also
	--------
	ansa.morph.PMEntityGeometryUpdate, ansa.morph.PMEntityGeometryRegenerate, ansa.morph.PMEntityGeometryDelete
...
def SculptingSmooth(smooth_area: list[base.Entity], smooth_algorithm: str, distortion: float, angle: float, intensity: float, iterations: int, frozen_area: list[base.Entity]) -> int:
	...
	frozen_area : list[base.Entity], optional
...
def NewParameterHoles(holes_2d: object, offset_type: str, movement_type: str, name: str) -> object:
...
def NewParameterTubes(holes_3d: object, offset_type: str, movement_type: str, name: str) -> object:
...
class BoxSplit:
	...
	::
		...
		def split_to_hexa_penta_example():
		    boxEdge = base.GetEntity(ansa.constants.NASTRAN, "HEXA_BOX_EDGE", a_morph_edge_id)
		    boxPnt = base.GetEntity(ansa.constants.NASTRAN, "HEXA_BOX_POINT", a_morph_point_id)
		    edgeDist = int_from_0_to_1
		    morph.BoxSplit().to_hexa_penta(boxEdge, edgeDist, boxPnt)
	...
	def on_points(self, box_points: Iterable[base.Entity]) -> int:
		...
		Parameters
		----------
		box_points : Iterable[base.Entity]
	...
	def number(self, box_edges: Iterable[base.Entity], number_of_splits: int) -> int:
		...
		Parameters
		----------
		box_edges : Iterable[base.Entity]
	...
	def project(self, box_edge: base.Entity, points: Iterable[base.Entity]) -> int:
	...
	def to_penta(self, box_points: Iterable[base.Entity]) -> int:
	...
	def to_hexa_penta(self, box_edge: base.Entity, u_on_edge: float, box_point: base.Entity) -> int:

		"""

		Splits a hexabox into one penta element and one hexa element
		...
		u_on_edge : float
			This parameter runs between 0. and 1. and represents the non-dimentional distance on an edge.

		box_point : base.Entity
			An iterable point-like entities (MORPHPOINT, HEXA_BOX_POINT, SIZEBOXPOINT)
	...
	def cut(self, box_points_a: Iterable[base.Entity], box_point_b: base.Entity) -> int:
		...
		Parameters
		----------
		box_points_a : Iterable[base.Entity]
		...
		box_point_b : base.Entity, optional
	...
	def __init__(self, fit_new_skin_edges: bool=False, work_on: str='all') -> None:
...
class Create:
	...
	def __init__(self, invert_direction: bool, auto_reconstruct: object, set_id: int, save_morph_parameter: bool) -> None:
	...
	def flanged_opening_surface(self, entities: object, height: float, angle: float, radius: float, return_characteristics: bool) -> object:
	...
	def flanged_opening_straight(self, opening_point1: object, opening_point2: object, width: float, height: float, angle: float, radius: float, straight_rounded: bool, return_characteristics: bool, top_is_width: bool) -> object:
	...
	def flanged_opening_curved(self, opening_entities: object, width: float, height: float, angle: float, radius: float, curved_rounded: bool, return_characteristics: bool, top_is_width: bool) -> object:
	...
	def flanged_opening_circular(self, center_point: object, diameter: float, height: float, angle: float, radius: float, direction_point1: object, direction_point2: object, return_characteristics: bool, top_is_width: bool) -> object:
	...
	def stamp_rectangular_rounded(self, center_point: object, width1: float, width2: float, corner: float, height: float, angle: float, radius1: float, radius2: float, direction_point1: object, direction_point2: object, return_characteristics: bool) -> object:
	...
	def stamp_circular(self, center_point: object, diameter: float, height: float, angle: float, radius1: float, radius2: float, direction_point1: object, direction_point2: object, return_characteristics: bool, top_is_width: bool) -> object:
	...
	def stamp_surface(self, stamp_entities: object, height: float, angle: float, radius1: float, radius2: float, return_characteristics: bool) -> object:
	...
	def rib_3d(self, rib_top1: object, rib_top2: object, rib_height: object, width: float, angle: float, top_type: str, top_value: float, bottom_type: str, bottom_value: float, length: float) -> object:
	...
	def rib_2d(self, rib_top1: object, rib_top2: object, rib_height: object, length: float) -> object:
	...
	def opening_curved(self, opening_entities: object, width: float, curved_rounded: bool) -> object:
	...
	def opening_circular(self, center_point: object, diameter: float, direction_point1: object, direction_point2: object) -> object:
	...
	def opening_straight(self, opening_point1: object, opening_point2: object, width: float, straight_rounded: bool) -> object:
	...
	def opening_rectangular_rounded(self, center_point: object, width1: float, width2: float, corner: float, direction_point1: object, direction_point2: object) -> object:
	...
	def bead_straight(self, bead_point1: object, bead_point2: object, width: float, height: float, angle: float, radius1: float, radius2: float, straight_rounded: bool, return_characteristics: bool, top_is_width: bool) -> object:
	...
	def bead_curved(self, bead_entities: object, width: float, height: float, angle: float, radius1: float, radius2: float, curved_rounded: bool, return_characteristics: bool, top_is_width: bool) -> object:
	...
	def set_improve_mesh(self, type: str, zones: int, exclude_feature_recon: bool=False) -> None:
	...
	def bead_X_type(self, bead_point: object, width1: float, width2: float, height: float, angle_a: float, radius1: float, radius2: float, length1: float, length2: float, length3: float, length4: float, angle_b: float, radius_a: float, radius_b: float, X_type_rounded: bool, return_characteristics: bool, top_is_width: bool) -> object:
	...
	def bead_L_type(self, bead_point: object, width1: float, width2: float, height: float, angle_a: float, radius1: float, radius2: float, length1: float, length2: float, angle_b: float, radius_a: float, L_type_rounded: bool, return_characteristics: bool, top_is_width: bool) -> object:
	...
	def bead_T_type(self, bead_point: object, width1: float, width2: float, height: float, angle_a: float, radius1: float, radius2: float, length1: float, length2: float, length3: float, angle_b: float, radius_a: float, radius_b: float, T_type_rounded: bool, return_characteristics: bool, top_is_width: bool) -> object:
	...
	def flanged_opening_rectangular_rounded(self, center_point: object, width1: float, width2: float, corner: float, height: float, angle: float, radius1: float, direction_point1: object, direction_point2: object, return_characteristics: bool) -> object:
	...
	def detached_feature(self, flanges_width_and_offset_distance: Iterable[float]) -> None:
		...
		Parameters
		----------
		flanges_width_and_offset_distance : Iterable[float], optional
...
class DFMTranslate:
	...
	def set_value(self, dist: float) -> None:

		"""

		Set a movement value
	...
	def insert_entities(self, entities: list[base.Entity]) -> None:

		"""

		Insert entities for movement
	...
	def set_entities(self, entities: list[base.Entity]) -> None:

		"""

		Set entities for movement
	...
	def remove_entities(self, entities: list[base.Entity]) -> None:

		"""

		Exclude entities from movement
	...
	def decrease_entities_zone(self, zones: int) -> None:

		"""

		Decrease entities for movement by a number of zones
	...
	def increase_entities_zone(self, zones: int) -> None:

		"""

		Increase entities for movement by a number of zones
	...
	def set_translate_vector(self, dx: float, dy: float, dz: float) -> None:

		"""

		Set a vector of translation
	...
	def set_coord(self, coord: base.Entity) -> None:

		"""

		Set a local coordinate system for the definition of translation vector
...
class DFMTransform:
	...
	def set_source_coord(self, coord: base.Entity) -> None:
	...
	def set_target_coord(self, coord: base.Entity) -> None:

		"""

		Set the target coordinate system
...
class DFMScale:
	...
	def set_value(self, dist: float) -> None:
		...
		Set the scaleing factor for movement


		Parameters
		----------
		dist : float
			A value of scaling factor
	...
	def increase_entities_zone(self, zones: int) -> None:
		...
		Increase entities for movement by a nuber of zones
...
class DFMOffset:
	...
	def set_value(self, dist: float) -> None:
		...
		Set the value for movement


		Parameters
		----------
		dist : float
			Numerical vaue for the magnitude of offset distance
...
class DFMRotate:
	...
	def set_value(self, dist: float) -> None:
		...
		Set the value for rotation movement
	...
	def set_rotate_axis(self, x: float, y: float, z: float, dx: float, dy: float, dz: float) -> None:

		"""

		Set a vector of rotation
	...
	def set_coord(self, coord: base.Entity) -> None:
		...
		Set a local coordinate system for the definition of rotation axis.
...
class DFMSweepGlide:
	...
	entities: list[base.Entity] = None
	"""
	A list of entities to sweep/glide.

	"""

	path: list[base.Entity] = None
	"""
	...
	def insert_path(self, path_entities: list[base.Entity]) -> None:

		"""

		Insert entities to define path of movement


		Parameters
		----------
		path_entities : list[base.Entity]
			A list of entities to define path of movement.
	...
	def set_path(self, path_entities: list[base.Entity]) -> None:

		"""

		Set entities to define path of movement
	...
	def remove_path(self, path_entities: list[base.Entity]) -> None:

		"""

		Exclude entities from those defining path of movement
...
class DFMFitEdges:
	...
	source_entities: list[base.Entity] = None
	"""
	A list of entities set as source edges.

	"""

	target_entities: list[base.Entity] = None
	"""
	A list of entities set as target edges.

	"""

	steady_section_entities: list[base.Entity] = None
	"""
	...
	def set_value(self, dist: float) -> None:
		...
		----------
		dist : float
			A numarical value to define the fitting movement. It represents a factor, where 1. means total fit.
	...
	def set_source_entities(self, source_entities: list[base.Entity]) -> None:
		...
		Parameters
		----------
		source_entities : list[base.Entity]
	...
	def insert_source_entities(self, source_entities: list[base.Entity]) -> None:

		"""

		Insert entities for source edges
	...
	def remove_source_entities(self, source_entities: list[base.Entity]) -> None:

		"""

		Exclude entities from source entities
	...
	def clear_source_entities(self) -> None:
	...
	def set_target_entities(self, target_entities: list[base.Entity]) -> None:

		"""

		Set entities for target edges


		Parameters
		----------
		target_entities : list[base.Entity]
			A list of target edges. Preexisting target edges will be discarded.
	...
	def insert_target_entities(self, target_entities: list[base.Entity]) -> None:

		"""

		Insert entities for target edges


		Parameters
		----------
		target_entities : list[base.Entity]
			A list of target edges.
	...
	def remove_target_entities(self, target_entities: list[base.Entity]) -> None:

		"""

		Exclude entities from target edges
	...
	def clear_target_entities(self) -> None:
	...
	def decrease_source_zones(self, zones: int) -> None:

		"""

		Decrease source edges by a number of zones
	...
	def increase_source_zones(self, zones: int) -> None:

		"""

		Increase source edges by a number of zones
	...
	def decrease_target_zones(self, zones: int) -> None:

		"""

		Decrease target edges by a number of zones
	...
	def increase_target_zones(self, zones: int) -> None:

		"""

		Increase target edges by a number of zones
	...
	def set_steady_section(self, steady_section: list[base.Entity]) -> None:

		"""

		Set entities for steady section morphing


		Parameters
		----------
		steady_section : list[base.Entity]
	...
	def insert_steady_section(self, steady_section: list[base.Entity]) -> None:

		"""

		Inert entities for steady section morphing
	...
	def remove_steady_section(self, steady_section: list[base.Entity]) -> None:

		"""

		Exclude entities from steady section morphing
	...
	def clear_steady_section(self) -> None:
	...
	def set_user_section(self, x: float, y: float, z: float, dx: float, dy: float, dz: float) -> None:

		"""

		Define a custom plane as reference for cross-sections, to be preserved along Source Edge.
		User Section is defined by a vector normal to its plane.
...
class DFMFitSurfaces:
	...
	def set_value(self, dist: float) -> None:
		...
		Set value for fitting movement


		Parameters
		----------
		dist : float
			Fitting value. A value representing the precentage of fitting, when 1. represents total fit.
	...
	def remove_target_entities(self, target_entities: list[base.Entity]) -> None:
		...
		Exclude entities from target


		Parameters
		----------
		target_entities : list[base.Entity]
			A list of target entities to be excluded.
	...
	def decrease_source_zone(self, zones: int) -> None:

		"""

		Decrease source entities by a number of zones
	...
	def increase_source_zone(self, zones: int) -> None:

		"""

		Increase source entities by a number of zones
	...
	def decrease_target_zone(self, zones: int) -> None:

		"""

		Decrease target entities by a number of zones
	...
	def increase_target_zone(self, zones: int) -> None:

		"""

		Increase target entities by a number of zones
	...
	def set_source_target_points(self, source_points: list[base.Entity], target_points: list[base.Entity]) -> None:

		"""

		Set corresponding nodes from source and target area perimeters to be matched. Lists of points should be aligned.


		Parameters
		----------
		source_points : list[base.Entity]
			A list of points to define source surface.

		target_points : list[base.Entity]
...
class DFMAlign:
	...
	"""
	The maximum search distance for alignment.
	...
	def set_value(self, dist: float) -> None:
		...
		Set value for movement


		Parameters
		----------
		dist : float
			Numerical value for the offset value of alignment.
	...
	def set_source_entities(self, source_entities: list[base.Entity]) -> None:
		...
		Set entities to be included in movement
	...
	def insert_source_entities(self, source_entities: list[base.Entity]) -> None:
		...
		Insert entities to be included in movement
	...
	def set_target_entities(self, target_entities: list[base.Entity]) -> None:
		...
		Set entities of target


		Parameters
		----------
		target_entities : list[base.Entity]
			A list of target entities. Preexisting target entities will be discarded.
	...
	def insert_target_entities(self, target_entitites: list[base.Entity]) -> None:

		"""

		Insert entities of target


		Parameters
		----------
		target_entitites : list[base.Entity]
	...
	def decrease_target_zone(self, zones: int) -> None:
		...
		Decrease entities of target by a number of zones
	...
	def increase_target_zone(self, zones: int) -> None:
		...
		Increase entities of target by a number of zones
	...
	def set_target_plane(self, x: float, y: float, z: float, dx: float, dy: float, dz: float) -> None:

		"""

		Set target to by defined by a plane


		Parameters
		----------
		x : float
			Value of origin's X coordinate

		y : float
			Value of origin's Y coordinate

		z : float
			Value of origin's Z coordinate

		dx : float
			Value of normal vector dx component

		dy : float
			Value of normal vector dy component

		dz : float
			Value of normal vector dz component
	...
	def set_target_axis(self, x: float, y: float, z: float, dx: float, dy: float, dz: float) -> None:

		"""

		Set target to by defined by an axis
		...
		dx : float
			Value of vector's dx component

		dy : float
			Value of vector's dy component

		dz : float
			Value of vector's dz component
	...
	def set_user_direction(self, dx: float, dy: float, dz: float) -> None:

		"""

		User set the direction mode
	...
	def set_max_distance(self, max_distance: float) -> None:
		...
		Set max distance for search distance
	...
	def set_include_thickness(self, include_thickness: bool) -> None:

		"""

		Take into account the thickness of the Control entities and Target entities and align in the correct plane respecting the thickness
	...
	def set_align_on_axis(self) -> None:
	...
	def set_align_on_entities(self) -> None:
...
class ConstraintRigid:
	...
	Notes
	-----
	After any change to "morphed" attribute (either through directly assigning it or through methods "set_morphed", "insert_morphed", "remove_morphed", "clear_morphed"), and before the final call to "apply" method, the "bounds" attribute should be set again (either through directly assigning, or through methods "calculate_bounds", "set_bounds", "insert_bounds", "remove_bounds", "clear_bounds").

	See Also
	--------
	ansa.morph.ConstraintFlanges
	...
	def insert_morphed(self, morphed: object) -> None:

		"""

		Insert entities to morphed
	...
	def set_morphed(self, morphed: object) -> None:

		"""

		Set morphed entities
		...
		morphed : object
			A list of entities to be inserted in object's member "morphed"
			Preexisting entities will be discarded
	...
	def remove_morphed(self, morphed: object) -> None:

		"""

		Exclude entities from morphed
	...
	def insert_bounds(self, bounds: object) -> None:

		"""

		Insert entities to bounds
	...
	def set_bounds(self, bounds: object) -> None:
	...
	def remove_bounds(self, bounds: object) -> None:

		"""

		Exclude entities from bounds
	...
	def calculate_bounds(self) -> list[base.Entity]:

		"""

		Automatic calculation of bounds
		The result will be inserted to object's member "bounds"
	...
	def increase_morphed_zone(self, zones: int) -> list[base.Entity]:

		"""

		Increase morphed entities by a number of zones
	...
	def decrease_morphed_zone(self, zones: int) -> list[base.Entity]:

		"""

		Decrease morphed entities by a number of zones
	...
	def insert_entities(self, entities: object) -> None:

		"""

		Insert entities to object's member "entities"
	...
	def set_entities(self, entities: object) -> None:

		"""

		Set entities to object's member "entities"
	...
	def remove_entities(self, entities: object) -> None:

		"""

		Exclude entities from object's member "entities"
	...
	def __init__(self, rigid_constraint: object) -> None:
	...
	def reg(self) -> object:
		...
		-------
		object
			The created and registered MORPH_CONSTRAINT entity
			Method returns None if the corresponding entity was already registered
...
class ConstraintPathFollower:
	...
	def set_entities(self, entities: object) -> object:
	...
	def insert_path(self, path_entities: object) -> object:

		"""

		Insert entities to path
	...
	def set_path(self, path_entities: object) -> None:
	...
	def remove_path(self, path_entities: object) -> None:

		"""

		Exclude entities from path
	...
	def __init__(self, path_follower_constraint: object) -> None:
		...
		path_follower_constraint : object, optional
			A MORPH_CONSTRAINT entity of Path Follower type
...
class ConstraintPlanar:
	...
	See Also
	--------
	ansa.morph.ConstraintSteadySection
	...
	def __init__(self, planar_constraint: object) -> None:
		...
		planar_constraint : object, optional
			A MORPH_CONSTRAINT entity of Planar type
...
class ConstraintScaled:
	...
	def __init__(self, scaled_constraint: object) -> None:
		...
		scaled_constraint : object, optional
			A MORPH_CONSTRAINT entity of Scaled type
...
class ConstraintDirectional:
	...
	morphed: Iterable[base.Entity] = None
	"""
	A list of entities to be in the transition zone.

	"""

	bounds: Iterable[base.Entity] = None
	"""
	A list of entities set as fixed perimeters.

	"""

	entities: Iterable[base.Entity] = None
	"""
	A list of entities constrained to move in a direction.

	"""

	def insert_morphed(self, morphed: Iterable[base.Entity]) -> None:
	...
	def set_morphed(self, morphed: Iterable[base.Entity]) -> None:
	...
	def remove_morphed(self, morphed: Iterable[base.Entity]) -> None:
	...
	def insert_bounds(self, bounds: Iterable[base.Entity]) -> None:
	...
	def set_bounds(self, bounds: Iterable[base.Entity]) -> None:
	...
	def insert_entities(self, entities: Iterable[base.Entity]) -> None:
	...
	def set_entities(self, entities: Iterable[base.Entity]) -> None:
	...
	def remove_entities(self, entities: Iterable[base.Entity]) -> None:
	...
	def set_coord(self, coord: base.Entity) -> None:
		...
		Set a local coordinate system for the definition of directions to be constrained.
	...
	def set_status(self, x_status: bool=False, y_status: bool=False, z_status: bool=False) -> None:

		"""

		Set to allow or not movement of X, Y and Z components


		Parameters
		----------
		x_status : bool, optional
			Status of movement on X

		y_status : bool, optional
			Status of movement on Y

		z_status : bool, optional
			Status of movement on Z
	...
	def set_x_active(self, status: bool) -> None:
	...
	def set_y_active(self, status: bool) -> None:
	...
	def set_z_active(self, status: bool) -> None:
	...
	def __init__(self, directional_constraint: base.Entity) -> None:
		...
		Parameters
		----------
		directional_constraint : base.Entity, optional
	...
	def reg(self) -> base.Entity:

		"""

		Create the MORPH_CONSTRAINT entity from a ConstraintDirectional object and register it in the database
...
class ConstraintFlanges:
	...
	def decrease_morphed_zone(self, zones: int) -> list[base.Entity]:
		...
		-------
		list[base.Entity]
			A list of entities excluded in object's member "morphed"
	...
	def insert_contacts(self, contacts: object) -> None:

		"""

		Insert entities to contacts
	...
	def remove_contacts(self, contacts: object) -> None:

		"""

		Exclude entities from contacts
	...
	def set_thickness_flange_gap(self, offset: float) -> None:

		"""

		Call this method to set the flange gap
	...
	def set_preserve_flange_gap(self) -> None:
	...
	def __init__(self, flanges_constraint: object) -> None:
...
class DCPosition:
	...
	def __init__(self, dc_position: object) -> None:
...
class DFM:
	...
	- Unless method "apply" has been called, any morphing action will be cancelled at the end of the Python script.
	...
	morphed: list[base.Entity] = None
	"""
	A list of entities to be morphed.

	"""

	bounds: list[base.Entity] = None
	"""
	A list of entities to bound the movement.

	"""

	constraints: list[base.Entity] = None
	"""
	A list of MORPH_CONSTRAINT entities participating in the movement.

	"""

	defined_constraints: list[base.Entity] = None
	"""
	A list of MORPH_CONSTRAINT entities related to the contents of the movement. This object cannot be changed.

	"""

	move_types: list[base.Entity] = None
	"""
	...
	volume_finder: list[base.Entity] = None
	"""
	...
	def insert_morphed(self, morphed: list[base.Entity]) -> None:
	...
	def set_morphed(self, morphed: list[base.Entity]) -> None:
	...
	def remove_morphed(self, morphed: list[base.Entity]) -> None:
	...
	def insert_bounds(self, bounds: None) -> None:
	...
	def set_bounds(self, bounds: list[base.Entity]) -> None:
	...
	def remove_bounds(self, bounds: list[base.Entity]) -> None:
	...
	def insert_volume_finder(self, size_boxes: list[base.Entity]) -> None:

		"""

		Insert entities to volume finder


		Parameters
		----------
		size_boxes : list[base.Entity]
	...
	def set_volume_finder(self, size_boxes: list[base.Entity]) -> None:

		"""

		Set entities for volume finder
	...
	def remove_volume_finder(self, size_boxes: list[base.Entity]) -> None:

		"""

		Exclude entities from volume finder
	...
	def clear_volume_finder(self) -> None:
	...
	def get_move_types(self) -> list[object]:

		"""

		Get the type of move_type
	...
	def add_translate(self, transl_obj: DFMTranslate) -> DFMTranslate:
		...
		Parameters
		----------
		transl_obj : DFMTranslate, optional
	...
	def add_rotate(self, rotate_obj: DFMRotate) -> DFMRotate:
	...
	def add_scale(self, scale_obj: DFMScale) -> DFMScale:
	...
	def add_transform(self, transform_obj: DFMTransform) -> DFMTransform:
		...
		Parameters
		----------
		transform_obj : DFMTransform, optional
	...
	def add_fit_edges(self, fit_edges_obj: DFMFitEdges) -> DFMFitEdges:
		...
		Parameters
		----------
		fit_edges_obj : DFMFitEdges, optional
	...
	def add_fit_surfs(self, fit_surfs_obj: DFMFitSurfaces) -> DFMFitSurfaces:
		...
		Parameters
		----------
		fit_surfs_obj : DFMFitSurfaces, optional
	...
	def add_align(self, align_obj: DFMAlign) -> DFMAlign:
	...
	def add_sweep_glide(self, sweep_glide_obj: DFMSweepGlide) -> DFMSweepGlide:
		...
		Parameters
		----------
		sweep_glide_obj : DFMSweepGlide, optional
	...
	def save_as_param(self, name: str) -> base.Entity:
	...
	def insert_constraints(self, constraints: list[base.Entity]) -> None:
	...
	def set_constraints(self, constraints: list[base.Entity]) -> None:

		"""

		Set constraints entities
	...
	def remove_constraints(self, constraints: list[base.Entity]) -> None:

		"""

		Exclude entities from constraints
	...
	def set_tangency(self, tangency_option: str) -> None:

		"""

		Set tangency between Default and Smooth
	...
	def create_symmetric(self) -> base.Entity:
	...
	def remove_move_type(self, move_type: DFMTranslate | DFMTransform | DFMRotate | DFMScale | DFMFitEdges|DFMFitSurfaces | DFMAlign | DFMOffset) -> None:
		...
		Parameters
		----------
		move_type : DFMTranslate | DFMTransform | DFMRotate | DFMScale | DFMFitEdges|DFMFitSurfaces | DFMAlign | DFMOffset
	...
	def add_constraint_obj(self, constraint_obj: ConstraintRigid | ConstraintPlanar | ConstraintPathFollower | ConstraintScaled | ConstraintDirectional | ConstraintFlanges | ConstraintSteadySection) -> None:
		...
		Parameters
		----------
		constraint_obj : ConstraintRigid | ConstraintPlanar | ConstraintPathFollower | ConstraintScaled | ConstraintDirectional | ConstraintFlanges | ConstraintSteadySection, optional
			An instance of one of the classes: morph.ConstraintRigid, morph.ConstraintPlanar, morph.ConstraintPathFollower, morph.ConstraintScaled, morph.ConstraintDirectional, morph.ConstraintFlanges, morph.ConstraintSteadySection.
	...
	def set_improve_mesh(self, type: str, zones: int) -> None:
	...
	def add_offset(self, offset_obj: DFMOffset) -> DFMOffset:

		"""

		Add a morph.DFMOffset object or create a new one. If no argument is given, a new instance of morph.DFMOffset will be created.


		Parameters
		----------
		offset_obj : DFMOffset, optional
	...
	def __init__(self, dfm_parameter: base.Entity) -> None:
		...
		Parameters
		----------
		dfm_parameter : base.Entity, optional
...
class Form:
	...
	Notes
	-----
	- After any change to "transition" attribute (either through directly assigning it or through methods "set_transition", "insert_transition", "remove_transition", "clear_transition"), and before the final call to "apply" method, the "fixed" attribute should be set again (either through directly assigning, or through methods "calculate_fixed", "set_fixed", "insert_fixed", "remove_fixed", "clear_fixed").
	...
	formed: object = None
	"""
	A list of entities to be formed.
	...
	def insert_formed(self, formed: list[base.Entity]) -> None:

		"""

		Insert entities to formed


		Parameters
		----------
		formed : list[base.Entity]
	...
	def set_formed(self, formed: list[base.Entity]) -> None:
	...
	def remove_formed(self, formed: list[base.Entity]) -> None:

		"""

		Exclude entities from formed
	...
	def increase_formed_zone(self, zones: int) -> list[base.Entity]:

		"""

		Increase formed entities by a number of zones
		...
		-------
		list[base.Entity]
			A list of entities included in object's member "formed"

		"""


	def decrease_formed_zone(self, zones: int) -> list[base.Entity]:

		"""

		Decrease formed entities by a number of zones
	...
	def insert_transition(self, transition: list[base.Entity]) -> None:

		"""

		Insert entities to transition


		Parameters
		----------
		transition : list[base.Entity]
	...
	def set_transition(self, transition: list[base.Entity]) -> None:

		"""

		Set transition entities
	...
	def remove_transition(self, transition: list[base.Entity]) -> None:

		"""

		Exclude entities from transition
	...
	def increase_transition_zone(self, zones: int) -> list[base.Entity]:

		"""

		Increase transition entities by a number of zones
		...
		-------
		list[base.Entity]
			A list of entities included in object's member "transition"

		"""


	def decrease_transition_zone(self, zones: int) -> list[base.Entity]:

		"""

		Decrease transition entities by a number of zones
		...
		-------
		list[base.Entity]
			A list of entities excluded in object's member "transition"

		"""


	def insert_fixed(self, fixed: list[base.Entity]) -> None:

		"""

		Insert entities to fixed


		Parameters
		----------
		fixed : list[base.Entity]
	...
	def set_fixed(self, fixed: list[base.Entity]) -> None:
	...
	def remove_fixed(self, fixed: list[base.Entity]) -> None:

		"""

		Exclude entities from fixed
	...
	def calculate_fixed(self) -> list[base.Entity]:

		"""

		Automatic calculation of fixed
		The result will be inserted to object's member "fixed"


		Returns
		-------
		list[base.Entity]
			A list of entities found as fixed

		"""


	def insert_constraints(self, constraints: object) -> None:
	...
	def set_coordinate(self, coordinate: base.Entity) -> None:

		"""

		Set a new entity for coordinate system.
		Neutral axis will be represented by X axis and Bending axis by Y.
		This action will reset Form to its initial setup.
	...
	def move_coordinate_to_cog(self) -> None:
	...
	def set_positive_plane_length(self, length: float) -> None:

		"""

		Define bend length in mode 'Free Ends'
		If needed, change Form mode prior to this action
	...
	def set_positive_plane_angle(self, angle: float) -> None:

		"""

		Define bend angle in mode 'Free Ends'
		If needed, change Form mode prior to this action
	...
	def set_negative_plane_length(self, length: float) -> None:
	...
	def set_negative_plane_angle(self, angle: float) -> None:
	...
	def reset_positive_plane_length(self) -> None:

		"""

		Reset object's member "positive_plane_length" to the maximum value
		This action can be performed in 'Free Ends' mode
		If needed, change Form mode prior to this action
	...
	def reset_negative_plane_length(self) -> None:
	...
	def set_link_planes(self, link_planes: bool) -> None:

		"""

		Enable planes linkage to bend, twist, taper and extend identically in both ends
		Positive plane's bend length and angle, twist angle, taper and extend ratios will be used as reference
	...
	def set_improve_mesh(self, type: str, expand_zones: int) -> None:
	...
	def preview(self) -> None:
		...
		Preview the result of the morphing action
		WARNING: Unless method "apply" is called, the morphing action will be finally cancelled in the end of the python script
	...
	def create_symmetric(self) -> object:
		...
		Create a symmetric DIRECT_FORM Entity relative to the default symmetry plane
		The current morph.Form object doesn't have to be saved as DIRECT_FORM Entity
	...
	def save_as_Direct_Form(self, name: str) -> None:
	...
	def set_positive_plane_twist(self, angle: float) -> None:

		"""

		Define twist in mode 'Free Ends' and 'Pinned Ends'
		If needed, change Form mode prior to this action
	...
	def set_negative_plane_twist(self, angle: float) -> None:
	...
	def set_positive_plane_extend(self, e_ratio: float) -> None:

		"""

		Define extend in mode 'Free Ends'
		If needed, change Form mode prior to this action
	...
	def set_negative_plane_extend(self, e_ratio: float) -> None:
	...
	def set_negative_plane_y_taper(self, y_ratio: float) -> None:

		"""

		Define taper in mode 'Free Ends' and 'Pinned Ends'
		If needed, change Form mode prior to this action
	...
	def set_positive_plane_y_taper(self, y_ratio: float) -> None:
	...
	def set_positive_plane_z_taper(self, z_ratio: float) -> None:
	...
	def set_negative_plane_z_taper(self, z_ratio: float) -> None:
	...
	def initial_positive_plane_length(self, length: float) -> None:

		"""

		Adjust the plane for the initial state
	...
	def initial_negative_plane_length(self, length: float) -> None:
	...
	def initial_positive_plane_angle(self, angle: float) -> None:
	...
	def initial_negative_plane_angle(self, angle: float) -> None:
	...
	def initial_positive_plane_twist(self, angle: float) -> None:
	...
	def initial_negative_plane_twist(self, angle: float) -> None:
	...
	def initial_positive_plane_extend(self, e_ratio: float) -> None:
	...
	def initial_negative_plane_extend(self, e_ratio: float) -> None:
	...
	def initial_negative_plane_y_taper(self, y_ratio: float) -> None:
	...
	def initial_positive_plane_y_taper(self, y_ratio: float) -> None:
	...
	def initial_negative_plane_z_taper(self, z_ratio: float) -> None:
	...
	def initial_positive_plane_z_taper(self, z_ratio: float) -> None:
	...
	def set_user_section(self, x: float, y: float, z: float, dx: float, dy: float, dz: float) -> None:
		...
		Define a custom plane as reference for cross-sections, to be preserved along neutral line
		User Section is defined by a vector normal to its plane
	...
	def clear_user_section(self) -> None:

		"""

		Clear definition of User Section
		This action will enable default plane sectioning
	...
	def set_mode(self, mode: str) -> None:
		...
		Set mode of forming: either 'Free Ends' or 'Pinned Ends'
		Form object is set by default to 'Free Ends' mode, unless initiallization is performed according to a DIRECT_FORM entity, where the mode is predefined.  This action will reset Form to its initial setup
	...
	def set_axes_displacement(self, neutral_axis: float, deflection_axis: float) -> None:

		"""

		Set displacement of Neutral and Deflection axes in 'Pinned Ends' mode to define bending
		If needed, change Form mode prior to this action
	...
	def set_performance(self, performance_option: str) -> None:
		...
		Determin the morphing performance of Form. Fast: only perimeters of Formed entities affect Transition entities. Accurate: all Formed entities affect Transition entities
...
class DCFeatureSlide:
	...
	feature_area: list[base.Entity] = None
	"""
	...
	surface_area: list[base.Entity] = None
	"""
	...
	def set_feature_area(self, feature_area_entities: list[base.Entity]) -> None:

		"""

		Set feature area entities


		Parameters
		----------
		feature_area_entities : list[base.Entity]
	...
	def insert_feature_area(self, feature_area_entities: list[base.Entity]) -> None:

		"""

		Insert entities to feature area
	...
	def remove_feature_area(self, feature_area_entities: list[base.Entity]) -> None:

		"""

		Exclude entities from feature area
	...
	def clear_feature_area(self) -> None:
	...
	def set_surface_area(self, surface_area_entities: list[base.Entity]) -> None:

		"""

		Set surface area entities


		Parameters
		----------
		surface_area_entities : list[base.Entity]
	...
	def insert_surface_area(self, surface_area_entities: list[base.Entity]) -> None:

		"""

		Insert entities to surface area
	...
	def remove_surface_area(self, surface_area_entities: list[base.Entity]) -> None:

		"""

		Exclude entities from surface area
	...
	def clear_surface_area(self) -> None:
	...
	def set_movement_type_free(self) -> None:
	...
	def set_movement_type_on_surface(self) -> None:
	...
	def set_movement_type_follow_path(self) -> None:
	...
	def set_movement_on_path(self, type: str) -> None:
	...
	def save_as_DC_Feature(self) -> base.Entity:
	...
	def set_translation_vector(self, dx_or_ds: float, dy_or_dt: float, dz: float) -> None:
	...
	def set_rotation_angles(self, rx_or_r: float, ry: float, rz: float) -> None:
	...
	def set_distance_on_path(self, distance: float) -> None:
	...
	def set_frozen_perimeters(self, perimeters_entities: list[base.Entity]) -> None:

		"""

		Set frozen perimeters entities


		Parameters
		----------
		perimeters_entities : list[base.Entity]
	...
	def clear_frozen_perimeters(self) -> None:
	...
	def set_improve_mesh(self, type: str, zones: int=0) -> None:
	...
	def snap_to_feature_lines(self, active: bool) -> None:

		"""

		Any Feature's node that lie very close to a recognized FE Perimeter will be snapped to it
	...
	def set_projection_direction(self, type: str) -> None:
		...
		----------
		type : str
			For movement types 'Free' the projection direction options are: 
			- 'Closest point'
			- 'X_Axis'
			- 'Y_Axis'
			- 'Z_Axis'
	...
	def set_projection_distance(self, distance: float) -> None:

		"""

		Define the projection distance
	...
	def set_projection_distance_active(self, active: bool) -> None:

		"""

		Set to 'True', in order for morphing to respect the maximum projection distance and direction.
	...
	def __init__(self, dc_feature_slide: base.Entity) -> None:
		...
		Parameters
		----------
		dc_feature_slide : base.Entity, optional
	...
	def create_symmetric(self) -> base.Entity | None:
	...
	def set_treat_feature_as(self, type: str) -> None:

		"""

		Available only in Path movement


		Parameters
		----------
		type : str
			A string that defines if the movement on path is 'Deformable' or 'Rigid'.
	...
	def clear_feature_patch(self) -> None:

		"""

		Delete feature patches for all features in definition
...
class DCFeatureCopy:
	...
	::
		...
		def copy_feature_example_on_path():
		    ...
		    copy_obj.set_distance_type("spacing")
	...
	def set_feature_area(self, feature_area_entities: Iterable[base.Entity]) -> None:
		...
		Parameters
		----------
		feature_area_entities : Iterable[base.Entity]
			A list of entities to be inserted in object's member "feature_area". Preexisting entities will be discarded.
	...
	def insert_feature_area(self, feature_area_entities: Iterable[base.Entity]) -> None:
	...
	def remove_feature_area(self, feature_area_entities: Iterable[base.Entity]) -> None:
	...
	def set_surface_area(self, surface_area_entities: Iterable[base.Entity]) -> None:
		...
		Parameters
		----------
		surface_area_entities : Iterable[base.Entity]
			A list of entities to be inserted in object's member "surface_area". Preexisting entities will be discarded.
	...
	def insert_surface_area(self, surface_area_entities: Iterable[base.Entity]) -> None:
	...
	def remove_surface_area(self, surface_area_entities: Iterable[base.Entity]) -> None:
	...
	def set_path(self, path_entities: Iterable[base.Entity]) -> None:
		...
		Parameters
		----------
		path_entities : Iterable[base.Entity]
			A list of entities to be inserted in object's member "path". Preexisting entities will be discarded.
	...
	def insert_path(self, path_entities: Iterable[base.Entity]) -> None:
	...
	def remove_path(self, path_entities: Iterable[base.Entity]) -> None:
	...
	def set_projection_direction(self, type: int) -> None:
	...
	def set_projection_distance(self, distance: int) -> None:
	...
	def __init__(self, dc_feature_copy: base.Entity) -> None:
		...
		Parameters
		----------
		dc_feature_copy : base.Entity, optional
	...
	def set_pattern_array(self) -> None:
	...
	def set_pattern_circular(self) -> None:
	...
	def set_pattern_follow_path(self) -> None:
	...
	def set_distance_type(self, distance_type: str) -> None:
		...
		----------
		distance_type : str
			A string to define distance type. Accepts either 'spacing' or 'extent' for input value.
	...
	def set_array_distance(self, dx: float, dy: float) -> None:
	...
	def set_circular_angle(self, rz: float) -> None:
	...
	def set_steps_x(self, num_steps_x: int) -> None:

		"""

		Available only in movement pattern 'Array'
	...
	def set_steps_y(self, num_steps_y: int) -> None:
...
class ChangeHoleDiameter:
	...
	def __init__(self, hole_2d_feature: object) -> None:
...
class ConstraintSteadySection:
	...
	def __init__(self, steady_section_constraint: object) -> None:
	...
	def insert_neutral_line(self, neutral_line_entities: object) -> None:

		"""

		Insert entities to neutral line
	...
	def set_neutral_line(self, neutral_line_entities: object) -> None:

		"""

		Set neutral line entities
	...
	def remove_neutral_line(self, neutral_line_entities: object) -> None:

		"""

		Exclude entities from object's member "neutral_line"
	...
	def clear_neutral_line(self) -> None:
...
class TubesDepenetrate:
	...
	User must first configure the problem by loading the tubes and the surrounding properties. 
	Optionally he/she may want to load dragged elements, fixed grids or to change the default configuration parameters. (Penetration parametric options, series separation angle, fix method). 
	Once configuration is done, method ".run()" can be called to carry out the automatic fix. Changes in configuration are not allowed thereafter. User can call method ".cancel()" to return everything to its initial position. Results are returned to the user either as a list of penetration pairs or as a total penetration depth number, each of these two at any desired state (initial, transform, transform_and_resize). After the process has run, user can call ".build_morphing_boxes()" method to get back cylindrical MORPHBOX entities which may aid to manually fix remaining penetrations.
...
class ChangeTubeDiameter:
	...
	def __init__(self, hole_3d_feature: object) -> None:
...
class DCFeatureScale:
	...
	feature_area: Iterable[base.Entity] = None
	"""
	A list of entities that represent the features to be morphed. The type of these entities can be SHELL, SHELLEDGE or a type of FEATURE group (HOLE 2D, HOLE 3D, RIB 2D, STAMP).

	"""

	surface_area: Iterable[base.Entity] = None
	"""
	A list of SHELL entities that represent the surface on which the feature entities will slide.
	...
	def save_as_DC_Feature(self) -> None:
	...
	def __init__(self, dc_feature_scale: base.Entity) -> None:
		...
		Parameters
		----------
		dc_feature_scale : base.Entity, optional
	...
	def set_scale_factors(self, fx: float, fy: float, fz: float) -> None:

		"""

		Set scale factors x,y,z
	...
	def set_frozen_perimeters(self, perimeters_entities: Iterable[base.Entity]) -> None:
		...
		Parameters
		----------
		perimeters_entities : Iterable[base.Entity]
			A list of one-dimensional entities (SHELLEDGE) to be regarded as 'frozen' during the morphing.
	...
	def clear_frozen_perimeters(self) -> base.Entity:
		...
		-------
		base.Entity
			Returns A DC_FEATURE_SCALE entity
...
class ParamConnectionChain:
	...
	def __init__(self, connection_chain_parameter: object) -> None:
		...
		::
			...
			param = base.GetEntity(0, "PARAMETERS", a_id)
			object = ansa.morph.ParamConnectionChain(param)
...
def OptimizationTaskActiveFolder() -> str:

	"""

	Function to get the DOE or Optimization folder

	Returns
	-------
	str
		The active folder or None if no DOE or Optimization running
	...
	::
		...
		def main():
		    print(ansa.morph.OptimizationTaskActiveFolder())
...
def GetDOEStudyResults(optimization_task: object, results_path: str, exp_prefix: str) -> dict:
...
class NominalToReal:
	...
	Class providing methods to fit a model to another similar Target model.

	Notes
	-----
	The function is ideal for fitting nominal models to the real ones, usually produced by scanning process.

	Examples
	--------
	::

		from ansa import constants, base, morph
		
		
		def main():
		    n2r = morph.NominalToReal()
		
		    part = base.GetPartFromModuleId("1")
		    solids = base.CollectEntities(constants.NASTRAN, part, "SOLID", recursive=True)
		    n2r.insert_source(solids)
		
		    part = base.GetPartFromModuleId("2")
		    shells = base.CollectEntities(constants.NASTRAN, part, "SHELL", recursive=True)
		    n2r.insert_target(shells)
		
		    n2r.method = "Combined"
		    n2r.distance = 2
		    n2r.result_type = "Morph"
	...
	method: str = None
	"""
	Defines the fitting method:
	"Transform" - a quick approach that tries to fit the Source to the Target model, by applying appropriate transformations
	"Closest Point" - a more accurate process that after transformations, applies normal projections from the Source to the Target model
	"Combined" - a combination of Transform and Closest point options. First performs the Transform method and then the Closest Point method is applied on the Transform method results

	"""

	result_type: str = None
	"""
	Defines the end result of the mephod:
	"Morph" - morphing of the source entities
	"DV Grids" - creation of DVGrind
	"Deformation" - creation of a Deformation parameter

	"""

	blend: float = None
	"""
	Defines interpolation weigh factors between the Transform (0) and Closest Point (1) methods in the Combined method. Range [0,1].

	"""

	distance: float = None
	"""
	The searching area around nodes of the source model for Closest Point and Combined methods

	"""

	source: list = None
	"""
	A list of elements (shells/faces/solids/volumes) of the source model

	"""

	target: list = None
	"""
	A list of elements (shells/faces/solidfacets/volumefacets) of the target model

	"""

	def insert_source(self, entities: list) -> None:

		"""

		Insert entities to source


		Parameters
		----------
		entities : list
			list of entities (shells/faces/solids/volumes) to be included in source model
	...
	def set_source(self, entities: list) -> None:
		...
		----------
		entities : list
			A list of entities to be included in source model. Preexisting entities will be discarded.
	...
	def remove_source(self, entities: list) -> None:
	...
	def clear_source(self) -> None:
		...
		Remove all existing entities from source model.
	...
	def insert_target(self, entities: list) -> None:

		"""

		Insert entities to target


		Parameters
		----------
		entities : list
			A list of entities (shells/faces/solidfacets/volumefacets) to be included in target model
	...
	def set_target(self, entities: list) -> None:
		...
		----------
		entities : list
			A list of entities to be included in target model. Preexisting entities will be discarded.
	...
	def remove_target(self, entities: list) -> None:

		"""

		Remove entities from target


		Parameters
		----------
		entities : list
			A list of entities to be excluded from target model.
	...
	def clear_target(self) -> None:
		...
		Remove all  entities included in target model.
	...
	def accept(self) -> None:
		...
		Perform and confirm the morphing action. Unless this method has been called, any morphing action will be cancelled at the end of the Python script.
...
def OptimizationToolClose() -> None:

	"""

	Function to close the Optimization Tool
	...
	::
		...
		def main():
		    morph.OptimizationToolClose()


	"""

def PerformOptimizationPath(server_id: str, working_directory: str, run_validation: bool=True) -> int:

	"""

	Function to perform an Optimization Study

	Parameters
	----------
	server_id : str
		The Optimization Study id

	working_directory : str
		The directory to save the Optimization

	run_validation : bool, optional
		Validate results if an RSM was used
	...
	::
		...
		def createOptimizationStudy(dm_dir, name):
		    names_values = {
		        ...
		        "DM Root": dm_dir,
		        "Iteration": "001",
		        "DOE/DV/front_height/Initial Value": "0.444444",
		        "DOE/DV/front_height/Max Value": "4.",
		        "DOE/DV/front_height/Min Value": "0.",
		        "DOE/DV/rear_height/Initial Value": "0.",
		        "DOE/DV/rear_height/Max Value": "1.",
		        "DOE/DV/rear_height/Min Value": "0.",
		        "DOE/DV/rear_width/Initial Value": "1.111111",
		        "DOE/DV/rear_width/Max Value": "5.",
		        "DOE/DV/rear_width/Min Value": "0.",
		        "DOE/DV/side_height/Initial Value": "2.",
		        "DOE/DV/side_height/Max Value": "4.",
		        "DOE/DV/side_height/Min Value": "0.",
		        "DOE/DV/side_width/Initial Value": "0.",
		        "DOE/DV/side_width/Max Value": "5.",
		        "DOE/DV/side_width/Min Value": "0.",
		        "Optimization/Objectives/Objective_1": "case_torsion,Minimize",
		        "Parameters/Acceptance probability function": "2",
		        "Parameters/Initial temperature": "Default",
		        "Parameters/Log: Display in terminal": "0",
		        "Parameters/Log: Export to file": "1",
		        "Parameters/Maximum perturbation length": "0.1",
		    }
		
		    new_object = dm.DMObject(names_values=names_values, type="Optimization_Study")
		...
		def main(path):
		    sid = createOptimizationStudy(path, "DIR_SA_1")
		    ansa.morph.PerformOptimizationPath(sid, path)
		
		
		main("../Subframe/OPT_DM")


	"""

def PerformOptimizationDM(server_id: str, working_directory: str, upload_results: bool=True, run_validation: bool=True) -> int:
	...
	upload_results : bool, optional
		Upload results to DM

	run_validation : bool, optional
		Validate solution when RSM was used
	...
	::
		...
		def main(sid):
		    ansa.morph.PerformOptimizationDM(
		        server_id=sid, working_directory="../SubframeDM/Temp/", upload_results=True
		    )
...
class DeformMap:
	...
	Class providing morphing methods on entities according to predefined vectors. 
	Available ways to define the morphing vectors:
	...
	::
		...
		def main():
		    # Initialize DeformMap object
		    dm = morph.DeformMap()
		    # Set the text filename - full path "~/home/user/fem_g/displacement_field.txt"
		    # dm.text_file = "~/PATH_TO_YOUR_DIRECTORY/displacement_field.txt"
		    # Set morphed entities
		    dm.set_morphed(base.GetEntity(constants.NASTRAN, "SET", 1))
		    # Auto calculation of bounds
		    dm.calculate_bounds()
		    # Set of the maximum displacement
		    dm.max_displacement = 10
		    # Apply deform map and make the morphing
		    dm.apply()
	...
	PARAMETERS: list[base.Entity] = None
	"""
	A list of PARAMETER entities

	"""

	text_file: str = None
	"""
	A string to a .txt file

	"""

	DESVAR: list[base.Entity] = None
	"""
	A list of design variable entities

	"""

	HISTORY_STATE: list[base.Entity] = None
	"""
	A list of history state variable entities
	...
	"""
	The number of the activated vectors.

	"""

	work_on_visible: bool = None
	"""
	Option to work only with visible or not.

	"""

	max_displacement: float = None
	"""
	Maximum displacement is expressed as an absolute value.
	e.g max_displacement = 11.41, will restrict larger vectors on this value.

	"""

	trim_offset: float = None
	"""
	The value which will be used to trim vectors

	"""

	activated_type: int = None
	"""
	Activated type expresses one of the following methods for the morphing vectors
	- 0: Deformation parameter
	- 1: History state
	- 2: Design variable
	- 3: Sensitivity
	- 4: Text file
	...
	def remove_morphed(self, morphed: list[base.Entity]) -> None:
		...
		----------
		morphed : list[base.Entity]
			A list of entities to be removed from objects's member "morphed"
	...
	def insert_bounds(self, bounds: list[base.Entity]) -> None:
	...
	def conflict_check(self, search_tolerance: float, conflict_action: str="Continue") -> dict:

		"""

		Checks whether conflicted regions of moved and bounds exists.


		Parameters
		----------
		search_tolerance : float
			Search distance in which conflict check will take place

		conflict_action : str, optional
			Action to be taken if conflict exists. Options are :
			- "Continue" (default)
			- "Remove bounds"
			- "Remove morphed"
		...
		-------
		dict
			A dictionary with two entries which indicate the number of conflicted bounds and moved respenctively.
			[{conflicted_bounds_num, 10},
			 {conflicted_moved_num,    5}]
			
			"conflicted_bounds_num" and "conflicted_moved_num" are the keys used for this dictionary
	...
	def clear_unmatched(self) -> None:
		...
		Vector with no matching node will be removed.
	...
	def clear(self) -> None:
		...
		It will clear the whole DeformMap object
	...
	def apply(self) -> None:
		...
		It will collect the necessary information and perform the movement
	...
	def export_csv(self, csv_filename: str) -> None:

		"""

		Saves all active vectors in a text file format: x, y, z, dx, dy, dz
	...
	def trim_vectors(self, collision_entities: list[base.Entity]) -> None:

		"""

		Trim vectors based on collision with entities. The trim offset value will taken into account in this process.


		Parameters
		----------
		collision_entities : list[base.Entity]
			Insert entities for collision detection
	...
	def remove_vectors_x_component(self) -> None:

		"""

		Clear movement on X axis
	...
	def remove_vectors_y_component(self) -> None:

		"""

		Clear movement on Y axis.
	...
	def remove_vectors_z_component(self) -> None:

		"""

		Clear movement on Z axis
