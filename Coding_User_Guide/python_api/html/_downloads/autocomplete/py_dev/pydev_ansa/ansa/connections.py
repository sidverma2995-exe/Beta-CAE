...
def AddAssemblyRuleToAssemblyRulesGroup(rules: list, rules_group: base.Entity) -> int:
	...
	See Also
	--------
	ansa.connections.CreateNewAssemblyRule, ansa.connections.CreateNewAssemblyRulesGroup, ansa.connections.CreateNewAssemblyScenario, ansa.connections.AddAssemblyRulesGroupToAssemblyScenario
...
def AddAssemblyRulesGroupToAssemblyScenario(rules_groups: base.Entity, scenario: base.Entity) -> int:
	...
	See Also
	--------
	ansa.connections.CreateNewAssemblyRule, ansa.connections.CreateNewAssemblyRulesGroup, ansa.connections.CreateNewAssemblyScenario, ansa.connections.AddAssemblyRuleToAssemblyRulesGroup
...
def AddFilterToAssemblyRule(field: str, expression: str, value: str, session: base.Entity, match: str='all', case_sensitive: str='no', filter_name: str='') -> int:
...
def AssignConnectionSettings(connections: Iterable[base.Entity], parameters: dict) -> int:
	...
	Parameters
	----------
	connections : Iterable[base.Entity]
...
def AutoSetConnectivityInConnections(connections: Iterable[base.Entity], filter_visible: bool=False, output_mode: str='pid', search_faces: bool=True, search_shells: bool=True, search_solids: bool=False, search_tubes: bool=False, search_projection: bool=True, search_holes: bool=False, use_hole_shape: bool=True, use_hole_proximity: bool=True, hole_proximity_distance: float=100.0, hole_proximity_angle: float=10.0, match_hole_params: str='any', search_distance: float=5.0, use_settings: bool=False, search_on_direction: bool=False, search_from: float=-1.0, search_to: float=1.0, find_nearest: int=2, find_up_to: int=2, find_exactly: int=2, between_parts: bool=False, clear_connectivity: bool=True, tubes_feature_line_angle_limit: float=30.0, consider_part_hierarchy: bool=False) -> None:
...
def CenterConnections(connections: Iterable[base.Entity]) -> int:
...
def CollectAffectedConnectionEntities(part: base.Entity, connection_type: str, search_option: str) -> list | int:
...
def ConnectivityStringToEnts(connectivity: str) -> list[base.Entity]:
...
def ConvertConnections(connections: list[base.Entity], point_to: str, line_to: str, create_single_line: bool) -> int:
...
def ConvertConnectivity(connections: list[base.Entity], connectivity_mode: str, search_nearest_dist: float) -> None:
	...
	------
	ValueError
		requested connectivity mode is invalid
...
def ConvertFeRepToConnection(entities: list[base.Entity], convert_type: str, connectivity_mode: str, check_violated_elements: bool) -> list[base.Entity]:
...
def ConvertTubesToConnections(connection_type: str, input_faces: list[base.Entity], connections: bool, matched_faces: bool, unmatched_faces: bool) -> dict:
...
def CreateConnectionFace(type: str, faces: list[base.Entity], id: int, connectivity: list[base.Entity], create_new_face: bool) -> base.Entity:
	...
	connectivity : list[base.Entity], optional
	...
	See Also
	--------
	ansa.connections.CreateConnectionLine, ansa.connections.CreateConnectionPoint, ansa.connections.EntsToConnectivityString
...
def CreateConnectionLine(type: str, curves: list[base.Entity], id: int, connectivity: list) -> base.Entity:
	...
	See Also
	--------
	ansa.connections.CreateConnectionPoint, ansa.connections.CreateConnectionFace, ansa.connections.EntsToConnectivityString
...
def CreateConnectionPoint(type: str, position: list[base.Entity], id: int, connectivity: list) -> base.Entity:
	...
	See Also
	--------
	ansa.connections.CreateConnectionLine, ansa.connections.CreateConnectionFace, ansa.connections.EntsToConnectivityString
...
def DefineConnectionHoles(entities: list[base.Entity], create: str, output_mode: str, parts_proximity_for_connection_merging: float, maximum_length: float, exclude_single_part_connections: bool, match_hole_params: str, search_holes: bool, use_hole_shape: bool, use_hole_proximity: bool, hole_proximity_distance: float, hole_proximity_angle: float, hole_minimum_diameter: float, hole_maximum_diameter: float, tube_minimum_diameter: float, tube_maximum_diameter: float, search_tubes: bool, tubes_feature_line_angle_limit: float) -> list:
...
def EntsToConnectivityString(connectivity: list[base.Entity]) -> str:
...
def EraseConnectionFeRep(connections: list[base.Entity]) -> int:
...
def FindDuplicateConnections(connections1: list[base.Entity], connections2: list[base.Entity], point_distance_method: str, connection_point_distance: float, average_thickness_factor: float, curve_face_distance: float, similarity: float, equivalent_connectivity: bool, same_type: bool, pair_results: bool, distance_of_projection_center: float) -> dict | int:
	...
	Parameters
	----------
	connections1 : list[base.Entity]
		A list that contains the first group of connection entities.

	connections2 : list[base.Entity], optional
...
def GetAllConnectionSettings(connection: base.Entity) -> object:
...
def GetConnectionProjections(connections: list[base.Entity], search_distance: float) -> list[base.Entity]:
...
def GetConnectionSettings(connection: base.Entity, parameters: list) -> dict:
...
def GetFirstFeRep(connections: base.Entity) -> base.Entity:
...
def GetNearestPointOnBound(points: Iterable[Iterable[float]], parts_props: Iterable[Iterable[base.Entity]], search_dist: float) -> list[float] | int:
...
def GetNearestPointOnFeature(points: Iterable[Iterable[float]], parts_props: Iterable[Iterable[base.Entity]], search_dist: float, feature_angle: float) -> list[base.Entity]:
...
def GetNextFeRep(connection: base.Entity, entity: base.Entity) -> base.Entity:
...
def GetSpwDiamFromThickness(connection: base.Entity, search_distance: float) -> float:
	...
	Notes
	-----
	If the user has set in ANSA.defaults as 'Spot Weld Diameter Map' 
	a script function, this function has to be in the same file as GetSpwDiamFromThickness()
	function, else the default thickness-diameter table is used for the diameter calculation.
...
def OutputConnections(connections: list, filetype: str, filename: str) -> int:
	...
	filetype : str
		...
		"xMCF 3.1", "xMCF 3.1(pid)","xMCF 3.0(Module id & pid)","xMCF 3.1(Module id & pid)".
...
def ReApplyConnections(connections: list[base.Entity]) -> int:
...
def ReadConnections(filetype: str, filename: str, group_name: str, offset_val: int) -> int:
...
def RealizeConnections(connections: list, parameters: dict) -> int:
	...
	See Also
	--------
	ansa.connections.GetAllConnectionSettings
...
def RemoveDoubleConnections(connections: list[base.Entity], tolerance: float=5.0, equivalent_connectivity: bool=False, keep_id: str="highest", move_to_middle: bool=False, action: str="delete") -> int:
...
def SetDefault(fields: tuple) -> int:
...
def RunAssemblyScenario(scenarios: base.Entity, realize_connections: bool=False) -> int:
...
def ActivateConnectionsEnts(connection_ents: Iterable[base.Entity], make_active: bool) -> int:
	...
	Parameters
	----------
	connection_ents : Iterable[base.Entity]
...
def AddFilterToAssemblyRulesGroup(field: str, expression: str, value: str, session: base.Entity, match: str="all", case_sensitive: str="no", filter_name: str="") -> int:
...
def OpenConnectionManager(connections: base.Entity | list[base.Entity]=None, mode: str='modal', inspection_mode: bool=False, confirm_to_close: bool=False) -> bool:
	...
	Parameters
	----------
	connections : base.Entity | list[base.Entity], optional
...
def ReplaceConnectivity(old_connectivity: base.Entity | list[base.Entity], new_connectivity: base.Entity | list[base.Entity], connections: base.Entity | list[base.Entity], connectivity_indexes: int) -> None:
	...
	Parameters
	----------
	old_connectivity : base.Entity | list[base.Entity]
		A part, a prop, an include, a subsytem or a list of them.

	new_connectivity : base.Entity | list[base.Entity]
		A part, a prop, an include, a subsytem or a list of them.

	connections : base.Entity | list[base.Entity]
...
def GroupConnectionsByConnectivity(connections: list[base.Entity]) -> dict[str, list]:
...
def ConvertConnectionsToGeometry(connections: list[base.Entity], part: base.Entity) -> list[base.Entity]:
...
def FindDuplicateTemplates(templates: list[base.Entity]) -> list[base.Entity]:
...
def SetWeldPosition(connections: list[base.Entity], set_method: str="Manual") -> list[base.Entity]:
	...
	-----
	set_method:
	  - "Manual" is supported only when ANSA runs with GUI.
	  - "Automatic" is supported in -nogui option as well.
...
def SplitConnectionLinesByAngle(connections: base.Entity, corner_angle: float) -> dict:
	...
	-------
	dict
		A dictionary containing the keys 'splitted' and 'not_splitted'.
...
def CreateConnectorFromInterfacePoints(interface_points: list[base.Entity], match_only_identical_names: bool, matching_proximity: float, create_external_connectors_only: bool, representation: str, max_number_of_connected_points: int, settings: dict) -> dict:
	...
	Parameters
	----------
	interface_points : list[base.Entity]
	...
	settings : dict, optional
		A dictionary with keys the name of the BC card
...
def CollectConnectionCurves(connection: base.Entity) -> list[base.Entity]:
...
def FindConnectionCharacteristics(connections: list[base.Entity], search_pattern: bool=False, average_angle: bool=False) -> dict:
	...
	Notes
	-----
	By default no characteristic will be returned, at least one should be provided.
...
def ChangeDensity(connection_chains: list[base.Entity], density_factor: float) -> None:
	...
	Parameters
	----------
	connection_chains : list[base.Entity]
	...
	Notes
	-----
	Provide a factor value greater than 1.0 to increase the density of the connections of the group.
	Provide a factor value less than 1.0 to decrease the density of the connections of the group.
	
	A factor value 2.0 doubles the density of the connections in the group.
	A factor value 0.5 halves the density of the connections in the group.
...
def FeRepSettingsConvertIDsToReferences(connections: list[base.Entity]) -> dict:
...
def ApplyDensityHistogram(connection_chains: Iterable[base.Entity], interval_params: Iterable[float], densities: Iterable[float]) -> None:
	...
	Parameters
	----------
	connection_chains : Iterable[base.Entity]
		a list of ANSA "CONNECTION_CHAIN" entities.

	interval_params : Iterable[float]
	...
	Notes
	-----
	The intervals list contains only the starting value of each interval.
	The first value in the intervals list is always 0.0.
	The ending of the last interval is not included, as it always corresponds to 1.0

	See Also
	--------
	ansa.connections.ChangeDensity
...
def SortConnectivity(connections: list[base.Entity]) -> bool:
...
def CompactConnectionFaces(connections: Iterable[base.Entity]) -> dict[int,bool]:
	...
	Notes
	-----
	This function works only for unrealized connections and for connection without 
	any FE.
	
	If the original faces (or any of their shells/nodes) of a connection are 
	referenced by any entity, then no replacement takes place for the given 
	connection.
	
	If the original faces (or any of their shells/nodes) belong to any container as 
	SET, INCLUDE etc, then this information is lost as the new faces are put only in 
	connection's INCLUDE.
...
def AutoCreateSeamlines(shells: Iterable[base.Entity], max_distance: float=10.0, min_distance: float=0.0, min_length: float=0.0, max_angle: float=70.0, preview: bool=True, output_mode: str='pid') -> list[base.Entity] | None:

	"""

	Creates Seamlines in auto-recognized suitable areas.

	Parameters
	----------
	shells : Iterable[base.Entity]
		A list that contains shells with which the function will run.

	max_distance : float, optional
		Maximum allowed distance between properties that Seamlines will connect.
		(Default: 10)

	min_distance : float, optional
		Minimum allowed distance between properties that Seamlines will connect.
		(Default: 0)

	min_length : float, optional
		Minimum allowed length of a created Seamline.
		(Default: 0)

	max_angle : float, optional
		Maximum allowed corner angle (degrees) of a created Seamline.
		(Default: 70)

	preview : bool, optional
		Preview Option for the created Seamlines.
		(Default: True)
	...
	list[base.Entity] | None
		Returns a list with the newly created Seamlines, or None on error.
	...
	::
		...
		def main():
		    ...
		    conns = connections.AutoCreateSeamlines(
		        shells=entities,
		        max_distance=10,
		        min_distance=0,
		        min_length=0,
...
def AutoCreateConnectionChains(connections: list) -> list[base.Entity]:

	"""

	This function creates CONNECTION_CHAIN entities  based on flange connectivity of input connections.
	...
	-------
	list[base.Entity]
		Returns a list  containing all the created CONNECTION_CHAIN entities or None on failure.
	...
	::
		...
		def main():
		    ...
		    connections.AutoCreateConnectionChains(cnctns)


	"""

def DefineConnectionChain(connections: list[base.Entity], sort_geometrically: bool) -> base.Entity:

	"""

	Creates CONNECTION_CHAIN entity. The order of connections in chain is the same with order of connections in list if argument 'sort_geometrically' is off. Else connections are sorted geometrically.
	...
	sort_geometrically : bool
		Sorts connections in CONNECTION_CHAIN geometrically.

	Returns
	-------
	base.Entity
		Returns created CONNECTION_CHAIN entity or None on failure.
	...
	::
		...
		def main():
		    ...
		    connections.DefineConnectionChain(cnctns, sort_geometrically=True)


	"""

def FlipEndpoints(connections: Iterable[base.Entity]) -> None:

	"""

	It flips the start/end of a connection.

	Parameters
	----------
	connections : Iterable[base.Entity]
		A list of connections whose start/end point will be flipped.
	...
	::
		...
		def main():
		    cnctns = base.CollectEntities(0, None, "__CONNECTIONS__")
		    connections.FlipEndpoints(cnctns)
