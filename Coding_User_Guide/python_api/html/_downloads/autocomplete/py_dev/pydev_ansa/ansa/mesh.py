...
def AlignMeshToMesh(source_part: base.Entity, target_parts: base.Entity) -> dict | None:
...
def AspacingCFD(Growth_rate: float, Feature_angle: float, Min_length: float, Max_length: float, Sharp_angle_limit: float, Sharp_angle_length: float) -> None:
...
def AspacingSTL(chordal_deviation: Any, max_length: float, feature_angle: float, min_length: float) -> None:
...
def AutoMatch(visible: bool, shells: Iterable[base.Entity], nodes: Iterable[base.Entity], project_on_geometry: bool, project_2nd_order_nodes: bool, isolate: bool, move_to: str, preserve_id: str, distance: float, name: str) -> int:
	...
	shells : Iterable[base.Entity], optional
		A list of shells.

	nodes : Iterable[base.Entity], optional
		A list of nodes.
...
def AutoPaste(visible: bool, shells: Iterable[base.Entity], nodes: Iterable[base.Entity], project_on_geometry: bool, project_2nd_order_nodes: bool, isolate: bool, move_to: str, preserve_id: str, distance: float, name: str, allow_element_collapse: bool) -> int:
...
def CheckShellTheta(shells: Iterable[base.Entity], prototype_shell: Iterable[base.Entity], do_fix: bool, tolerance: float) -> list[base.Entity] | None:
	...
	Parameters
	----------
	shells : Iterable[base.Entity]
		A list of shells to check material orientation.

	prototype_shell : Iterable[base.Entity]
...
def ConvertToPolyhedrals(solids: list[base.Entity], feature_angle: float, exclude_ANSA_layers: bool, ret_ents: bool, result_type: str, split_layers_at_sharp_convex_features: bool) -> int | list[base.Entity]:
	...
	Parameters
	----------
	solids : list[base.Entity], optional
...
def ConvertHexaToMorph(entities: list[base.Entity]) -> int:
...
def ConvertHexaToSizeBox(entities: list[base.Entity], max_surface_length: float, max_volume_length: float) -> int:
...
def Convex(input_data: list[base.Entity], tolerance: float, offset_status: str, offset_mode: str, offset_value: float, module_id: str, property_id: int) -> list[base.Entity]:
...
def CreateOGridTopology(hexa_boxes: list[base.Entity], free_faces: list[base.Entity], offset: float, pattern_type: str, pattern_coef: float, branch_faces: list[base.Entity], fix_intersections: bool, offset_algorithm: str) -> int:
	...
	branch_faces : list[base.Entity], optional
...
def DeleteOGridTopology(entities: list[base.Entity]) -> int:
...
def EdgesToPerimeter(SET: list[base.Entity]) -> int:
...
def FEMToSurf(shells: list[base.Entity], delete: bool, ret_ents: bool) -> int | list[base.Entity]:
...
def FEMToSurfArea(shells: list[base.Entity] | str, ret_ents: bool, delete: bool, imprint: bool) -> int | list[base.Entity]:
...
def FemTopo(tolerance: float, shells_to_be_pasted: list[base.Entity], max_tolerance: float, steps: int) -> int:
	...
	shells_to_be_pasted : list[base.Entity]
...
def FillGapFreeShells(SET1: list[base.Entity], SET2: list[base.Entity], RECONS: int, PART: base.Entity | int, PROP: base.Entity | int) -> list[base.Entity]:
	...
	PART : base.Entity | int
		A part object or a part id (module_id).

	PROP : base.Entity | int
...
def FillHole(diameter: float, point_on_center: bool, convert_to_spot: bool, create_curve: bool, zones_num: int, part_or_property: str, with_stl: bool, force_fill_external_perimeter: bool) -> list[base.Entity]:
...
def GetGridsThickness(Grids: list[base.Entity]) -> list[float]:
...
def GetMacroShells(macros: list[base.Entity]) -> list[base.Entity]:
...
def GetMapVolumeBoundaries(volume: base.Entity) -> dict:
...
@typing_extensions.deprecated("Deprecated since version 19.0.0.Use ansa.base.GetANSAdefaultsValues instead.")
def GetReconstructAttachedSolidsValue(labels: list[str]) -> dict:

	"""
	.. deprecated:: 19.0.0
		Use :py:func:`ansa.base.GetANSAdefaultsValues` instead.
	...
	warnings.warn("Deprecated since version 19.0.0.Use ansa.base.GetANSAdefaultsValues instead.", DeprecationWarning)

def GetShellMacro(shells: list[base.Entity]) -> list[base.Entity]:
...
@typing_extensions.deprecated("Deprecated since version 19.0.0.Use ansa.base.GetANSAdefaultsValues instead.")
def GetSmoothAttachedSolidsValue(labels: list[str]) -> dict:
...
def GetVolumeBoundary(volume: base.Entity) -> list[base.Entity]:
...
def GetVolumesMapParameters(volume: base.Entity) -> list | int:
...
def GetVolumesOffsetParameters(volume: base.Entity) -> list | int:
...
def GetVolumesRotateParameters(volume: base.Entity) -> dict:
...
def GetVolumesTranslateParameters(volume: base.Entity) -> list[float] | int:
...
def HexaBlockLength(edges: list[base.Entity], length: float, distribution: str, is_factor: bool) -> int:
...
def HexaBlockNumber(input: base.Entity | list[base.Entity] | int, number: str, apply_multiple_number: bool, remesh_macros: bool, apply_number_of: str, ortho_spaced: bool) -> int:
	...
	Parameters
	----------
	input : base.Entity | list[base.Entity] | int
...
def HexaBlockSpacing(edges: list[base.Entity], algorithm: str, factor: float, dmin: float, dmax: float, dmax_dmin_ratio: float, dlimit: float, steps: int, dir: str, factor_end: float, apply_to_opposite: bool, u_parameters: list, dstart: float, dend: float) -> int:
...
def HexaBlockVolSkin(volumes: list[base.Entity], ret_ents: bool) -> int:
...
def HexaBlockVolumes(boxes: list[base.Entity], tolerance: float, project: bool, output_filename: str, ret_ents: bool, tolerance_expr: str, apply_surface_fit: bool, project_non_associated: bool) -> int | list[base.Entity]:
...
def HexaBoxDelete(boxes: list[base.Entity]) -> int:
...
def HexaBoxUndelete(entities: list[base.Entity]) -> int:
...
def HexaInterior(coordinate: base.Entity, maximum_length: float, volume: base.Entity) -> int:
...
@typing_extensions.deprecated("Deprecated since version 18.0.0.Use ansa.mesh.HexaInterior instead.")
def HexaInteriorbyID(volume: int, coord: int, Maxlength: float) -> int:

	"""
	.. deprecated:: 18.0.0
		Use :py:func:`ansa.mesh.HexaInterior` instead.
	...
	warnings.warn("Deprecated since version 18.0.0.Use ansa.mesh.HexaInterior instead.", DeprecationWarning)

def InitPerimeters(cons: list[base.Entity], remesh_macros: bool, initialize_number: bool, initialize_spacing: bool, use_ansa_defaults_values: bool) -> int:
...
def IsVolumeMeshed(volume: base.Entity) -> int:
...
def IsolateBaffles(baffles_inside_volumes: bool, baffles_with_red_bounds: bool, baffles_between_two_volumes: bool) -> int:
...
def IsolateFeatureShells(PARAMS: tuple, EXPAND_LEVEL: int) -> list[base.Entity]:
...
def JoinMacros(entities: list[base.Entity], keep_mesh: bool, auto_delete_hot_points: bool, use_ansa_defaults_values: bool) -> int:
...
def ApplyNewLengthToMacros(element_length: str, perimeters: Iterable[base.Entity] | int, use_ansa_defaults_values: bool) -> int:
	...
	perimeters : Iterable[base.Entity] | int, optional
...
def ModifyOGridTopology(ogrid: base.Entity, offset: float, pattern_type: str, pattern_coef: float, fix_intersections: bool, offset_algorithm: str) -> int:
...
def MoveGridsToOrigin(entities: list[base.Entity]) -> int:
...
def OpenHole(coordinates: list[tuple], tolerance: float, number_of_zones: int, nodes_around_hole: int, hole_diameter: float, zone1_length: list[float], zone2_length: list[float], entities: list[base.Entity] | int) -> list:
...
@typing_extensions.deprecated("Deprecated since version 18.0.0.Use ansa.mesh.OrientVolume instead.")
def OrientVolumebyID(volume: int) -> int:

	"""
	.. deprecated:: 18.0.0
		Use :py:func:`ansa.mesh.OrientVolume` instead.
	...
	warnings.warn("Deprecated since version 18.0.0.Use ansa.mesh.OrientVolume instead.", DeprecationWarning)

def ProjectNodesArrayOnShells(input: base.Entity | list[base.Entity] | int, nodes_array: list[base.Entity], projection_tolerance: float, maximum_projections_number: int, user_projection_mode_vector: list, zones: list[float], number_of_shell_zones_affected: float, move_projection_to_nearest_perimeter: float, move_to_projected_perims: float, paste_projected_and_result_edges: bool, add_results_to_set: str, cut_faces_on_result_edges: bool, cut_faces_on_result_zones: bool, release_result_edges: bool, apply_fill_gap_on_results: bool, open_closed_perimeter_hole: bool, freeze_non_single_boundary: bool, is_extend: bool) -> int:
	...
	user_projection_mode_vector : list, optional
...
def ProjectOpenHole(holes: list[list], add_to_set: str, cut_faces_on_holes_edges: bool, cut_faces_on_zones_edges: bool) -> list[int]:
...
def ProjectPerimeterOnShells(input: base.Entity | list[base.Entity] | int, perimeters: base.Entity | list[base.Entity], projection_tolerance: float, maximum_projections_number: float, user_projection_mode_vector: list, target_edges_number: float, zones: list[float], number_of_shell_zones_affected: float, move_projection_to_nearest_perimeter: float, move_to_projected_perims: float, add_results_to_set: str, cut_faces_on_result_edges: bool, cut_faces_on_result_zones: bool, release_result_edges: bool, freeze_non_single_boundary: bool, apply_fill_gap_on_results: bool, open_closed_perimeter_hole: bool, is_extend: bool) -> int:
	...
	perimeters : base.Entity | list[base.Entity]
...
def ReconstructShells(SHELLS: list[base.Entity]) -> int:
...
def RefineElements(ELEMENTS_TO_BE_REFINED: list[base.Entity], EXTERNAL_TRANSITION_ZONE: int, MAX_REFINEMENT_STEPS: int, MIN_EDGE_LENGTH: float, NUMBER_OF_TRANSITION_ZONES: int, ALLOW_TRIAS_AT_REFINED_AREA: int, REFINEMENT_MESH_TYPE: int, SMOOTH_EXTERNAL_TRANS_ZONE: int, FREEZE_FREE_EDGES: int) -> int:
	...
	Parameters
	----------
	ELEMENTS_TO_BE_REFINED : list[base.Entity]
...
def RefineTrias(shells: list[base.Entity], number_of_transition_zones: int=0, preview_result: bool=True) -> int:
...
def ReleaseElements(FACES_VOLUMES_FOR_RELEASE: list[base.Entity]) -> int:
	...
	Parameters
	----------
	FACES_VOLUMES_FOR_RELEASE : list[base.Entity]
...
def ReleaseMacros(macros: list[base.Entity], remesh_macros: bool, keep_mesh: bool, delete_hot_points: bool, use_ansa_defaults_values: bool) -> int:
...
def SealGaps(min_distance: float, max_distance: float, width: int, feat_line_angle: float, ret_ents: bool=False, ignore_gaps_in_the_same_pid: bool=False) -> int | list:
...
def SetGridsThickness(grids: list[base.Entity], thickness: list[base.Entity], use_original_thickness: str) -> int:
...
@typing_extensions.deprecated("Deprecated since version 19.0.0.Use ansa.base.SetANSAdefaultsValues instead.")
def SetReconstructAttachedSolidsValue(attached_solids: str, conflicting_areas: str) -> int:

	"""
	.. deprecated:: 19.0.0
		Use :py:func:`ansa.base.SetANSAdefaultsValues` instead.
	...
	warnings.warn("Deprecated since version 19.0.0.Use ansa.base.SetANSAdefaultsValues instead.", DeprecationWarning)
...
def SetVolumesMapParameters(volume: base.Entity, method: str, steps: int) -> int:
...
def SetVolumesOffsetParameters(volume: base.Entity, dist: float, steps: int, middle: int, biasing: str, factor: float) -> int:
...
def SetVolumesRotateParameters(volume: base.Entity, x: float, y: float, z: float, dx: float, dy: float, dz: float, angle: float, steps: int, biasing: str, factor: float) -> int:
...
def SetVolumesTranslateParameters(volume: base.Entity, dx: float, dy: float, dz: float, dist: float, steps: int, biasing: str, factor: float) -> int:
...
def SimplifyMacros(faces: list[base.Entity] | str, fine_draft_slider: float, keep_perimeters_on_symmetry_plane: bool, maintain_sharp_edges: bool, minimum_side_length: float, minimum_perimeter_corner_angle: float, freeze_meshed_macros: bool, test_gui_result: bool) -> int:
...
@typing_extensions.deprecated("Deprecated since version 22.0.0.Use ansa.mesh.SolidSmooth instead.")
def SmoothTetra() -> int:

	"""
	.. deprecated:: 22.0.0
		Use :py:func:`ansa.mesh.SolidSmooth` instead.
	...
	warnings.warn("Deprecated since version 22.0.0.Use ansa.mesh.SolidSmooth instead.", DeprecationWarning)
...
def SplitElements(shells: list[base.Entity], ret_ents: bool=False) -> int:
...
@typing_extensions.deprecated("Deprecated since version 19.0.0.Use ansa.mesh.VolumesMeshV instead.")
def TetraCFD(volume: base.Entity) -> int:

	"""
	.. deprecated:: 19.0.0
		Use :py:func:`ansa.mesh.VolumesMeshV` instead.
	...
	warnings.warn("Deprecated since version 19.0.0.Use ansa.mesh.VolumesMeshV instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 18.0.0.Use ansa.mesh.TetraCFD instead.")
def TetraCFDbyID(Vol_ID: int) -> int:

	"""
	.. deprecated:: 18.0.0
		Use :py:func:`ansa.mesh.TetraCFD` instead.
	...
	warnings.warn("Deprecated since version 18.0.0.Use ansa.mesh.TetraCFD instead.", DeprecationWarning)

@typing_extensions.deprecated("Deprecated since version 19.0.0.Use ansa.mesh.VolumesMeshV instead.")
def TetraFEM(volume: base.Entity) -> int:
...
def UnmeshedVolumes(return_volumes: bool) -> int:
...
def VolumeType(volume: base.Entity) -> str:
...
def VolumesDelete(volume: base.Entity) -> int:
...
def VolumesDetect(method_option: int, return_volumes: bool, include_facets: bool, whole_db: bool) -> int | list:
...
def VolumesMap(master: list[base.Entity], slave: list[base.Entity], round: list[base.Entity], method: str, steps: int, part: str, prop: str, ret_ents: bool, light_volume_representation: bool) -> int | list:
...
def VolumesMeshV(volume: base.Entity | list[base.Entity], mesh_type: str) -> int:
	...
	Parameters
	----------
	volume : base.Entity | list[base.Entity]
...
@typing_extensions.deprecated("Deprecated since version 19.0.0.Use ansa.mesh.VolumesExtrude instead.")
def VolumesOffset(boundary_array: list[base.Entity], dist: float, steps: int, middle: int, bias: str, factor: float, part: base.Entity, property: base.Entity) -> int:

	"""
	.. deprecated:: 19.0.0
		Use :py:class:`ansa.mesh.VolumesExtrude` instead.
	...
	Parameters
	----------
	boundary_array : list[base.Entity]
	...
	warnings.warn("Deprecated since version 19.0.0.Use ansa.mesh.VolumesExtrude instead.", DeprecationWarning)

def VolumesParameters(growth_rate: float, max_length: float, criterion_type: str, criterion_val: float, geometry_checks: bool) -> int:
...
def VolumesRemesh(ENTITY: base.Entity) -> int:
...
@typing_extensions.deprecated("Deprecated since version 19.0.0.Use ansa.mesh.VolumesExtrude instead.")
def VolumesRotate(boundary_array: list[base.Entity], x: float, y: float, z: float, dx: float, dy: float, dz: float, angle: float, steps: int, bias: str, factor: float, part: base.Entity, property: base.Entity) -> int:
...
@typing_extensions.deprecated("Deprecated since version 19.0.0.Use ansa.mesh.VolumesExtrude instead.")
def VolumesTranslate(boundary_array: list[base.Entity], dx: float, dy: float, dz: float, dist: float, steps: int, bias: str, factor: float, part: str, property: int) -> int:
...
def Wrap(input_data: list[base.Entity], tolerance: float, volume_type: str, wrap_style: str, wrap_style_argument: float, separate_sets_flags: str, separate_sets_angle: float, counter_volumes: int, part_name: str, property_id: int) -> list:
...
def xyzIsInsideVolume(x: float, y: float, z: float, return_all_volumes: bool) -> int | list[base.Entity]:
...
def xyzIsInsideVolumeMatrix(points_coordinates: list[list], return_all_volumes: bool, input_vols: list[base.Entity]) -> list:
	...
	input_vols : list[base.Entity], optional
...
def NumberPerimeters(input: base.Entity | list[base.Entity], number: str, apply_multiple_number: bool, remesh_macros: bool, apply_number_of: str, use_ansa_defaults_values: bool) -> int:
	...
	Parameters
	----------
	input : base.Entity | list[base.Entity]
...
def IntersectSolidDescription(input: base.Entity | list[base.Entity], fuse_distance: float, inflate_distance: float, ignore_same_pid: bool, ignore_same_part: bool, ignore_same_set: bool, ignore_same_neighour_zones: int, keep_separation_walls: bool, create_pid_for_separation_walls: bool, improve_mesh_quality: bool, trash_treatment: str) -> int:
...
def IntersectSkinDescription(input: base.Entity | list[base.Entity] | int, fuse_distance: float, ignore_same_pid: bool, ignore_same_part: bool, ignore_same_set: bool, ignore_same_neighour_zones: int, improve_mesh_quality: bool) -> int:
...
def FillGapCoons(input: list[base.Entity], alternative: bool, improve_result_zones: int, result_set_id: int, ret_ents: bool) -> int:
...
def FillGapDraft(input: list[base.Entity], alternative: bool, improve_result_zones: int, result_set_id: int, ret_ents: bool) -> int:
...
def HexaBoxSweepGlide(extrusion_type: str, guideline_ents: list[base.Entity], box_face: base.Entity, curves: list[base.Entity], points: list[base.Entity], section_type: str, radius: float, width: float, dx: float, dy: float, dz: float, height: float, lower_base: float, upper_base: float) -> base.Entity:
...
def VoxelGeneration(shells_or_faces: list[base.Entity], voxel_len: float, allow_surface_intersection: bool, nth_largest: int, ret_ents: bool, different_properties_per_volume: bool, smooth_iterations: int, mesh_method: str, sharp_angle: float, coordinate_sys: base.Entity | str) -> int:
	...
	Parameters
	----------
	shells_or_faces : list[base.Entity]
	...
	coordinate_sys : base.Entity | str, optional
...
def RemeshShells(shells: list[base.Entity] | str, mesh_generator: str) -> list[base.Entity]:
...
def PerimetersOfMacro(faces: list[base.Entity]) -> list:
...
def FillGapFitted(input: list[base.Entity], improve_result_zones: int, result_set_id: int, ret_ents: bool) -> int:
...
def FillGapPlanar(input: list[base.Entity], improve_result_zones: int, result_set_id: int, ret_ents: bool) -> int:
...
def FillSingleBoundHoles(max_diameter: float, fill_ext_perim: bool, point_at_center: bool, connection_by: str, curve_at_perimeter: bool, reshape_zones: int, set_id: base.Entity | int=None, pid_id: base.Entity | int=None, ret_ents: bool=False, fill_method: str="draft", part: base.Entity=None, geom_fill_method: str="create_new_faces") -> int | list:
...
def FillSingleBoundConcavities(max_width: float, point_at_center: bool, curve_at_perimeter: bool, reshape_zones: int, set_id: base.Entity | int, pid_id: base.Entity | int, ret_ents: bool, part: base.Entity) -> int | list:
...
def FillSolidHoles(max_diameter: float, feat_angle: float, feat_type: str, max_distortion: float, point_at_center: bool, curve_at_perimeter: bool, reshape_zones: int, set_id: base.Entity | int, pid_id: base.Entity | int, ret_ents: bool, fill_method: str, part: base.Entity, solids_set: base.Entity, solids_pid: base.Entity, solids_part: base.Entity, geom_fill_method: str) -> int | list:
	...
	solids_set : base.Entity, optional
		Adds the new solids to a set.

	solids_pid : base.Entity, optional
		Adds the new solids to a pid.

	solids_part : base.Entity, optional
...
def FillFeatureLineHoles(max_diameter: float, feat_angle: float, feat_type: str, max_distortion: float, detach_triple_perimeters: bool, point_at_center: bool, curve_at_perimeter: bool, reshape_zones: int, set_id: base.Entity | int, pid_id: base.Entity | int, ret_ents: bool, fill_method: str, part: base.Entity, allow_intersecting_result_shells: bool) -> int | list:
...
def SuppressFeatureLines(feature_angle_limit: float, max_dist_from_prev_pos: float, shells: base.Entity | list[base.Entity]) -> int:
	...
	shells : base.Entity | list[base.Entity], optional
...
def ReduceMesh(shells: list[base.Entity] | int, reduce_percentage: float, distortion: float, maximum_length: float, maximum_aspect: float, distortion_angle: float) -> int:
...
def AssociateBoxEdgesToEdges(box_edges: Iterable[base.Entity] | base.Entity, target_edges: Iterable[base.Entity] | base.Entity, connect_to_cons: bool, remove_points: bool, box_edge_points: dict) -> int:
	...
	Parameters
	----------
	box_edges : Iterable[base.Entity] | base.Entity
		A box edge or a list of box edges to be associated with the target entities.

	target_edges : Iterable[base.Entity] | base.Entity
...
def AssociateBoxEdgesToSurfs(box_edges: Iterable[base.Entity] | base.Entity, surface_ents: Iterable[base.Entity] | base.Entity, user_projection_mode_vector: Iterable[float], remove_points: bool, box_edge_points: dict, cut_geometric_faces: bool, connect_to_cons: bool) -> int:
...
def AssociateBoxFacesToSurfs(box_faces: Iterable[base.Entity] | base.Entity, surface_ents: Iterable[base.Entity] | base.Entity, user_projection_mode_vector: Iterable[float], remove_points: bool, box_edge_points: dict) -> int:
	...
	Parameters
	----------
	box_faces : Iterable[base.Entity] | base.Entity
...
def AssociateBoxPointsToEdges(box_points: Iterable[base.Entity] | base.Entity, target_edges: Iterable[base.Entity] | base.Entity, insert_hot_point: bool=False) -> int:
	...
	Parameters
	----------
	box_points : Iterable[base.Entity] | base.Entity
...
def AssociateBoxPointsToPoints(box_points: Iterable[base.Entity] | base.Entity, target_points: Iterable[base.Entity] | base.Entity) -> int:
	...
	target_points : Iterable[base.Entity] | base.Entity
...
def AssociateBoxPointsToSurfs(box_points: Iterable[base.Entity] | base.Entity, surface_ents: Iterable[base.Entity] | base.Entity, user_projection_mode_vector: Iterable[float]) -> int:
...
def EraseBoxEdgesAssociation(box_edges: base.Entity | list[base.Entity]) -> int:
	...
	Parameters
	----------
	box_edges : base.Entity | list[base.Entity]
...
def EraseBoxFacesAssociation(box_faces: base.Entity | list[base.Entity]) -> int:
	...
	Parameters
	----------
	box_faces : base.Entity | list[base.Entity]
...
def EraseBoxPointsAssociation(box_points: base.Entity | list[base.Entity]) -> int:
	...
	Parameters
	----------
	box_points : base.Entity | list[base.Entity]
...
def ZoneCutSpecificWidth(input: base.Entity | list[base.Entity], zones_offset: list[float], radial_offset: bool=False, blended: bool=False, expand_level: int=1, smooth_zones: str="Full", proximity_distance_value: float=1.0, proximity_distance_mode: str="*last height", cut_faces_on_zones: bool=False, zones_set_id: int=None, join_obstructing_perimeters: bool=False) -> int:
...
def HexaBlockDeleteVolume(boxes: base.Entity | list[base.Entity]) -> int:
...
def HexaBlockEraseShellMesh(box_faces: base.Entity | list[base.Entity]) -> int:
...
def HexaBlockEraseVolumeMesh(boxes: base.Entity | list[base.Entity]) -> int:
...
def HexaBlockShellMesh(box_faces: base.Entity | list[base.Entity] | int, tolerance: str, project: bool, generator: str, apply_surface_fit: bool, project_non_associated: bool) -> list[base.Entity]:
	...
	Parameters
	----------
	box_faces : base.Entity | list[base.Entity] | int
...
@typing_extensions.deprecated("Deprecated since version 19.0.0.Use ansa.mesh.VolumesExtrude instead.")
def VolumesGlide(boundary_array: list[base.Entity], guideline_array: list[base.Entity], distribution: str, paste_nodes: int, paste_distance: float, steps_type: str, steps: int, element_length: float, biasing: str, factor: float, reference_point: str, part: base.Entity, property: base.Entity) -> int:
	...
	guideline_array : list[base.Entity]
...
@typing_extensions.deprecated("Deprecated since version 19.0.0.Use ansa.mesh.VolumesExtrude instead.")
def VolumesSweep(boundary_array: list[base.Entity], guideline_array: list[base.Entity], distribution: str, paste_nodes: int, paste_distance: float, steps_type: str, steps: int, element_length: float, biasing: str, factor: float, reference_point: str, part: base.Entity, property: base.Entity) -> int:
...
@typing_extensions.deprecated("Deprecated since version 19.0.0.Use ansa.mesh.VolumesExtrude instead.")
def VolumesDualSweep(boundary_array: list[base.Entity], guideline1_array: list[base.Entity], guideline2_array: list[base.Entity], distribution: str, paste_nodes: int, paste_distance: float, steps_type: str, steps: int, element_length: float, biasing: str, factor: float, reference_point: str, part: base.Entity, property: base.Entity) -> int:
	...
	guideline1_array : list[base.Entity]
		The guideline that defines the direction of the extrusion.
		Elements could be Perimeters, Edges or curves.

	guideline2_array : list[base.Entity]
...
def IsolateWashers(shells: list[base.Entity], include_filled_connection_holes: bool) -> list[base.Entity]:
...
@typing_extensions.deprecated("Deprecated since version 23.0.0.Use ansa.mesh.IsolateVisibilityGroups instead.")
def IsolateExterior(input: list[base.Entity], groups_number: int, classification: str="average", group_entities: bool=True, separate_at_blue_bounds: bool=True, separate_at_pid_bounds: bool=True, feature_angle: float=60.0, feature_type: str="convex_and_concave", view_point: str="scan_all_around") -> list:

	"""
	.. deprecated:: 23.0.0
		Use :py:func:`ansa.mesh.IsolateVisibilityGroups` instead.
	...
	warnings.warn("Deprecated since version 23.0.0.Use ansa.mesh.IsolateVisibilityGroups instead.", DeprecationWarning)

def CalculateThickness(middle_entities: list[base.Entity], skin_entities: list[base.Entity], maximum_thickness: float, keep_thickness_at_junctions: int, assign_thickness_to: str='nodes', pid_thickness_step: float=0.5, use_materials_from: str='middle') -> int:
	...
	Parameters
	----------
	middle_entities : list[base.Entity]
		A list that contains the entities that will get a new 
		calculated thickness.

	skin_entities : list[base.Entity]
...
def SplitToTetras(solids: list[base.Entity], improve: bool, ret_ents: bool=False) -> int:
...
def IntersectWeldingFE(input: list[base.Entity], thick_ratio: float, extend_distance: float, ignore_same_pid: bool, ignore_same_part: bool, ignore_same_set: bool, ignore_same_neighbour_zones: bool, improve_mesh_quality: bool, ignore_parallel_angle_tol: float) -> int:
	...
	ignore_parallel_angle_tol : float, optional
...
def IntersectFusePanels(input: base.Entity | list[base.Entity] | int, offset_distance: float, ignore_same_pid: bool, ignore_same_part: bool, ignore_same_set: bool, ignore_same_neighbour_zones: bool, improve_mesh_quality: bool, fuse_direction: str, dx: float, dy: float, dz: float, project_shells: list[base.Entity]) -> int:
	...
	project_shells : list[base.Entity], optional
...
def HexaBoxOrtho(loaded_elements: list[base.Entity], db_or_visible: str, coordinate: base.Entity, min_flag: bool, directions: list) -> base.Entity:
...
def CreateShellsOnSolidsPidSkin(solids: list[base.Entity], ret_ents: bool=False) -> int | list:
...
@typing_extensions.deprecated("Deprecated since version 20.1.0.Use ansa.mesh.VolumesExtrude instead.")
def ExtrudeOffset(source: list[base.Entity], target: list[base.Entity], rem_source: list[base.Entity], connect_source: bool, direction: str, distance: float, steps: int, first_height: float, biasing: str, factor: float, factor_dir: str, side_treatment: str, angle: float, snap_to_target: bool, connect_to_target: bool, part: base.Entity, property: base.Entity) -> int:
	...
	See Also
	--------
	ansa.mesh.ExtrudeProject, ansa.mesh.ExtrudeSweepGlide, ansa.mesh.ExtrudeDualSweep, ansa.mesh.ExtrudeMap, ansa.mesh.ExtrudeRotate, ansa.mesh.ExtrudeTranslate
	...
	warnings.warn("Deprecated since version 20.1.0.Use ansa.mesh.VolumesExtrude instead.", DeprecationWarning)

def ExtrudeProject(source: list[base.Entity], target: list[base.Entity], rem_source: list[base.Entity], connect_source: bool, steps: int, first_height: float, biasing: str, factor: float, factor_dir: str, side_treatment: str, angle: float, snap_to_target: bool, connect_to_target: bool, part: base.Entity, property: base.Entity) -> int:
	...
	See Also
	--------
	ansa.mesh.ExtrudeOffset, ansa.mesh.ExtrudeSweepGlide, ansa.mesh.ExtrudeDualSweep, ansa.mesh.ExtrudeMap, ansa.mesh.ExtrudeRotate, ansa.mesh.ExtrudeTranslate
...
@typing_extensions.deprecated("Deprecated since version 20.1.0.Use ansa.mesh.VolumesExtrude instead.")
def ExtrudeRotate(source: list[base.Entity], rotation_axis: list[list[float]], rotation_angle: float, target: list[base.Entity], rem_source: list[base.Entity], connect_source: bool, steps: int, first_height: float, biasing: str, factor: float, factor_dir: str, side_treatment: str, angle: float, snap_to_target: bool, connect_to_target: bool, part: base.Entity, property: base.Entity) -> int:
	...
	See Also
	--------
	ansa.mesh.ExtrudeProject, ansa.mesh.ExtrudeSweepGlide, ansa.mesh.ExtrudeDualSweep, ansa.mesh.ExtrudeMap, ansa.mesh.ExtrudeOffset, ansa.mesh.ExtrudeTranslate
...
@typing_extensions.deprecated("Deprecated since version 20.1.0.Use ansa.mesh.VolumesExtrude instead.")
def ExtrudeTranslate(source: list[base.Entity], translation_axis: list[list[float]], target: list[base.Entity], rem_source: list[base.Entity], connect_source: bool, distance: float, steps: int, first_height: float, biasing: str, factor: float, factor_dir: str, side_treatment: str, angle: float, snap_to_target: bool, connect_to_target: bool, part: base.Entity, property: base.Entity) -> int:
	...
	translation_axis : list[list[float]]
	...
	See Also
	--------
	ansa.mesh.ExtrudeProject, ansa.mesh.ExtrudeSweepGlide, ansa.mesh.ExtrudeDualSweep, ansa.mesh.ExtrudeMap, ansa.mesh.ExtrudeOffset, ansa.mesh.ExtrudeRotate
...
@typing_extensions.deprecated("Deprecated since version 20.1.0.Use ansa.mesh.VolumesExtrude instead.")
def ExtrudeSweepGlide(algorithm: str, source: list[base.Entity], guideline: list[base.Entity], target: list[base.Entity], rem_source: list[base.Entity], connect_source: bool, guide_distribution: bool, steps: int, first_height: float, biasing: str, factor: float, factor_dir: str, side_treatment: str, angle: float, snap_to_target: bool, connect_to_target: bool, part: base.Entity, property: base.Entity) -> int:
	...
	See Also
	--------
	ansa.mesh.ExtrudeProject, ansa.mesh.ExtrudeOffset, ansa.mesh.ExtrudeDualSweep, ansa.mesh.ExtrudeMap, ansa.mesh.ExtrudeRotate, ansa.mesh.ExtrudeTranslate
...
def ExtrudeDualSweep(source: list[base.Entity], guideline: list[base.Entity], target: list[base.Entity], rem_source: list[base.Entity], connect_source: bool, guide_distribution: bool, steps: int, first_height: float, biasing: str, factor: float, factor_dir: str, side_treatment: str, angle: float, snap_to_target: bool, connect_to_target: bool, part: base.Entity, property: base.Entity) -> int:
	...
	See Also
	--------
	ansa.mesh.ExtrudeProject, ansa.mesh.ExtrudeOffset, ansa.mesh.ExtrudeSweepGlide, ansa.mesh.ExtrudeMap, ansa.mesh.ExtrudeRotate, ansa.mesh.ExtrudeTranslate
...
def ExtrudeMap(source: list[base.Entity], guideline: list[base.Entity], target: list[base.Entity], rem_source: list[base.Entity], connect_source: bool, guide_distribution: bool, steps: int, first_height: float, biasing: str, factor: float, factor_dir: str, side_treatment: str, angle: float, snap_to_target: bool, connect_to_target: bool, part: base.Entity, property: base.Entity) -> int:
	...
	See Also
	--------
	ansa.mesh.ExtrudeProject, ansa.mesh.ExtrudeOffset, ansa.mesh.ExtrudeSweepGlide, ansa.mesh.ExtrudeDualSweep, ansa.mesh.ExtrudeRotate, ansa.mesh.ExtrudeTranslate
...
def HexaBlockInitBoxEdges(box_edges: list[base.Entity], remesh_box_faces: bool, initialize_number: bool, initialize_spacing: bool) -> int:
...
def HexaBlockVolumesMap(box_faces: list[base.Entity], boxes: object, tolerance: str, project: bool, apply_surface_fit: bool, project_non_associated: bool) -> int:
...
def Redistribute(property: base.Entity, num_layers: int, layers_dir: int, growth_rate: float, modify: str, num_layers_applied: int, create_shells: bool) -> int:
	...
	See Also
	--------
	ansa.mesh.RedistributeMulti, ansa.mesh.ChangeHeightOfLayers, ansa.mesh.ChangeHeightOfLayersMulti
...
def ChangeHeightOfLayers(property: base.Entity, increase_by: float, type: str, layers_dir: int, mod_dir: str, num_layers_applied: int) -> int:
	...
	See Also
	--------
	ansa.mesh.ChangeHeightOfLayersMulti, ansa.mesh.Redistribute, ansa.mesh.RedistributeMulti
...
def HexaBlockOrthoSmooth(box_faces: list[base.Entity], feature_lines: list[base.Entity], layers_number: int, layers_smooth_iterations: int, smooth_through_boxes: bool, smooth_base_surface_mesh: bool, smooth_iterations: int, fix_violating_solids: bool, boxes: list[base.Entity]) -> int:
	...
	feature_lines : list[base.Entity], optional
	...
	boxes : list[base.Entity], optional
...
def MatchShellsAndSolids(shells: list[base.Entity], solids: list[base.Entity]) -> list:
...
def CreateFillet(fillet_type: str, edges: list[base.Entity], chamfer_width: float, fillet_radius: float, fillet_rows: int, ret_ents: bool) -> int | list:
...
def ModifyFillet(fillet_type: str, shells: list[base.Entity], edges: list[base.Entity], chamfer_width: float, fillet_radius: float, fillet_rows: int, ret_ents: bool) -> int | list:
...
def ElementsExtrude(algorithm: str, edges: list[base.Entity], guideline1: list[base.Entity], use_edges_nodes: bool, distribution: str, ref_point: str, guideline2: list[base.Entity], paste_nodes: bool, tolerance: float, length: float, bias_type: str, bias_factor: float, point1: base.Entity, point2: base.Entity) -> int:
	...
	guideline2 : list[base.Entity], optional
...
def HexaBoxByPoints(points: list[base.Entity], solid_type: str) -> base.Entity:
...
def HexaBlockSaveAssociations(filename: str, hexa_block_entities: str, geometric_entities: str, model: str) -> int:
...
def RedistributeMulti(list: list[base.Entity], num_layers: int, layers_dir: int, growth_rate: float, modify: str, num_layers_applied: bool, create_shells: bool) -> int:
	...
	See Also
	--------
	ansa.mesh.Redistribute, ansa.mesh.ChangeHeightOfLayers, ansa.mesh.ChangeHeightOfLayersMulti
...
def ChangeHeightOfLayersMulti(list: list[base.Entity], increase_by: float, type: str, layers_dir: int, mod_dir: str, num_layers_applied: int) -> int:
	...
	See Also
	--------
	ansa.mesh.ChangeHeightOfLayers, ansa.mesh.Redistribute, ansa.mesh.RedistributeMulti
...
def Create2DEnvelopeFromShellsOnPlane(shells: list[base.Entity]) -> list[base.Entity]:
...
def SuppressNoise(shells: list[base.Entity], intensity: str='high', only_move_nodes: bool=False, movement_direction: str='both_sides') -> int:
...
def SolidsMeshV(solids: list[base.Entity], mesh_type: str) -> int:
...
def HexaBoxByCurves(height_edges: list[base.Entity], top_bottom_edges: list[base.Entity]) -> base.Entity:
	...
	See Also
	--------
	ansa.mesh.HexaBoxOrtho, ansa.mesh.HexaBoxByPoints
...
def CavityWrap(entities: list[base.Entity], leak_distance: float, target_length: float, maximum_length: float, nth_largest: int, snap_nodes: bool, features_set: base.Entity) -> int:
	...
	features_set : base.Entity, optional
...
def CavityVolumeTetra(shells: list[base.Entity], maximum_length: float, growth_rate: float, sensors_set: base.Entity) -> int:
	...
	sensors_set : base.Entity, optional
...
def CavityVolumeHexaInterior(shells: list[base.Entity], maximum_length: float, buffer_zones: int, sensors_set: base.Entity) -> int:
...
def CavityVolumeHexaDominant(shells: list[base.Entity], boundary_length: float, maximum_length: float, nth_largest: int, buffer_zones: int, sensors_set: base.Entity, features_set: base.Entity, feature_angle: float) -> int:
...
def ConstantWrap(entities: object, type: str, target_length: float, nth_largest: int, smooth_factor: float, mode: str, wrap_pid: str, shell_type: str, offset_factor: int, coordinate_system: object) -> int:
...
def IsolateSkin(type: str, leak_length: float, nth_largest: int, group_entities: bool, separate_at_blue_bounds: bool, separate_at_pid_bounds: bool, feature_angle: float, feature_type: str, mpar_file: str) -> int:
...
def HexaBlockAutoCFDSpacing(input: list[base.Entity], growth_rate: float, feature_angle: float, min_length: float, max_length: float, sharp_edges_angle_limit: float, convex_sharp_edges_length: float, convex_sharp_edges_length_mode: str, concave_sharp_edges_length: float, concave_sharp_edges_length_mode: str) -> None:
...
def PointCloudMesh(points: list[base.Entity], algorithm: str) -> list[base.Entity]:
...
def CreateTransitionZones(boxes: list[base.Entity], box_faces: list[base.Entity], direction: str, element_ratio: dict) -> None:
	...
	See Also
	--------
	ansa.mesh.RemoveTransitionZones, ansa.mesh.ModifyTransitionZones
...
def ModifyTransitionZones(element_ratio: dict) -> None:
	...
	See Also
	--------
	ansa.mesh.CreateTransitionZones, ansa.mesh.RemoveTransitionZones
...
def RemoveTransitionZones(box_faces: list[base.Entity]) -> None:
	...
	See Also
	--------
	ansa.mesh.CreateTransitionZones, ansa.mesh.ModifyTransitionZones
...
def CheckSkin(skin: Iterable[base.Entity], solid_description: Iterable[base.Entity], distance: float, create_points: bool=False) -> list:
...
def CheckMiddleSurface(middle_surface: Iterable[base.Entity], solid_description: Iterable[base.Entity], middle_deviation_value: float=0.05, middle_deviation_type: str='thickness_percentage', bounds_deviation_value: float=0.05, bounds_deviation_type: str='thickness_percentage', thickness_deviation_value: float=0.05, thickness_deviation_type: str='thickness_percentage', check_missing_middle: bool=True, exclude_near_junctions: bool=True, l_junction_angle: float=60.0) -> object:
	...
	Parameters
	----------
	middle_surface : Iterable[base.Entity]
...
def SolidSmooth(solids: list[base.Entity], freeze_skin: bool=True) -> int:
...
def OrientVolume(volume: base.Entity) -> int:
...
def SplitQuads(entities: list[base.Entity] | str, method: str="oriented_hybrid") -> int:
...
def BatchGenerator(entities: Iterable[base.Entity]) -> int:
...
def ApplyOctreeFilters(octree: base.Entity) -> bool:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.RunOctree, ansa.mesh.CheckOctreeLeaks, ansa.mesh.AddPartsToOctreeArea, ansa.mesh.AddFilterToOctreeArea, ansa.mesh.GetNewOctreeArea, ansa.mesh.GetPartsFromOctreeArea, ansa.mesh.GetAreasFromOctree, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams
...
def RunOctree(octree: base.Entity) -> bool:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.ApplyOctreeFilters, ansa.mesh.CheckOctreeLeaks, ansa.mesh.AddPartsToOctreeArea, ansa.mesh.AddFilterToOctreeArea, ansa.mesh.GetNewOctreeArea, ansa.mesh.GetPartsFromOctreeArea, ansa.mesh.GetAreasFromOctree, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams
...
def ApplyAutoAssociation(distance: float, box_points: Iterable, box_edges: Iterable, box_faces: Iterable, work_on_visible: bool=False, cut_geometric_faces: bool=False, connect_to_cons: bool=False, insert_hot_points: bool=False) -> int:
	...
	box_points : Iterable, optional
		The box points to associate.

	box_edges : Iterable, optional
		The box edges to associate.

	box_faces : Iterable, optional
...
def ProjectShellsOnShells(source: base.Entity | list[base.Entity] | str, target: base.Entity | list[base.Entity] | str, projection_tolerance: float, maximum_projections_number: int, user_projection_mode_vector: list[float], number_of_shell_zones_affected: int, move_projection_to_nearest_perimeter: float, move_to_projected_shells: float, paste_projected_and_result_shells: int, add_results_to_set: str, join_perimeters_mode: int, cut_faces_on_boundary: bool, open_closed_perimeter_hole: bool, freeze_non_single_boundary: bool) -> int:
	...
	Parameters
	----------
	source : base.Entity | list[base.Entity] | str
	...
	target : base.Entity | list[base.Entity] | str
...
def ProjectPointsOnShells(shells: base.Entity | list[base.Entity] | str, points: base.Entity | list[base.Entity], projection_tolerance: float, maximum_projections_number: int, user_projection_mode_vector: list[base.Entity], number_of_shell_zones_affected: int, move_projection_to_nearest_perimeter: float, move_to_projected_points: float, paste_projected_and_result_points: int, add_results_to_set: str, mark_result_macro_grids: bool) -> int:
	...
	Parameters
	----------
	shells : base.Entity | list[base.Entity] | str
	...
	points : base.Entity | list[base.Entity]
	...
	user_projection_mode_vector : list[base.Entity], optional
...
def HexaBlockSmooth(boxes: list[base.Entity], feature_lines: list[base.Entity], smooth_iterations: int, fix_violating_solids: bool) -> int:
...
def CheckOctreeLeaks(octree: base.Entity) -> bool:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.RunOctree, ansa.mesh.ApplyOctreeFilters, ansa.mesh.AddPartsToOctreeArea, ansa.mesh.AddFilterToOctreeArea, ansa.mesh.GetNewOctreeArea, ansa.mesh.GetPartsFromOctreeArea, ansa.mesh.GetAreasFromOctree, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams
...
def ConvertToLightVolumeRepresentation(volumes: list[base.Entity]) -> int:
	...
	Parameters
	----------
	volumes : list[base.Entity], optional
...
def RotatingInterface(rotating_entities: object, static_entities: object, offset: float, start_x: float, start_y: float, start_z: float, end_x: float, end_y: float, end_z: float, offset_type: str, minimum_offset: float, vertical_intersection_entities: object, vertical_intersection_points: object, fill_concavities: bool, auto_axis_calc: bool, planar_external_direction: object, relaxation_angle_limit: float) -> object:
...
def Create4SidedMesh(entities: list, only_4sided: bool, only_aligned: bool, corner_angle: float, smooth_type: str, split_method: str, spacing: str, elem_type: str, quad_pattern: str) -> object:
...
def CreateCircularMesh(entities: object, only_circular: bool, only_even: bool, radius_tol: bool, pattern: str, zones: int, layers: int, first_height: float, growth_factor: float, max_aspect: float) -> object:
...
def VolumesCheckDefinition(volume: base.Entity) -> int:
...
def AddFilterToOctreeArea(field: str, expression: str, value: str, area: object, match: str, case_sensitive: str, filter_name: str) -> int:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.RunOctree, ansa.mesh.ApplyOctreeFilters, ansa.mesh.CheckOctreeLeaks, ansa.mesh.AddPartsToOctreeArea, ansa.mesh.GetNewOctreeArea, ansa.mesh.GetPartsFromOctreeArea, ansa.mesh.GetAreasFromOctree, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams
...
def AddPartsToOctreeArea(entities: object, area: object) -> int:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.RunOctree, ansa.mesh.ApplyOctreeFilters, ansa.mesh.CheckOctreeLeaks, ansa.mesh.AddFilterToOctreeArea, ansa.mesh.GetNewOctreeArea, ansa.mesh.GetPartsFromOctreeArea, ansa.mesh.GetAreasFromOctree, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams
...
def GetNewOctreeArea(parent_octree: object, name: str, min_len: float, max_len: float, max_vol_len: float, part_pid_proximity: bool, self_proximity: bool, curvature_min_len: float) -> object:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.RunOctree, ansa.mesh.ApplyOctreeFilters, ansa.mesh.CheckOctreeLeaks, ansa.mesh.AddPartsToOctreeArea, ansa.mesh.AddFilterToOctreeArea, ansa.mesh.GetPartsFromOctreeArea, ansa.mesh.GetAreasFromOctree, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams
...
def GetPartsFromOctreeArea(area: object) -> object:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.RunOctree, ansa.mesh.ApplyOctreeFilters, ansa.mesh.CheckOctreeLeaks, ansa.mesh.AddFilterToOctreeArea, ansa.mesh.GetNewOctreeArea, ansa.mesh.AddPartsToOctreeArea, ansa.mesh.GetAreasFromOctree, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams
...
def GetAreasFromOctree(octree: object) -> object:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.RunOctree, ansa.mesh.ApplyOctreeFilters, ansa.mesh.CheckOctreeLeaks, ansa.mesh.AddFilterToOctreeArea, ansa.mesh.GetNewOctreeArea, ansa.mesh.AddPartsToOctreeArea, ansa.mesh.GetPartsFromOctreeArea, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams
...
def ReadOctreeAreaParams(area: object, mpar_file: str) -> int:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.RunOctree, ansa.mesh.ApplyOctreeFilters, ansa.mesh.CheckOctreeLeaks, ansa.mesh.AddFilterToOctreeArea, ansa.mesh.GetNewOctreeArea, ansa.mesh.AddPartsToOctreeArea, ansa.mesh.GetPartsFromOctreeArea, ansa.mesh.GetAreasFromOctree, ansa.mesh.SaveOctreeAreaParams
...
def SaveOctreeAreaParams(area: base.Entity, mpar_file: str) -> None:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.RunOctree, ansa.mesh.ApplyOctreeFilters, ansa.mesh.CheckOctreeLeaks, ansa.mesh.AddFilterToOctreeArea, ansa.mesh.GetNewOctreeArea, ansa.mesh.AddPartsToOctreeArea, ansa.mesh.GetPartsFromOctreeArea, ansa.mesh.GetAreasFromOctree, ansa.mesh.ReadOctreeAreaParams
...
def HexaBlockSetIjk(box: base.Entity, origin_hb_pnt: base.Entity, i_hb_pnt: base.Entity) -> bool:
	...
	See Also
	--------
	ansa.mesh.HexaBlockAlignIjk, ansa.mesh.HexaBlockResetIjk
...
def HexaBlockAlignIjk(guide_box: list[base.Entity], boxes_to_align: list[base.Entity]) -> bool:
	...
	Parameters
	----------
	guide_box : list[base.Entity]
		Sets the guide box that the rest of the boxes will be 
		aligned with.

	boxes_to_align : list[base.Entity]
	...
	See Also
	--------
	ansa.mesh.HexaBlockSetIjk, ansa.mesh.HexaBlockResetIjk
...
def HexaBlockResetIjk(boxes: list[base.Entity]) -> None:
	...
	See Also
	--------
	ansa.mesh.HexaBlockSetIjk, ansa.mesh.HexaBlockAlignIjk
...
def LeakTool(mpar_file: str, sampling_length: float, group_leaks: bool, close_leaks: bool, chosen_properties: list[base.Entity], seed_points: list[base.Entity], leak_points: list[base.Entity], seal_and_wrap_inner_volumes: bool, accuracy: str) -> bool:
	...
	chosen_properties : list[base.Entity], optional
		An array of sets of properties where leaks are biased to be identified and closed.

	seed_points : list[base.Entity], optional
		A list of ANSA entities.
		These entities must be points.

	leak_points : list[base.Entity], optional
		A list of ANSA entities.
		These entities must be points.
...
def AddContentsToSizeFieldRule(entities: object, rule: object) -> bool:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.CopySizeFieldRules, ansa.mesh.MoveSizeFieldRules, ansa.mesh.MergeSizeFields, ansa.mesh.ApplySizeFieldFilters
...
def GetContentsFromSizeFieldRule(rule: base.Entity) -> list[base.Entity]:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.CopySizeFieldRules, ansa.mesh.MoveSizeFieldRules, ansa.mesh.MergeSizeFields, ansa.mesh.ApplySizeFieldFilters
...
def SaveSizeFieldRuleParams(rule: base.Entity, mpar_file: str) -> None:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.CopySizeFieldRules, ansa.mesh.MoveSizeFieldRules, ansa.mesh.MergeSizeFields, ansa.mesh.ApplySizeFieldFilters
...
def ReadSizeFieldRuleParams(rule: object, mpar_file: str) -> bool:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.CopySizeFieldRules, ansa.mesh.MoveSizeFieldRules, ansa.mesh.MergeSizeFields, ansa.mesh.ApplySizeFieldFilters
...
def AddFilterToSizeFieldRule(field: str, expression: str, value: str, rule: object, match: str, case_sensitive: str, filter_name: str) -> int:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.CopySizeFieldRules, ansa.mesh.MoveSizeFieldRules, ansa.mesh.MergeSizeFields, ansa.mesh.ApplySizeFieldFilters
...
def GetRulesFromSizeField(size_field: base.Entity) -> list[base.Entity]:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.CopySizeFieldRules, ansa.mesh.MoveSizeFieldRules, ansa.mesh.MergeSizeFields, ansa.mesh.ApplySizeFieldFilters
...
def BuildSizeField(size_field: base.Entity) -> bool:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.CopySizeFieldRules, ansa.mesh.MoveSizeFieldRules, ansa.mesh.MergeSizeFields, ansa.mesh.ApplySizeFieldFilters
...
def GetNewSizeFieldClosedSurfaceRule(size_field: object, name: str, max_surf_len: float, max_vol_len: float):
...
def GetNewSizeFieldSurfaceOffsetRule(size_field: object, name: str, max_surf_len: float, max_vol_len: float, offset: float):
...
def GetNewSizeFieldCylinderRule(size_field: object, name: str, max_surf_len: float, max_vol_len: float, radius: float):
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.CopySizeFieldRules, ansa.mesh.MoveSizeFieldRules, ansa.mesh.MergeSizeFields, ansa.mesh.ApplySizeFieldFilters
...
def GetNewSizeFieldSphereRule(size_field: object, name: str, max_surf_len: float, max_vol_len: float, radius: float):
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.ApplySizeFieldFilters
...
def GetNewSizeFieldSizeBoxRule(size_field: base.Entity, name: str, max_surf_len: float, max_vol_len: float, variable_size: bool) -> base.Entity | None:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.CopySizeFieldRules, ansa.mesh.MoveSizeFieldRules, ansa.mesh.MergeSizeFields, ansa.mesh.ApplySizeFieldFilters
...
def SetSizeFieldRuleActive(rule: base.Entity, active: bool) -> None:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.ApplySizeFieldFilters
...
def SmoothShells(shells: list[base.Entity]) -> int:
...
def CloseOctreeLeaks(octree: base.Entity, chosen_properties: Iterable[base.Entity]) -> bool:
	...
	chosen_properties : Iterable[base.Entity], optional
...
def Outline(dir_x: float, dir_y: float, dir_z: float, outline_internal_detected_voids: bool) -> object:
...
def GetFEPerimeterShells(fe_perimeters: list[base.Entity], expand_to_macro: bool=False) -> list:
	...
	Parameters
	----------
	fe_perimeters : list[base.Entity]
...
def BuildAdaptivityField(adaptivity_field: base.Entity) -> bool:
	...
	See Also
	--------
	ansa.mesh.CreateNewAdaptivityField, ansa.mesh.SetAdaptivityFieldActive, ansa.mesh.IsAdaptivityFieldActive, ansa.mesh.SetAdaptivityFieldCsvPath
...
def CreateNewAdaptivityField(name: str, scale_factor: float, min_length: float, max_length: float, symmetry_mirror: bool) -> object:
	...
	See Also
	--------
	ansa.mesh.BuildAdaptivityField, ansa.mesh.SetAdaptivityFieldActive, ansa.mesh.IsAdaptivityFieldActive, ansa.mesh.SetAdaptivityFieldCsvPath
...
def SetAdaptivityFieldCsvPath(adaptivity_field: object, csv_file_path: str):
	...
	See Also
	--------
	ansa.mesh.CreateNewAdaptivityField, ansa.mesh.BuildAdaptivityField, ansa.mesh.SetAdaptivityFieldActive, ansa.mesh.IsAdaptivityFieldActive
...
def SetAdaptivityFieldActive(adaptivity_field: object, active: bool):
	...
	See Also
	--------
	ansa.mesh.CreateNewAdaptivityField, ansa.mesh.BuildAdaptivityField, ansa.mesh.IsAdaptivityFieldActive, ansa.mesh.SetAdaptivityFieldCsvPath
...
def IsAdaptivityFieldActive(adaptivity_field: object) -> bool:
	...
	See Also
	--------
	ansa.mesh.CreateNewAdaptivityField, ansa.mesh.BuildAdaptivityField, ansa.mesh.SetAdaptivityFieldActive, ansa.mesh.SetAdaptivityFieldCsvPath
...
def CopySizeFieldRules(rules: object, size_field: object) -> bool:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.MoveSizeFieldRules, ansa.mesh.MergeSizeFields
...
def MoveSizeFieldRules(rules: object, size_field: object) -> bool:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.CopySizeFieldRules, ansa.mesh.MergeSizeFields
...
def MergeSizeFields(size_fields: object) -> object:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.CopySizeFieldRules, ansa.mesh.MoveSizeFieldRules
...
def SmoothHexaField(hexas: list[base.Entity], smooth_iterations: int) -> bool:
...
def FillGapBridge(input: list[base.Entity], improve_result_zones: int, result_set: base.Entity, ret_ents: bool) -> int:
	...
	result_set : base.Entity, optional
...
def ApplySizeFieldFilters(size_field: base.Entity) -> bool:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.CopySizeFieldRules, ansa.mesh.MoveSizeFieldRules, ansa.mesh.MergeSizeFields
...
def CheckMiddleMesh(shells: Iterable[base.Entity], faces: Iterable[base.Entity], options: dict[str,str], check_for_unconnected: bool=True, return_ents: bool=True, min_nodal_thick: float=0.0) -> dict | list | None:
...
def HexaSphere(sphere_center: list[float], sphere_radius: float, number_of_perimeter_elements: int, light_volume_representation: bool, create_skin_shells: bool, part: base.Entity, solids_property: base.Entity, shells_property: base.Entity) -> bool:
...
def MapBlock(macros: list[base.Entity]) -> list:
	...
	Parameters
	----------
	macros : list[base.Entity], optional
...
def GetMiddleMeshQualityScore(shells: list[base.Entity], faces: list[base.Entity], tol_dict: dict=None) -> dict:
...
def SolidBuilder(base_elems: list[base.Entity], auto_build: bool, inverted_dir: bool, extrude_method: str, new_solid_height: float, snap_angle: float, create_new_nodes: bool, part: base.Entity, prop: base.Entity) -> list[base.Entity]:
...
def SplitToTrias(entities: base.Entity | list[base.Entity] | str, quad_method: str="oriented_hybrid") -> int:
	...
	Parameters
	----------
	entities : base.Entity | list[base.Entity] | str
		Accepted values: A list of shells and/or solid facets, "all", "visible", 0.
		If set to 0 or "all", runs for all shells of the database.
		If set to "visible," runs for visible shells.
...
def ExternalDetection(input_pids: list[base.Entity], forced_internal_pids_sets: base.Entity, forced_external_pids_sets: base.Entity, bottom_cameras_angle: float, bottom_cameras_upper_visibility_plane: str, external_mark_limit: float, overlaping_distance: float, merge_area_limit: float, merge_elements_limit: int, merge_mark_limit: float, create_scan_results: bool) -> None:
	...
	bottom_cameras_upper_visibility_plane : str, optional
...
def ReadOctreeScenarioQualityCriteria(scenario: base.Entity, qual_criteria_file: str) -> int:
	...
	See Also
	--------
	ansa.mesh.SaveOctreeScenarioQualityCriteria, ansa.mesh.GetOctreeScenarioQualityCriteriaName, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams
...
def SaveOctreeScenarioQualityCriteria(scenario: base.Entity, qual_criteria_file: str) -> int:
	...
	See Also
	--------
	ansa.mesh.ReadOctreeScenarioQualityCriteria, ansa.mesh.GetOctreeScenarioQualityCriteriaName, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams
...
def GetOctreeScenarioQualityCriteriaName(scenario: base.Entity) -> str:
	...
	See Also
	--------
	ansa.mesh.SaveOctreeScenarioQualityCriteria, ansa.mesh.ReadOctreeScenarioQualityCriteria, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams
...
def GetNewSizeFieldSurfaceSectionRule(size_field: object, name: str, dir_dx: float, dir_dy: float, dir_dz: float, start_x: float, start_y: float, start_z: float, start_surf_len: float, end_x: float, end_y: float, end_z: float, end_surf_len: float):
...
def BuildOctree(octree: base.Entity) -> bool:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.ApplyOctreeFilters, ansa.mesh.CheckOctreeLeaks, ansa.mesh.AddPartsToOctreeArea, ansa.mesh.AddFilterToOctreeArea, ansa.mesh.GetNewOctreeArea, ansa.mesh.GetPartsFromOctreeArea, ansa.mesh.GetAreasFromOctree, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams, ansa.mesh.RunOctree, ansa.mesh.VisualizeOctree, ansa.mesh.ControlOctreeVisualization
...
def VisualizeOctree(octree: base.Entity) -> bool:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.ApplyOctreeFilters, ansa.mesh.CheckOctreeLeaks, ansa.mesh.AddPartsToOctreeArea, ansa.mesh.AddFilterToOctreeArea, ansa.mesh.GetNewOctreeArea, ansa.mesh.GetPartsFromOctreeArea, ansa.mesh.GetAreasFromOctree, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams, ansa.mesh.BuildOctree, ansa.mesh.RunOctree, ansa.mesh.ResetOctreeVisualizationCropArea, ansa.mesh.ControlOctreeVisualization
...
def ControlOctreeVisualization(octree: base.Entity, x_cut_plane: bool, x_direction: str, x_value: float, y_cut_plane: bool, y_direction: str, y_value: float, z_cut_plane: bool, z_direction: str, z_value: float, structure_cut_plane: bool, structure_cut_plane_distance: float, crop_x_min: float, crop_y_min: float, crop_z_min: float, crop_x_max: float, crop_y_max: float, crop_z_max: float, show_only_skin: bool, size_plot: bool, size_plot_type: str) -> bool:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.ApplyOctreeFilters, ansa.mesh.CheckOctreeLeaks, ansa.mesh.AddPartsToOctreeArea, ansa.mesh.AddFilterToOctreeArea, ansa.mesh.GetNewOctreeArea, ansa.mesh.GetPartsFromOctreeArea, ansa.mesh.GetAreasFromOctree, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams, ansa.mesh.BuildOctree, ansa.mesh.VisualizeOctree, ansa.mesh.ResetOctreeVisualizationCropArea, ansa.mesh.RunOctree
...
def ResetOctreeVisualizationCropArea(octree: base.Entity) -> bool:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.ApplyOctreeFilters, ansa.mesh.CheckOctreeLeaks, ansa.mesh.AddPartsToOctreeArea, ansa.mesh.AddFilterToOctreeArea, ansa.mesh.GetNewOctreeArea, ansa.mesh.GetPartsFromOctreeArea, ansa.mesh.GetAreasFromOctree, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams, ansa.mesh.BuildOctree, ansa.mesh.RunOctree, ansa.mesh.ControlOctreeVisualization, ansa.mesh.VisualizeOctree
...
def CalculateSurfaceSectionRuleParamsFromDirection(rule: base.Entity, calc_points: bool=True, calc_lenghts: bool=True, chordal_fraction: float=0.01) -> None:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.BuildSizeField, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.ApplySizeFieldFilters, ansa.mesh.SetSizeFieldRuleActive
...
def IsolateVisibilityGroups(input: list[base.Entity], groups_number: int, external_visibility_limit: float, classification: str="average", view_point: str="scan_all_around", connectivity_groups_by: str="Entity", forced_internal_sets: list[base.Entity]=[], forced_external_sets: list[base.Entity]=[], overlapping_distance: float=0.0, merge_area_limit: float=0.0, merge_elements_limit: float=30.0, group_by_feature_lines: bool=False, feature_angle: float=60.0, feature_type: str="convex_and_concave") -> list:
	...
	forced_internal_sets : list[base.Entity], optional
		Sets with entities or properties that are known a priori to be absolutely interior.

	forced_external_sets : list[base.Entity], optional
...
def HexaBlock2DBoxCreate(type: str, entities: list[base.Entity], delete_original: bool=False, paste: bool=False) -> base.Entity | list[base.Entity]:
...
class VolumesExtrude():
	...
	def offset(self, source: Iterable[base.Entity], target: Iterable[base.Entity], side: Iterable[base.Entity], source_remove: Iterable[base.Entity], disconnect_from_source: bool, stitch_sources: bool, connect_target: bool, collapse_free_edges: bool, direction: str, biasing: str, factor: float, biasing_direction: str, steps: int, element_length: float, distance: float, part: base.Entity, property: base.Entity, last_layer_facets_set_name: str) -> int:
		...
		Parameters
		----------
		source : Iterable[base.Entity]
			list of ansa entities

		target : Iterable[base.Entity], optional
			list of ansa entities

		side : Iterable[base.Entity], optional
			list of ansa entities

		source_remove : Iterable[base.Entity], optional
			list of ansa entities
	...
	def translate(self, source: Iterable[base.Entity], target: Iterable[base.Entity], side: Iterable[base.Entity], source_remove: Iterable[base.Entity], disconnect_from_source: bool, stitch_sources: bool, connect_target: bool, collapse_free_edges: bool, axis: tuple, biasing: str, factor: float, biasing_direction: str, steps: int, element_length: float, distance: float, part: base.Entity, property: base.Entity, last_layer_facets_set_name: str) -> int:
	...
	def revolute(self, source: Iterable[base.Entity], target: Iterable[base.Entity], side: Iterable[base.Entity], source_remove: Iterable[base.Entity], disconnect_from_source: bool, stitch_sources: bool, connect_target: bool, collapse_free_edges: bool, axis: tuple, biasing: str, factor: float, biasing_direction: str, steps: int, element_length: float, angle: float, part: base.Entity, property: base.Entity, last_layer_facets_set_name: str) -> int:
	...
	def project(self, source: Iterable[base.Entity], target: Iterable[base.Entity], side: Iterable[base.Entity], source_remove: Iterable[base.Entity], disconnect_from_source: bool, stitch_sources: bool, connect_target: bool, collapse_free_edges: bool, biasing: str, factor: float, biasing_direction: str, steps: int, element_length: float, part: base.Entity, property: base.Entity, last_layer_facets_set_name: str) -> int:
	...
	def sweep(self, source: Iterable[base.Entity], guideline: Iterable[base.Entity], match_guideline: bool) -> int:
		...
		guideline : Iterable[base.Entity]
			list of ansa entities
	...
	def glide(self, source: Iterable[base.Entity], guideline: Iterable[base.Entity], match_guideline: bool) -> int:
	...
	def dual_sweep(self, source: Iterable[base.Entity], guideline1: Iterable[base.Entity], guideline2: Iterable[base.Entity], match_guideline1: bool, match_guideline2: bool) -> int:
		...
		guideline1 : Iterable[base.Entity]
			list of ansa entities

		guideline2 : Iterable[base.Entity]
			list of ansa entities
	...
	def map(self, source: Iterable[base.Entity], guidelines: Iterable[base.Entity], match_guidelines: list) -> int:
		...
		guidelines : Iterable[base.Entity]
			list of guidelines

		match_guidelines : list, optional
...
class HexaBlockShellsSmooth:
	...
	@classmethod
	def __init__(cls, box_faces: object) -> None:
...
def Mesh(entities: base.Entity | list[base.Entity] | str) -> int:
...
def Reset(entities: base.Entity | list[base.Entity] | str) -> int:
...
class HexaBlockSolidsSmooth:
	...
	def __init__(self, boxes: Iterable[base.Entity]) -> None:
	...
	def run(self, iterations: int, relaxation: float, project_on_db: bool) -> HexaBlockSolidsSmooth:
	...
	def accept(self) -> HexaBlockSolidsSmooth:
	...
	def auto_detect_feature_lines(self, feature_line_angle: float) -> HexaBlockSolidsSmooth:
	...
	def clear_all_feature_lines(self) -> HexaBlockSolidsSmooth:
	...
	def remove_feature_lines(self, box_edges: Iterable[base.Entity]) -> HexaBlockSolidsSmooth:
	...
	def add_feature_lines(self, box_edges: Iterable[base.Entity]) -> HexaBlockSolidsSmooth:
	...
	def finalize_feature_line_selection(self) -> HexaBlockSolidsSmooth:
	...
	def set_boundary_condition(self, face: base.Entity, boundary_type: str) -> HexaBlockSolidsSmooth:
	...
	def get_boundary_condition(self, face: base.Entity) -> tuple:
...
def HexaBlockVolumeMesh(boxes: list[base.Entity], tolerance: float, project: bool, ret_ents: bool, tolerance_expr: str, apply_surface_fit: bool, project_non_associated: bool) -> int | list:
	...
	See Also
	--------
	ansa.mesh.HexaBlockVolumes, ansa.mesh.HexaBlockVolumesMap, ansa.mesh.HexaBlockShellMesh
...
def RotatingInterfaceGeneric(rotating_entities: object, offset: float, auto_axis_calc: bool, start_x: float, start_y: float, start_z: float, end_x: float, end_y: float, end_z: float) -> object:
...
def DraftSkinSizeFieldRule(sf_rule: base.Entity) -> list[base.Entity]:
...
def ElevateOrder(deck: int, entities: Iterable[base.Entity] | str, order: int, variation: str) -> int:
	...
	entities : Iterable[base.Entity] | str
...
def SetSizeFieldSizeBoxRulePointLength(rule: base.Entity, size_box_point: base.Entity, length: float) -> int:
	...
	See Also
	--------
	ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.BuildSizeField
...
@typing_extensions.deprecated("Deprecated since version 24.1.0.Use ansa.mesh.ReadSizeFieldRuleParams instead.")
def AddControlPointToSizeFieldSizeCurveRule(rule: base.Entity, curve: base.Entity, u: float, radius_1: float, length_1: float, radius_2: float, length_2: float) -> int:

	"""
	.. deprecated:: 24.1.0
		Use :py:func:`ansa.mesh.ReadSizeFieldRuleParams` instead.
	...
	See Also
	--------
	ansa.mesh.GetNewSizeFieldSizeCurveRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.BuildSizeField
	...
	warnings.warn("Deprecated since version 24.1.0.Use ansa.mesh.ReadSizeFieldRuleParams instead.", DeprecationWarning)

def GetNewSizeFieldSizeCurveRule(size_field: base.Entity, name: str) -> base.Entity:
	...
	See Also
	--------
	ansa.mesh.AddControlPointToSizeFieldSizeCurveRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.BuildSizeField, ansa.base.CreateEntity, ansa.mesh.AddFilterToSizeFieldRule, ansa.mesh.GetNewSizeFieldClosedSurfaceRule, ansa.mesh.GetNewSizeFieldSurfaceOffsetRule, ansa.mesh.GetNewSizeFieldCylinderRule, ansa.mesh.GetNewSizeFieldSphereRule, ansa.mesh.GetNewSizeFieldSizeBoxRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSizeFieldRuleActive, ansa.mesh.IsSizeFieldRuleActive, ansa.mesh.CopySizeFieldRules, ansa.mesh.MoveSizeFieldRules, ansa.mesh.MergeSizeFields, ansa.mesh.ApplySizeFieldFilters
...
def scaleDistributionOfBoxEdges(box_edges: Iterable[base.Entity], scale_factor: float) -> int:

	"""

	A function to scale the number of points on the box edges giving input parameters
...
def CreateTubularBoxes(faces: base.Entity, caps: base.Entity, spin_angle: float=0.0, fit_to_geometry: bool=True) -> bool:
	...
	spin_angle : float, optional
		The spin angle of the box.

	fit_to_geometry : bool, optional
...
def CreateExtrudedBoxes(faces: Iterable[base.Entity], operation: str, vector: Iterable[float], origin: Iterable[float]=[0,0,0], distance: float=0.1, angle: float=10.0, steps: int=1) -> list[base.Entity]:
...
def GetNewSurfaceSizeFieldSizeCurveRule(name: str, constant_size: bool=True) -> base.Entity:
	...
	See Also
	--------
	ansa.mesh.GetSurfaceSizeField, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSurfaceSizeFieldRuleAffectWholeModelActive, ansa.mesh.IsSurfaceSizeFieldRuleAffectWholeModelActive, ansa.mesh.CopySizeFieldRules
...
def SetSurfaceSizeFieldRuleAffectWholeModelActive(rule: object, active: bool) -> None:
	...
	See Also
	--------
	ansa.mesh.GetSurfaceSizeField, ansa.mesh.IsSurfaceSizeFieldRuleAffectWholeModelActive, ansa.mesh.GetNewSurfaceSizeFieldSizeCurveRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.IsSurfaceSizeFieldRuleAffectWholeModelActive, ansa.mesh.CopySizeFieldRules
...
def IsSurfaceSizeFieldRuleAffectWholeModelActive(rule: object) -> bool:
	...
	See Also
	--------
	ansa.mesh.GetSurfaceSizeField, ansa.mesh.SetSurfaceSizeFieldRuleAffectWholeModelActive, ansa.mesh.GetNewSurfaceSizeFieldSizeCurveRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSurfaceSizeFieldRuleAffectWholeModelActive, ansa.mesh.CopySizeFieldRules
...
def GetSurfaceSizeField() -> base.Entity:
	...
	See Also
	--------
	ansa.mesh.IsSurfaceSizeFieldRuleAffectWholeModelActive, ansa.mesh.SetSurfaceSizeFieldRuleAffectWholeModelActive, ansa.mesh.GetNewSurfaceSizeFieldSizeCurveRule, ansa.mesh.AddContentsToSizeFieldRule, ansa.mesh.GetRulesFromSizeField, ansa.mesh.GetContentsFromSizeFieldRule, ansa.mesh.ReadSizeFieldRuleParams, ansa.mesh.SaveSizeFieldRuleParams, ansa.mesh.SetSurfaceSizeFieldRuleAffectWholeModelActive, ansa.mesh.IsSurfaceSizeFieldRuleAffectWholeModelActive, ansa.mesh.CopySizeFieldRules
...
class HexaBlock2Dto3D:
	...
	@classmethod
	def set_extrude_parameters(cls, operation: str, vector: list=[0, 0, 1], origin: list=[1, 0, 0], distance: float=0.1, angle: float=10.0, steps: int=1) -> object:
	...
	@classmethod
	def set_distribution_parameters(cls, biasing: str, steps: int, start_factor: float=1.1, d_start: float=0.01, end_factor: float=1.1, d_end: float=0.01) -> object:
...
def OctreeSeedPoints(octree: base.Entity, x_seed_point: float, y_seed_point: float, z_seed_point: float, property: str, max_volume_len: float) -> None:
...
def OctreeDraftSkin(octree: base.Entity) -> bool:
...
def CreateSTLBMScenarioFromOctree(octree: base.Entity) -> base.Entity:
	...
	See Also
	--------
	ansa.base.CreateEntity, ansa.mesh.ApplyOctreeFilters, ansa.mesh.CheckOctreeLeaks, ansa.mesh.AddPartsToOctreeArea, ansa.mesh.AddFilterToOctreeArea, ansa.mesh.GetNewOctreeArea, ansa.mesh.GetPartsFromOctreeArea, ansa.mesh.GetAreasFromOctree, ansa.mesh.ReadOctreeAreaParams, ansa.mesh.SaveOctreeAreaParams, ansa.mesh.BuildOctree, ansa.mesh.RunOctree, ansa.mesh.ResetOctreeVisualizationCropArea, ansa.mesh.ControlOctreeVisualization, ansa.mesh.VisualizeOctree
