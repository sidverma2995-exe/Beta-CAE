...
class process:
	def getDefinitionWorkflows() -> list[WorkflowDefinition]:
		...
		See Also
		--------
		ansa.spdrm.process.WorkflowDefinition
	...
	def instantiateWorkflow(workflow_handle_id: int, input_slot_values: dict, input_dir: str) -> int:
		...
		See Also
		--------
		ansa.spdrm.process.getDefinitionWorkflows, ansa.spdrm.process.abortWorkflow
	...
	def getStateOfWorkflow(workflow_id: int) -> list:
		...
		See Also
		--------
		ansa.spdrm.process.WorkflowStatus
	...
	def updateNodeProgress(node_id: int, node_progress: float, user_data: dict, dir: str) -> int:
		...
		See Also
		--------
		ansa.spdrm.process.getStateOfWorkflow
	...
	def abortWorkflow(workflow_id: int) -> int:
		...
		See Also
		--------
		ansa.spdrm.process.instantiateWorkflow, ansa.spdrm.process.getStateOfWorkflow
	...
	def getWorkflowFiles(workflow_id: int) -> list:
		...
		See Also
		--------
		ansa.spdrm.process.FilesRecord
	...
	def getRoot() -> str:
		...
		See Also
		--------
		ansa.spdrm.process.setRoot, ansa.spdrm.process.removeRoot
	...
	def setRoot(url: str, username: str, password: str, role: str, ticket: str) -> int:
		...
		* Do not provide anything and search if there is an already stored ticket
		...
		See Also
		--------
		ansa.spdrm.process.getRoot, ansa.spdrm.process.removeRoot
	...
	def removeRoot() -> None:
		...
		See Also
		--------
		ansa.spdrm.process.setRoot, ansa.spdrm.process.getRoot
	...
	def getDefinitionActions(type: str) -> list:
		...
		See Also
		--------
		ansa.spdrm.process.ActionDefinition
	...
	class WorkflowDefinition:
		...
		See Also
		--------
		ansa.spdrm.process.getDefinitionWorkflows
	...
	class WorkflowStatus:
		...
		See Also
		--------
		ansa.spdrm.process.getStateOfWorkflow, ansa.spdrm.process.RunningNode
	...
	class RunningNode:
		...
		See Also
		--------
		ansa.spdrm.process.WorkflowStatus, ansa.spdrm.process.getStateOfWorkflow, ansa.spdrm.process.updateNodeProgress
	...
	class ActionDefinition:
		...
		See Also
		--------
		ansa.spdrm.process.getDefinitionActions
	...
	class PexDriver:
		...
		See Also
		--------
		ansa.spdrm.process.getPexDriver
	...
	def getBALApps(bal: str) -> list:
		...
		See Also
		--------
		ansa.spdrm.process.getAvailableBALs
