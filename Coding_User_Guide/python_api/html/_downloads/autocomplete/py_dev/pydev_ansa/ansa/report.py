...
@typing_extensions.deprecated("Deprecated since version 20.1.0.Use ansa.report.Report.get_slide_size instead.")
def HeightOfSlide(unit: float) -> float:

	"""
	.. deprecated:: 20.1.0
		Use :py:meth:`ansa.report.Report.get_slide_size` instead.
	...
	warnings.warn("Deprecated since version 20.1.0.Use ansa.report.Report.get_slide_size instead.", DeprecationWarning)
...
@typing_extensions.deprecated("Deprecated since version 20.1.0.Use ansa.report.Textbox.get_text instead.")
def TextOfReportTextbox(slide_name: str, textbox_name: str, text_type: int) -> str:

	"""
	.. deprecated:: 20.1.0
		Use :py:meth:`ansa.report.Textbox.get_text` instead.
	...
	warnings.warn("Deprecated since version 20.1.0.Use ansa.report.Textbox.get_text instead.", DeprecationWarning)
...
def CreateReport(name: str) -> Report:
	...
	See Also
	--------
	ansa.report.Report, ansa.report.Reports
...
def Reports() -> Iterable[Report]:
	...
	See Also
	--------
	ansa.report.CreateReport, ansa.report.Report
...
def DeleteReport(report: Report | str) -> bool:
	...
	See Also
	--------
	ansa.report.Report, ansa.report.CreateReport, ansa.report.Reports
...
class Slide:
	...
	::
		...
		import ansa
		from ansa import report
		from ansa.windows import Color
